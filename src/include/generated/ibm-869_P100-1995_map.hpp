...
//                         DuckDB - Encodings
//
// generated/ibm-869_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_869_p100_1995ToUtf {
public:
	Ibm_869_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-869_P100-1995";
	// Generated from: ibm-869_P100-1995.ucm
	static constexpr map_entry ibm_869_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x88", 2, "\xCE\x87"},     {1, "\x89", 2, "\xC2\xAC"},     {1, "\x8A", 2, "\xC2\xA6"},
	    {1, "\x8B", 3, "\xE2\x80\x98"}, {1, "\x8C", 3, "\xE2\x80\x99"}, {1, "\x8D", 2, "\xCE\x88"},
	    {1, "\x8E", 3, "\xE2\x80\x95"}, {1, "\x8F", 2, "\xCE\x89"},     {1, "\x90", 2, "\xCE\x8A"},
	    {1, "\x91", 2, "\xCE\xAA"},     {1, "\x92", 2, "\xCE\x8C"},     {1, "\x95", 2, "\xCE\x8E"},
	    ...
	    {1, "\xED", 2, "\xCF\x82"},     {1, "\xEE", 2, "\xCF\x84"},     {1, "\xEF", 2, "\xC2\xB4"},
	    {1, "\xF0", 2, "\xC2\xAD"},     {1, "\xF1", 2, "\xC2\xB1"},     {1, "\xF2", 2, "\xCF\x85"},
	    {1, "\xF3", 2, "\xCF\x95"},     {1, "\xF4", 2, "\xCF\x87"},     {1, "\xF5", 2, "\xC2\xA7"},
	    {1, "\xF6", 2, "\xCF\x88"},     {1, "\xF7", 2, "\xCE\x85"},     {1, "\xF8", 2, "\xC2\xB0"},
	    {1, "\xF9", 2, "\xC2\xA8"},     {1, "\xFA", 2, "\xCF\x89"},     {1, "\xFB", 2, "\xCF\x8B"},
	    {1, "\xFC", 2, "\xCE\xB0"},     {1, "\xFD", 2, "\xCF\x8E"},     {1, "\xFE", 3, "\xEF\xBF\xAD"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_869_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_869_P100_1995_to_utf8),
		                                std::size(ibm_869_P100_1995_to_utf8));
