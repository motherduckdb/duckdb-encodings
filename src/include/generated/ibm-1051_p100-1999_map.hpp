...
//                         DuckDB - Encodings
//
// generated/ibm-1051_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1051_p100_1999ToUtf {
public:
	Ibm_1051_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1051_P100-1999";
	// Generated from: ibm-1051_P100-1999.ucm
	static constexpr map_entry ibm_1051_P100_1999_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 3, "\xE2\x96\x92"}, {1, "\x80", 2, "\xC2\x80"},
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA1", 2, "\xC3\x80"},     {1, "\xA2", 2, "\xC3\x82"},
	    {1, "\xA3", 2, "\xC3\x88"},     {1, "\xA4", 2, "\xC3\x8A"},     {1, "\xA5", 2, "\xC3\x8B"},
	    {1, "\xA6", 2, "\xC3\x8E"},     {1, "\xA7", 2, "\xC3\x8F"},     {1, "\xA8", 2, "\xC2\xB4"},
	    {1, "\xA9", 1, "\x60"},         {1, "\xAA", 2, "\xCB\x86"},     {1, "\xAB", 2, "\xC2\xA8"},
	    {1, "\xAC", 2, "\xCB\x9C"},     {1, "\xAD", 2, "\xC3\x99"},     {1, "\xAE", 2, "\xC3\x9B"},
	    {1, "\xAF", 2, "\xC2\xA3"},     {1, "\xB0", 3, "\xE2\x80\xBE"}, {1, "\xB1", 2, "\xC3\x9D"},
	    {1, "\xB2", 2, "\xC3\xBD"},     {1, "\xB3", 2, "\xCB\x9A"},     {1, "\xB4", 2, "\xC3\x87"},
	    {1, "\xB5", 2, "\xC3\xA7"},     {1, "\xB6", 2, "\xC3\x91"},     {1, "\xB7", 2, "\xC3\xB1"},
	    {1, "\xB8", 2, "\xC2\xA1"},     {1, "\xB9", 2, "\xC2\xBF"},     {1, "\xBA", 2, "\xC2\xA4"},
	    {1, "\xBB", 2, "\xC2\xA3"},     {1, "\xBC", 2, "\xC2\xA5"},     {1, "\xBD", 2, "\xC2\xA7"},
	    {1, "\xBE", 2, "\xC6\x92"},     {1, "\xBF", 2, "\xC2\xA2"},     {1, "\xC0", 2, "\xC3\xA2"},
	    {1, "\xC1", 2, "\xC3\xAA"},     {1, "\xC2", 2, "\xC3\xB4"},     {1, "\xC3", 2, "\xC3\xBB"},
	    {1, "\xC4", 2, "\xC3\xA1"},     {1, "\xC5", 2, "\xC3\xA9"},     {1, "\xC6", 2, "\xC3\xB3"},
	    {1, "\xC7", 2, "\xC3\xBA"},     {1, "\xC8", 2, "\xC3\xA0"},     {1, "\xC9", 2, "\xC3\xA8"},
	    {1, "\xCA", 2, "\xC3\xB2"},     {1, "\xCB", 2, "\xC3\xB9"},     {1, "\xCC", 2, "\xC3\xA4"},
	    {1, "\xCD", 2, "\xC3\xAB"},     {1, "\xCE", 2, "\xC3\xB6"},     {1, "\xCF", 2, "\xC3\xBC"},
	    {1, "\xD0", 2, "\xC3\x85"},     {1, "\xD1", 2, "\xC3\xAE"},     {1, "\xD2", 2, "\xC3\x98"},
	    {1, "\xD3", 2, "\xC3\x86"},     {1, "\xD4", 2, "\xC3\xA5"},     {1, "\xD5", 2, "\xC3\xAD"},
	    {1, "\xD6", 2, "\xC3\xB8"},     {1, "\xD7", 2, "\xC3\xA6"},     {1, "\xD8", 2, "\xC3\x84"},
	    {1, "\xD9", 2, "\xC3\xAC"},     {1, "\xDA", 2, "\xC3\x96"},     {1, "\xDB", 2, "\xC3\x9C"},
	    {1, "\xDC", 2, "\xC3\x89"},     {1, "\xDD", 2, "\xC3\xAF"},     {1, "\xDE", 2, "\xC3\x9F"},
	    {1, "\xDF", 2, "\xC3\x94"},     {1, "\xE0", 2, "\xC3\x81"},     {1, "\xE1", 2, "\xC3\x83"},
	    {1, "\xE2", 2, "\xC3\xA3"},     {1, "\xE3", 2, "\xC4\x90"},     {1, "\xE4", 2, "\xC3\xB0"},
	    {1, "\xE5", 2, "\xC3\x8D"},     {1, "\xE6", 2, "\xC3\x8C"},     {1, "\xE7", 2, "\xC3\x93"},
	    {1, "\xE8", 2, "\xC3\x92"},     {1, "\xE9", 2, "\xC3\x95"},     {1, "\xEA", 2, "\xC3\xB5"},
	    {1, "\xEB", 2, "\xC5\xA0"},     {1, "\xEC", 2, "\xC5\xA1"},     {1, "\xED", 2, "\xC3\x9A"},
	    {1, "\xEE", 2, "\xC5\xB8"},     {1, "\xEF", 2, "\xC3\xBF"},     {1, "\xF0", 2, "\xC3\x9E"},
	    {1, "\xF1", 2, "\xC3\xBE"},     {1, "\xF2", 2, "\xC2\xB7"},     {1, "\xF3", 2, "\xCE\xBC"},
	    {1, "\xF4", 2, "\xC2\xB6"},     {1, "\xF5", 2, "\xC2\xBE"},     {1, "\xF6", 1, "\x2D"},
	    {1, "\xF7", 2, "\xC2\xBC"},     {1, "\xF8", 2, "\xC2\xBD"},     {1, "\xF9", 2, "\xC2\xAA"},
	    {1, "\xFA", 2, "\xC2\xBA"},     {1, "\xFB", 2, "\xC2\xAB"},     {1, "\xFC", 3, "\xEF\xBF\xAD"},
	    {1, "\xFD", 2, "\xC2\xBB"},     {1, "\xFE", 2, "\xC2\xB1"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1051_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1051_P100_1999_to_utf8),
		                                std::size(ibm_1051_P100_1999_to_utf8));
