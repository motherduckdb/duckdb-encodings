...
//                         DuckDB - Encodings
//
// generated/windows-858-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_858_2000ToUtf {
public:
	Windows_858_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-858-2000";
	// Generated from: windows-858-2000.ucm
	static constexpr map_entry windows_858_2000_to_utf8[] = {
	    {1, "\x00", 1, "\x00"},         {1, "\x01", 3, "\xE2\x98\xBA"}, {1, "\x02", 3, "\xE2\x98\xBB"},
	    {1, "\x03", 3, "\xE2\x99\xA5"}, {1, "\x04", 3, "\xE2\x99\xA6"}, {1, "\x05", 3, "\xE2\x99\xA3"},
	    {1, "\x06", 3, "\xE2\x99\xA0"}, {1, "\x07", 3, "\xE2\x88\x99"}, {1, "\x08", 3, "\xE2\x97\x98"},
	    ...
	    {1, "\x99", 2, "\xC3\x96"},     {1, "\x9A", 2, "\xC3\x9C"},     {1, "\x9B", 2, "\xC9\xB8"},
	    {1, "\x9C", 3, "\xE2\x82\xA4"}, {1, "\x9D", 3, "\xE2\x88\x85"}, {1, "\x9E", 2, "\xC3\x97"},
	    ...
	    {1, "\xA8", 2, "\xC2\xBF"},     {1, "\xA9", 2, "\xC2\xAE"},     {1, "\xAA", 3, "\xE2\x8C\x90"},
	    ...
	    {1, "\xB7", 2, "\xC3\x80"},     {1, "\xB8", 2, "\xC2\xA9"},     {1, "\xB9", 3, "\xE2\x95\xA3"},
	    {1, "\xBA", 3, "\xE2\x95\x91"}, {1, "\xBB", 3, "\xE2\x95\x97"}, {1, "\xBC", 3, "\xE2\x95\x9D"},
	    {1, "\xBD", 2, "\xC2\xA2"},     {1, "\xBE", 2, "\xC2\xA5"},     {1, "\xBF", 3, "\xE2\x94\x90"},
	    {1, "\xC0", 3, "\xE2\x94\x94"}, {1, "\xC1", 3, "\xE2\x94\xB4"}, {1, "\xC2", 3, "\xE2\x94\xAC"},
	    {1, "\xC3", 3, "\xE2\x94\x9C"}, {1, "\xC4", 3, "\xE2\x94\x80"}, {1, "\xC5", 3, "\xE2\x94\xBC"},
	    {1, "\xC6", 2, "\xC3\xA3"},     {1, "\xC7", 2, "\xC3\x83"},     {1, "\xC8", 3, "\xE2\x95\x9A"},
	    {1, "\xC9", 3, "\xE2\x95\x94"}, {1, "\xCA", 3, "\xE2\x95\xA9"}, {1, "\xCB", 3, "\xE2\x95\xA6"},
	    {1, "\xCC", 3, "\xE2\x95\xA0"}, {1, "\xCD", 3, "\xE2\x95\x90"}, {1, "\xCE", 3, "\xE2\x95\xAC"},
	    {1, "\xCF", 2, "\xC2\xA4"},     {1, "\xD0", 2, "\xC3\xB0"},     {1, "\xD1", 2, "\xC3\x90"},
	    {1, "\xD2", 2, "\xC3\x8A"},     {1, "\xD3", 2, "\xC3\x8B"},     {1, "\xD4", 2, "\xC3\x88"},
	    {1, "\xD5", 3, "\xE2\x82\xAC"}, {1, "\xD6", 2, "\xC3\x8D"},     {1, "\xD7", 2, "\xC3\x8E"},
	    {1, "\xD8", 2, "\xC3\x8F"},     {1, "\xD9", 3, "\xE2\x94\x98"}, {1, "\xDA", 3, "\xE2\x94\x8C"},
	    {1, "\xDB", 3, "\xE2\x96\x90"}, {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 2, "\xC2\xA6"},
	    {1, "\xDE", 2, "\xC3\x8C"},     {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 2, "\xC3\x93"},
	    {1, "\xE1", 2, "\xCE\xB2"},     {1, "\xE2", 2, "\xC3\x94"},     {1, "\xE3", 2, "\xC3\x92"},
	    {1, "\xE4", 2, "\xC3\xB5"},     {1, "\xE5", 2, "\xC3\x95"},     {1, "\xE6", 2, "\xCE\xBC"},
	    {1, "\xE7", 2, "\xC3\xBE"},     {1, "\xE8", 2, "\xC3\x9E"},     {1, "\xE9", 2, "\xC3\x9A"},
	    {1, "\xEA", 2, "\xC3\x9B"},     {1, "\xEB", 2, "\xC3\x99"},     {1, "\xEC", 2, "\xC3\xBD"},
	    {1, "\xED", 2, "\xC3\x9D"},     {1, "\xEE", 2, "\xCC\x85"},     {1, "\xEF", 3, "\xE2\x80\xB5"},
	    {1, "\xF0", 2, "\xC2\xAD"},     {1, "\xF1", 3, "\xE2\x88\x93"}, {1, "\xF2", 3, "\xE2\x80\x97"},
	    {1, "\xF3", 2, "\xC2\xBE"},     {1, "\xF4", 2, "\xC2\xB6"},     {1, "\xF5", 2, "\xC2\xA7"},
	    {1, "\xF6", 2, "\xC3\xB7"},     {1, "\xF7", 2, "\xCC\xA7"},     {1, "\xF8", 3, "\xE2\x88\x98"},
	    {1, "\xF9", 2, "\xCC\x88"},     {1, "\xFA", 3, "\xE3\x83\xBB"}, {1, "\xFB", 3, "\xE2\x82\x81"},
	    {1, "\xFC", 3, "\xE2\x82\x83"}, {1, "\xFD", 3, "\xE2\x82\x82"}, {1, "\xFE", 3, "\xE2\x96\xA0"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Windows_858_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_858_2000_to_utf8),
		                                std::size(windows_858_2000_to_utf8));
