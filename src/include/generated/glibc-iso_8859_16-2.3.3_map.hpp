...
//                         DuckDB - Encodings
//
// generated/glibc-iso_8859_16-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_iso_8859_16_2_3_3ToUtf {
public:
	Glibc_iso_8859_16_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-ISO_8859_16-2.3.3";
	// Generated from: glibc-ISO_8859_16-2.3.3.ucm
	static constexpr map_entry glibc_ISO_8859_16_2_3_3_to_utf8[] = {
	    ...
	    {1, "\xA2", 2, "\xC4\x85"},     {1, "\xA3", 2, "\xC5\x81"},     {1, "\xA4", 3, "\xE2\x82\xAC"},
	    {1, "\xA5", 3, "\xE2\x80\x9E"}, {1, "\xA6", 2, "\xC5\xA0"},     {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC5\xA1"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 2, "\xC8\x98"},
	    {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC5\xB9"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xC5\xBA"},     {1, "\xAF", 2, "\xC5\xBB"},     {1, "\xB0", 2, "\xC2\xB0"},
	    {1, "\xB1", 2, "\xC2\xB1"},     {1, "\xB2", 2, "\xC4\x8C"},     {1, "\xB3", 2, "\xC5\x82"},
	    {1, "\xB4", 2, "\xC5\xBD"},     {1, "\xB5", 3, "\xE2\x80\x9D"}, {1, "\xB6", 2, "\xC2\xB6"},
	    {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC5\xBE"},     {1, "\xB9", 2, "\xC4\x8D"},
	    {1, "\xBA", 2, "\xC8\x99"},     {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC5\x92"},
	    {1, "\xBD", 2, "\xC5\x93"},     {1, "\xBE", 2, "\xC5\xB8"},     {1, "\xBF", 2, "\xC5\xBC"},
	    {1, "\xC0", 2, "\xC3\x80"},     {1, "\xC1", 2, "\xC3\x81"},     {1, "\xC2", 2, "\xC3\x82"},
	    {1, "\xC3", 2, "\xC4\x82"},     {1, "\xC4", 2, "\xC3\x84"},     {1, "\xC5", 2, "\xC4\x86"},
	    ...
	    {1, "\xCF", 2, "\xC3\x8F"},     {1, "\xD0", 2, "\xC4\x90"},     {1, "\xD1", 2, "\xC5\x83"},
	    {1, "\xD2", 2, "\xC3\x92"},     {1, "\xD3", 2, "\xC3\x93"},     {1, "\xD4", 2, "\xC3\x94"},
	    {1, "\xD5", 2, "\xC5\x90"},     {1, "\xD6", 2, "\xC3\x96"},     {1, "\xD7", 2, "\xC5\x9A"},
	    {1, "\xD8", 2, "\xC5\xB0"},     {1, "\xD9", 2, "\xC3\x99"},     {1, "\xDA", 2, "\xC3\x9A"},
	    {1, "\xDB", 2, "\xC3\x9B"},     {1, "\xDC", 2, "\xC3\x9C"},     {1, "\xDD", 2, "\xC4\x98"},
	    {1, "\xDE", 2, "\xC8\x9A"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC3\xA0"},
	    {1, "\xE1", 2, "\xC3\xA1"},     {1, "\xE2", 2, "\xC3\xA2"},     {1, "\xE3", 2, "\xC4\x83"},
	    {1, "\xE4", 2, "\xC3\xA4"},     {1, "\xE5", 2, "\xC4\x87"},     {1, "\xE6", 2, "\xC3\xA6"},
	    ...
	    {1, "\xF0", 2, "\xC4\x91"},     {1, "\xF1", 2, "\xC5\x84"},     {1, "\xF2", 2, "\xC3\xB2"},
	    {1, "\xF3", 2, "\xC3\xB3"},     {1, "\xF4", 2, "\xC3\xB4"},     {1, "\xF5", 2, "\xC5\x91"},
	    {1, "\xF6", 2, "\xC3\xB6"},     {1, "\xF7", 2, "\xC5\x9B"},     {1, "\xF8", 2, "\xC5\xB1"},
	    {1, "\xF9", 2, "\xC3\xB9"},     {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},
	    {1, "\xFC", 2, "\xC3\xBC"},     {1, "\xFD", 2, "\xC4\x99"},     {1, "\xFE", 2, "\xC8\x9B"},
	    {1, "\xFF", 2, "\xC3\xBF"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_iso_8859_16_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_ISO_8859_16_2_3_3_to_utf8),
		                                std::size(glibc_ISO_8859_16_2_3_3_to_utf8));
