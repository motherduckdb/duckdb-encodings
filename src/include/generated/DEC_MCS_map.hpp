...
public:
	...
	// Generated from: glibc-DEC_MCS-2.1.2.ucm
	static constexpr map_entry DEC_MCS_to_utf8[] = {
	    ...
	    {1, "\xA1", 2, "\xC2\xA1"}, {1, "\xA2", 2, "\xC2\xA2"}, {1, "\xA3", 2, "\xC2\xA3"}, {1, "\xA5", 2, "\xC2\xA5"},
	    {1, "\xA7", 2, "\xC2\xA7"}, {1, "\xA8", 2, "\xC2\xA4"}, {1, "\xA9", 2, "\xC2\xA9"}, {1, "\xAA", 2, "\xC2\xAA"},
	    {1, "\xAB", 2, "\xC2\xAB"}, {1, "\xB0", 2, "\xC2\xB0"}, {1, "\xB1", 2, "\xC2\xB1"}, {1, "\xB2", 2, "\xC2\xB2"},
	    {1, "\xB3", 2, "\xC2\xB3"}, {1, "\xB5", 2, "\xC2\xB5"}, {1, "\xB6", 2, "\xC2\xB6"}, {1, "\xB7", 2, "\xC2\xB7"},
	    {1, "\xB9", 2, "\xC2\xB9"}, {1, "\xBA", 2, "\xC2\xBA"}, {1, "\xBB", 2, "\xC2\xBB"}, {1, "\xBC", 2, "\xC2\xBC"},
	    {1, "\xBD", 2, "\xC2\xBD"}, {1, "\xBF", 2, "\xC2\xBF"}, {1, "\xC0", 2, "\xC3\x80"}, {1, "\xC1", 2, "\xC3\x81"},
	    {1, "\xC2", 2, "\xC3\x82"}, {1, "\xC3", 2, "\xC3\x83"}, {1, "\xC4", 2, "\xC3\x84"}, {1, "\xC5", 2, "\xC3\x85"},
	    {1, "\xC6", 2, "\xC3\x86"}, {1, "\xC7", 2, "\xC3\x87"}, {1, "\xC8", 2, "\xC3\x88"}, {1, "\xC9", 2, "\xC3\x89"},
	    {1, "\xCA", 2, "\xC3\x8A"}, {1, "\xCB", 2, "\xC3\x8B"}, {1, "\xCC", 2, "\xC3\x8C"}, {1, "\xCD", 2, "\xC3\x8D"},
	    {1, "\xCE", 2, "\xC3\x8E"}, {1, "\xCF", 2, "\xC3\x8F"}, {1, "\xD1", 2, "\xC3\x91"}, {1, "\xD2", 2, "\xC3\x92"},
	    {1, "\xD3", 2, "\xC3\x93"}, {1, "\xD4", 2, "\xC3\x94"}, {1, "\xD5", 2, "\xC3\x95"}, {1, "\xD6", 2, "\xC3\x96"},
	    {1, "\xD7", 2, "\xC5\x92"}, {1, "\xD8", 2, "\xC3\x98"}, {1, "\xD9", 2, "\xC3\x99"}, {1, "\xDA", 2, "\xC3\x9A"},
	    {1, "\xDB", 2, "\xC3\x9B"}, {1, "\xDC", 2, "\xC3\x9C"}, {1, "\xDD", 2, "\xC5\xB8"}, {1, "\xDF", 2, "\xC3\x9F"},
	    ...
	    {1, "\xF1", 2, "\xC3\xB1"}, {1, "\xF2", 2, "\xC3\xB2"}, {1, "\xF3", 2, "\xC3\xB3"}, {1, "\xF4", 2, "\xC3\xB4"},
	    {1, "\xF5", 2, "\xC3\xB5"}, {1, "\xF6", 2, "\xC3\xB6"}, {1, "\xF7", 2, "\xC5\x93"}, {1, "\xF8", 2, "\xC3\xB8"},
	    {1, "\xF9", 2, "\xC3\xB9"}, {1, "\xFA", 2, "\xC3\xBA"}, {1, "\xFB", 2, "\xC3\xBB"}, {1, "\xFC", 2, "\xC3\xBC"},
	    {1, "\xFD", 2, "\xC3\xBF"},
	};
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&DEC_MCS_to_utf8), std::size(DEC_MCS_to_utf8));
