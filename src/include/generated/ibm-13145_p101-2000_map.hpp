...
public:
	...
	// Generated from: ibm-13145_P101-2000.ucm
	static constexpr map_entry ibm_13145_P101_2000_to_utf8[] = {
	    ...
	    {1, "\x8D", 2, "\xC4\xB1"},     {1, "\x8E", 2, "\xC3\x84"},     {1, "\x8F", 2, "\xC3\x85"},
	    {1, "\x90", 2, "\xC3\x89"},     {1, "\x91", 2, "\xC3\xA6"},     {1, "\x92", 2, "\xC3\x86"},
	    {1, "\x93", 2, "\xC3\xB4"},     {1, "\x94", 2, "\xC3\xB6"},     {1, "\x95", 2, "\xC3\xB2"},
	    {1, "\x96", 2, "\xC3\xBB"},     {1, "\x97", 2, "\xC3\xB9"},     {1, "\x98", 2, "\xC4\xB0"},
	    {1, "\x99", 2, "\xC3\x96"},     {1, "\x9A", 2, "\xC3\x9C"},     {1, "\x9B", 2, "\xC3\xB8"},
	    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xC3\x98"},     {1, "\x9E", 2, "\xC5\x9E"},
	    {1, "\x9F", 2, "\xC5\x9F"},     {1, "\xA0", 2, "\xC3\xA1"},     {1, "\xA1", 2, "\xC3\xAD"},
	    {1, "\xA2", 2, "\xC3\xB3"},     {1, "\xA3", 2, "\xC3\xBA"},     {1, "\xA4", 2, "\xC3\xB1"},
	    {1, "\xA5", 2, "\xC3\x91"},     {1, "\xA6", 2, "\xC4\x9E"},     {1, "\xA7", 2, "\xC4\x9F"},
	    {1, "\xA8", 2, "\xC2\xBF"},     {1, "\xA9", 2, "\xC2\xAE"},     {1, "\xAA", 2, "\xC2\xAC"},
	    ...
	    {1, "\xCF", 2, "\xC2\xA4"},     {1, "\xD0", 2, "\xC2\xBA"},     {1, "\xD1", 2, "\xC2\xAA"},
	    ...
	    {1, "\xE1", 2, "\xC3\x9F"},     {1, "\xE2", 2, "\xC3\x94"},     {1, "\xE3", 2, "\xC3\x92"},
	    {1, "\xE4", 2, "\xC3\xB5"},     {1, "\xE5", 2, "\xC3\x95"},     {1, "\xE6", 2, "\xC2\xB5"},
	    {1, "\xE8", 2, "\xC3\x97"},     {1, "\xE9", 2, "\xC3\x9A"},     {1, "\xEA", 2, "\xC3\x9B"},
	    {1, "\xEB", 2, "\xC3\x99"},     {1, "\xEC", 2, "\xC3\xAC"},     {1, "\xED", 2, "\xC3\xBF"},
	    {1, "\xEE", 3, "\xE2\x80\xBE"}, {1, "\xEF", 2, "\xC2\xB4"},     {1, "\xF0", 2, "\xC2\xAD"},
	    {1, "\xF1", 2, "\xC2\xB1"},     {1, "\xF3", 2, "\xC2\xBE"},     {1, "\xF4", 2, "\xC2\xB6"},
	    {1, "\xF5", 2, "\xC2\xA7"},     {1, "\xF6", 2, "\xC3\xB7"},     {1, "\xF7", 2, "\xC2\xB8"},
	    {1, "\xF8", 2, "\xC2\xB0"},     {1, "\xF9", 2, "\xC2\xA8"},     {1, "\xFA", 2, "\xC2\xB7"},
	    {1, "\xFB", 2, "\xC2\xB9"},     {1, "\xFC", 2, "\xC2\xB3"},     {1, "\xFD", 2, "\xC2\xB2"},
	    {1, "\xFE", 3, "\xEF\xBF\xAD"}, {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_13145_p101_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_13145_P101_2000_to_utf8),
		                                std::size(ibm_13145_P101_2000_to_utf8));
