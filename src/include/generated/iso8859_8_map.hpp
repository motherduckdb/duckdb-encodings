...
class Iso8859_8ToUtf {
public:
	Iso8859_8ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ISO8859_8";
	// Generated from: aix-ISO8859_8-4.3.6.ucm
	static constexpr map_entry ISO8859_8_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Iso8859_8ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ISO8859_8_to_utf8), std::size(ISO8859_8_to_utf8));
