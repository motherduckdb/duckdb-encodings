...
class Iso_8859_7ToUtf {
public:
	Iso_8859_7ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ISO_8859_7";
	// Generated from: glibc-ISO_8859_7-2.1.2.ucm
	static constexpr map_entry ISO_8859_7_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA1", 3, "\xE2\x80\x9B"},
	...
	static void Register(const DBConfig &config) {
		const Iso_8859_7ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ISO_8859_7_to_utf8),
		                                std::size(ISO_8859_7_to_utf8));
