...
//                         DuckDB - Encodings
//
// generated/java-cp1255-1.3_p_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Java_cp1255_1_3_pToUtf {
public:
	Java_cp1255_1_3_pToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "java-Cp1255-1.3_P";
	// Generated from: java-Cp1255-1.3_P.ucm
	static constexpr map_entry java_Cp1255_1_3_P_to_utf8[] = {
	    ...
	    {1, "\x9B", 3, "\xE2\x80\xBA"}, {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA2", 2, "\xC2\xA2"},
	    ...
	    {1, "\xC8", 2, "\xD6\xB8"},     {1, "\xC9", 2, "\xD6\xB9"},     {1, "\xCA", 2, "\xD6\xBA"},
	    {1, "\xCB", 2, "\xD6\xBB"},     {1, "\xCC", 2, "\xD6\xBC"},     {1, "\xCD", 2, "\xD6\xBD"},
	    {1, "\xCE", 2, "\xD6\xBE"},     {1, "\xCF", 2, "\xD6\xBF"},     {1, "\xD0", 2, "\xD7\x80"},
	    {1, "\xD1", 2, "\xD7\x81"},     {1, "\xD2", 2, "\xD7\x82"},     {1, "\xD3", 2, "\xD7\x83"},
	    {1, "\xD4", 2, "\xD7\xB0"},     {1, "\xD5", 2, "\xD7\xB1"},     {1, "\xD6", 2, "\xD7\xB2"},
	...
	static void Register(const DBConfig &config) {
		const Java_cp1255_1_3_pToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&java_Cp1255_1_3_P_to_utf8),
		                                std::size(java_Cp1255_1_3_P_to_utf8));
