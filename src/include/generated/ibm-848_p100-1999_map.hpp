...
//                         DuckDB - Encodings
//
// generated/ibm-848_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_848_p100_1999ToUtf {
public:
	Ibm_848_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-848_P100-1999";
	// Generated from: ibm-848_P100-1999.ucm
	static constexpr map_entry ibm_848_P100_1999_to_utf8[] = {
	    ...
	    {1, "\xFC", 3, "\xE2\x84\x96"}, {1, "\xFD", 3, "\xE2\x82\xAC"}, {1, "\xFE", 3, "\xEF\xBF\xAD"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_848_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_848_P100_1999_to_utf8),
		                                std::size(ibm_848_P100_1999_to_utf8));
