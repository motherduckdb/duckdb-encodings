...
//                         DuckDB - Encodings
//
// generated/windows-28596-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_28596_2000ToUtf {
public:
	Windows_28596_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-28596-2000";
	// Generated from: windows-28596-2000.ucm
	static constexpr map_entry windows_28596_2000_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xEF\x9F\x88"},
	    {1, "\xA2", 3, "\xEF\x9F\x89"}, {1, "\xA3", 3, "\xEF\x9F\x8A"}, {1, "\xA4", 2, "\xC2\xA4"},
	    {1, "\xA5", 3, "\xEF\x9F\x8B"}, {1, "\xA6", 3, "\xEF\x9F\x8C"}, {1, "\xA7", 3, "\xEF\x9F\x8D"},
	    {1, "\xA8", 3, "\xEF\x9F\x8E"}, {1, "\xA9", 3, "\xEF\x9F\x8F"}, {1, "\xAA", 3, "\xEF\x9F\x90"},
	    {1, "\xAB", 3, "\xEF\x9F\x91"}, {1, "\xAC", 2, "\xD8\x8C"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 3, "\xEF\x9F\x92"}, {1, "\xAF", 3, "\xEF\x9F\x93"}, {1, "\xB0", 3, "\xEF\x9F\x94"},
	    {1, "\xB1", 3, "\xEF\x9F\x95"}, {1, "\xB2", 3, "\xEF\x9F\x96"}, {1, "\xB3", 3, "\xEF\x9F\x97"},
	    {1, "\xB4", 3, "\xEF\x9F\x98"}, {1, "\xB5", 3, "\xEF\x9F\x99"}, {1, "\xB6", 3, "\xEF\x9F\x9A"},
	    {1, "\xB7", 3, "\xEF\x9F\x9B"}, {1, "\xB8", 3, "\xEF\x9F\x9C"}, {1, "\xB9", 3, "\xEF\x9F\x9D"},
	    {1, "\xBA", 3, "\xEF\x9F\x9E"}, {1, "\xBB", 2, "\xD8\x9B"},     {1, "\xBC", 3, "\xEF\x9F\x9F"},
	    {1, "\xBD", 3, "\xEF\x9F\xA0"}, {1, "\xBE", 3, "\xEF\x9F\xA1"}, {1, "\xBF", 2, "\xD8\x9F"},
	    {1, "\xC0", 3, "\xEF\x9F\xA2"}, {1, "\xC1", 2, "\xD8\xA1"},     {1, "\xC2", 2, "\xD8\xA2"},
	    {1, "\xC3", 2, "\xD8\xA3"},     {1, "\xC4", 2, "\xD8\xA4"},     {1, "\xC5", 2, "\xD8\xA5"},
	    {1, "\xC6", 2, "\xD8\xA6"},     {1, "\xC7", 2, "\xD8\xA7"},     {1, "\xC8", 2, "\xD8\xA8"},
	    {1, "\xC9", 2, "\xD8\xA9"},     {1, "\xCA", 2, "\xD8\xAA"},     {1, "\xCB", 2, "\xD8\xAB"},
	    {1, "\xCC", 2, "\xD8\xAC"},     {1, "\xCD", 2, "\xD8\xAD"},     {1, "\xCE", 2, "\xD8\xAE"},
	    {1, "\xCF", 2, "\xD8\xAF"},     {1, "\xD0", 2, "\xD8\xB0"},     {1, "\xD1", 2, "\xD8\xB1"},
	    {1, "\xD2", 2, "\xD8\xB2"},     {1, "\xD3", 2, "\xD8\xB3"},     {1, "\xD4", 2, "\xD8\xB4"},
	    {1, "\xD5", 2, "\xD8\xB5"},     {1, "\xD6", 2, "\xD8\xB6"},     {1, "\xD7", 2, "\xD8\xB7"},
	    {1, "\xD8", 2, "\xD8\xB8"},     {1, "\xD9", 2, "\xD8\xB9"},     {1, "\xDA", 2, "\xD8\xBA"},
	    {1, "\xDB", 3, "\xEF\x9F\xA3"}, {1, "\xDC", 3, "\xEF\x9F\xA4"}, {1, "\xDD", 3, "\xEF\x9F\xA5"},
	    {1, "\xDE", 3, "\xEF\x9F\xA6"}, {1, "\xDF", 3, "\xEF\x9F\xA7"}, {1, "\xE0", 2, "\xD9\x80"},
	    {1, "\xE1", 2, "\xD9\x81"},     {1, "\xE2", 2, "\xD9\x82"},     {1, "\xE3", 2, "\xD9\x83"},
	    {1, "\xE4", 2, "\xD9\x84"},     {1, "\xE5", 2, "\xD9\x85"},     {1, "\xE6", 2, "\xD9\x86"},
	    {1, "\xE7", 2, "\xD9\x87"},     {1, "\xE8", 2, "\xD9\x88"},     {1, "\xE9", 2, "\xD9\x89"},
	    {1, "\xEA", 2, "\xD9\x8A"},     {1, "\xEB", 2, "\xD9\x8B"},     {1, "\xEC", 2, "\xD9\x8C"},
	    {1, "\xED", 2, "\xD9\x8D"},     {1, "\xEE", 2, "\xD9\x8E"},     {1, "\xEF", 2, "\xD9\x8F"},
	    {1, "\xF0", 2, "\xD9\x90"},     {1, "\xF1", 2, "\xD9\x91"},     {1, "\xF2", 2, "\xD9\x92"},
	    {1, "\xF3", 3, "\xEF\x9F\xA8"}, {1, "\xF4", 3, "\xEF\x9F\xA9"}, {1, "\xF5", 3, "\xEF\x9F\xAA"},
	    {1, "\xF6", 3, "\xEF\x9F\xAB"}, {1, "\xF7", 3, "\xEF\x9F\xAC"}, {1, "\xF8", 3, "\xEF\x9F\xAD"},
	    {1, "\xF9", 3, "\xEF\x9F\xAE"}, {1, "\xFA", 3, "\xEF\x9F\xAF"}, {1, "\xFB", 3, "\xEF\x9F\xB0"},
	    {1, "\xFC", 3, "\xEF\x9F\xB1"}, {1, "\xFD", 3, "\xEF\x9F\xB2"}, {1, "\xFE", 3, "\xEF\x9F\xB3"},
	    {1, "\xFF", 3, "\xEF\x9F\xB4"},
	};
	static void Register(const DBConfig &config) {
		const Windows_28596_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_28596_2000_to_utf8),
		                                std::size(windows_28596_2000_to_utf8));
