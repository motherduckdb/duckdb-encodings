...
public:
	...
	const string name = "8859_4";
	// Generated from: solaris-8859_4-2.7.ucm
	static constexpr map_entry _8859_4_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const _8859_4ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&_8859_4_to_utf8), std::size(_8859_4_to_utf8));
