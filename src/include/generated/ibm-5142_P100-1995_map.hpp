...
//                         DuckDB - Encodings
//
// generated/ibm-5142_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_5142_p100_1995ToUtf {
public:
	Ibm_5142_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-5142_P100-1995";
	// Generated from: ibm-5142_P100-1995.ucm
	static constexpr map_entry ibm_5142_P100_1995_to_utf8[] = {
	    ...
	    {1, "\xBF", 2, "\xD8\x9F"},     {1, "\xC1", 3, "\xEF\xBA\x80"}, {1, "\xC2", 3, "\xEF\xBA\x81"},
	    ...
	    {1, "\xD5", 3, "\xEF\xBA\xBA"}, {1, "\xD6", 3, "\xEF\xBA\xBE"}, {1, "\xD7", 3, "\xEF\xBB\x83"},
	    {1, "\xD8", 3, "\xEF\xBB\x87"}, {1, "\xD9", 3, "\xEF\xBB\x89"}, {1, "\xDA", 3, "\xEF\xBB\x8D"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_5142_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_5142_P100_1995_to_utf8),
		                                std::size(ibm_5142_P100_1995_to_utf8));
