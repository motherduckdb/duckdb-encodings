...
public:
	...
	static constexpr map_entry glibc_NF_Z_62_010_2_3_3_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Glibc_nf_z_62_010_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_NF_Z_62_010_2_3_3_to_utf8),
		                                std::size(glibc_NF_Z_62_010_2_3_3_to_utf8));
