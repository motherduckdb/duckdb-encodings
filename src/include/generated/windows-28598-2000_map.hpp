...
//                         DuckDB - Encodings
//
// generated/windows-28598-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_28598_2000ToUtf {
public:
	Windows_28598_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-28598-2000";
	// Generated from: windows-28598-2000.ucm
	static constexpr map_entry windows_28598_2000_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xEF\x9E\x9C"},
	    ...
	    {1, "\xBD", 2, "\xC2\xBD"},     {1, "\xBE", 2, "\xC2\xBE"},     {1, "\xBF", 3, "\xEF\x9E\x9D"},
	    {1, "\xC0", 3, "\xEF\x9E\x9E"}, {1, "\xC1", 3, "\xEF\x9E\x9F"}, {1, "\xC2", 3, "\xEF\x9E\xA0"},
	    {1, "\xC3", 3, "\xEF\x9E\xA1"}, {1, "\xC4", 3, "\xEF\x9E\xA2"}, {1, "\xC5", 3, "\xEF\x9E\xA3"},
	    {1, "\xC6", 3, "\xEF\x9E\xA4"}, {1, "\xC7", 3, "\xEF\x9E\xA5"}, {1, "\xC8", 3, "\xEF\x9E\xA6"},
	    {1, "\xC9", 3, "\xEF\x9E\xA7"}, {1, "\xCA", 3, "\xEF\x9E\xA8"}, {1, "\xCB", 3, "\xEF\x9E\xA9"},
	    {1, "\xCC", 3, "\xEF\x9E\xAA"}, {1, "\xCD", 3, "\xEF\x9E\xAB"}, {1, "\xCE", 3, "\xEF\x9E\xAC"},
	    {1, "\xCF", 3, "\xEF\x9E\xAD"}, {1, "\xD0", 3, "\xEF\x9E\xAE"}, {1, "\xD1", 3, "\xEF\x9E\xAF"},
	    {1, "\xD2", 3, "\xEF\x9E\xB0"}, {1, "\xD3", 3, "\xEF\x9E\xB1"}, {1, "\xD4", 3, "\xEF\x9E\xB2"},
	    {1, "\xD5", 3, "\xEF\x9E\xB3"}, {1, "\xD6", 3, "\xEF\x9E\xB4"}, {1, "\xD7", 3, "\xEF\x9E\xB5"},
	    {1, "\xD8", 3, "\xEF\x9E\xB6"}, {1, "\xD9", 3, "\xEF\x9E\xB7"}, {1, "\xDA", 3, "\xEF\x9E\xB8"},
	    {1, "\xDB", 3, "\xEF\x9E\xB9"}, {1, "\xDC", 3, "\xEF\x9E\xBA"}, {1, "\xDD", 3, "\xEF\x9E\xBB"},
	    {1, "\xDE", 3, "\xEF\x9E\xBC"}, {1, "\xDF", 3, "\xE2\x80\x97"}, {1, "\xE0", 2, "\xD7\x90"},
	    ...
	    {1, "\xF9", 2, "\xD7\xA9"},     {1, "\xFA", 2, "\xD7\xAA"},     {1, "\xFB", 3, "\xEF\x9E\xBD"},
	    {1, "\xFC", 3, "\xEF\x9E\xBE"}, {1, "\xFD", 3, "\xEF\x9E\xBF"}, {1, "\xFE", 3, "\xEF\x9F\x80"},
	    {1, "\xFF", 3, "\xEF\x9F\x81"},
	};
	static void Register(const DBConfig &config) {
		const Windows_28598_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_28598_2000_to_utf8),
		                                std::size(windows_28598_2000_to_utf8));
