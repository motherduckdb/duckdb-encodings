...
//                         DuckDB - Encodings
//
// generated/ibm-901_P100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_901_p100_1999ToUtf {
public:
	Ibm_901_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-901_P100-1999";
	// Generated from: ibm-901_P100-1999.ucm
	static constexpr map_entry ibm_901_P100_1999_to_utf8[] = {
	    ...
	    {1, "\x87", 3, "\xE2\x96\x88"}, {1, "\x88", 3, "\xE2\x96\x84"}, {1, "\x89", 3, "\xE2\x95\xA3"},
	    {1, "\x8A", 3, "\xE2\x95\x91"}, {1, "\x8B", 3, "\xE2\x95\x97"}, {1, "\x8C", 3, "\xE2\x95\x9D"},
	    {1, "\x8D", 3, "\xE2\x96\x80"}, {1, "\x8E", 2, "\xC2\xA5"},     {1, "\x8F", 3, "\xE2\x94\x90"},
	    {1, "\x90", 3, "\xE2\x94\x94"}, {1, "\x91", 3, "\xE2\x94\xB4"}, {1, "\x92", 3, "\xE2\x94\xAC"},
	    {1, "\x93", 3, "\xE2\x94\x9C"}, {1, "\x94", 3, "\xE2\x94\x80"}, {1, "\x95", 3, "\xE2\x94\xBC"},
	    {1, "\x96", 3, "\xEF\xBF\xAD"}, {1, "\x97", 3, "\xE2\x80\x97"}, {1, "\x98", 3, "\xE2\x95\x9A"},
	    {1, "\x99", 3, "\xE2\x95\x94"}, {1, "\x9A", 3, "\xE2\x95\xA9"}, {1, "\x9B", 3, "\xE2\x95\xA6"},
	    {1, "\x9C", 3, "\xE2\x95\xA0"}, {1, "\x9D", 3, "\xE2\x95\x90"}, {1, "\x9E", 3, "\xE2\x95\xAC"},
	    {1, "\x9F", 3, "\xE2\x80\xBE"}, {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xE2\x80\x9D"},
	    {1, "\xA2", 2, "\xC2\xA2"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xE2\x82\xAC"},
	    {1, "\xA5", 3, "\xE2\x80\x9E"}, {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC3\x98"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 2, "\xC5\x96"},
	    {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC2\xAC"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xC2\xAE"},     {1, "\xAF", 2, "\xC3\x86"},     {1, "\xB0", 2, "\xC2\xB0"},
	    {1, "\xB1", 2, "\xC2\xB1"},     {1, "\xB2", 2, "\xC2\xB2"},     {1, "\xB3", 2, "\xC2\xB3"},
	    {1, "\xB4", 3, "\xE2\x80\x9C"}, {1, "\xB5", 2, "\xC2\xB5"},     {1, "\xB6", 2, "\xC2\xB6"},
	    {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC3\xB8"},     {1, "\xB9", 2, "\xC2\xB9"},
	    {1, "\xBA", 2, "\xC5\x97"},     {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC2\xBC"},
	    {1, "\xBD", 2, "\xC2\xBD"},     {1, "\xBE", 2, "\xC2\xBE"},     {1, "\xBF", 2, "\xC3\xA6"},
	    {1, "\xC0", 2, "\xC4\x84"},     {1, "\xC1", 2, "\xC4\xAE"},     {1, "\xC2", 2, "\xC4\x80"},
	    {1, "\xC3", 2, "\xC4\x86"},     {1, "\xC4", 2, "\xC3\x84"},     {1, "\xC5", 2, "\xC3\x85"},
	    {1, "\xC6", 2, "\xC4\x98"},     {1, "\xC7", 2, "\xC4\x92"},     {1, "\xC8", 2, "\xC4\x8C"},
	    {1, "\xC9", 2, "\xC3\x89"},     {1, "\xCA", 2, "\xC5\xB9"},     {1, "\xCB", 2, "\xC4\x96"},
	    {1, "\xCC", 2, "\xC4\xA2"},     {1, "\xCD", 2, "\xC4\xB6"},     {1, "\xCE", 2, "\xC4\xAA"},
	    {1, "\xCF", 2, "\xC4\xBB"},     {1, "\xD0", 2, "\xC5\xA0"},     {1, "\xD1", 2, "\xC5\x83"},
	    {1, "\xD2", 2, "\xC5\x85"},     {1, "\xD3", 2, "\xC3\x93"},     {1, "\xD4", 2, "\xC5\x8C"},
	    {1, "\xD5", 2, "\xC3\x95"},     {1, "\xD6", 2, "\xC3\x96"},     {1, "\xD7", 2, "\xC3\x97"},
	    {1, "\xD8", 2, "\xC5\xB2"},     {1, "\xD9", 2, "\xC5\x81"},     {1, "\xDA", 2, "\xC5\x9A"},
	    {1, "\xDB", 2, "\xC5\xAA"},     {1, "\xDC", 2, "\xC3\x9C"},     {1, "\xDD", 2, "\xC5\xBB"},
	    {1, "\xDE", 2, "\xC5\xBD"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC4\x85"},
	    {1, "\xE1", 2, "\xC4\xAF"},     {1, "\xE2", 2, "\xC4\x81"},     {1, "\xE3", 2, "\xC4\x87"},
	    {1, "\xE4", 2, "\xC3\xA4"},     {1, "\xE5", 2, "\xC3\xA5"},     {1, "\xE6", 2, "\xC4\x99"},
	    {1, "\xE7", 2, "\xC4\x93"},     {1, "\xE8", 2, "\xC4\x8D"},     {1, "\xE9", 2, "\xC3\xA9"},
	    {1, "\xEA", 2, "\xC5\xBA"},     {1, "\xEB", 2, "\xC4\x97"},     {1, "\xEC", 2, "\xC4\xA3"},
	    {1, "\xED", 2, "\xC4\xB7"},     {1, "\xEE", 2, "\xC4\xAB"},     {1, "\xEF", 2, "\xC4\xBC"},
	    {1, "\xF0", 2, "\xC5\xA1"},     {1, "\xF1", 2, "\xC5\x84"},     {1, "\xF2", 2, "\xC5\x86"},
	    {1, "\xF3", 2, "\xC3\xB3"},     {1, "\xF4", 2, "\xC5\x8D"},     {1, "\xF5", 2, "\xC3\xB5"},
	    {1, "\xF6", 2, "\xC3\xB6"},     {1, "\xF7", 2, "\xC3\xB7"},     {1, "\xF8", 2, "\xC5\xB3"},
	    {1, "\xF9", 2, "\xC5\x82"},     {1, "\xFA", 2, "\xC5\x9B"},     {1, "\xFB", 2, "\xC5\xAB"},
	    {1, "\xFC", 2, "\xC3\xBC"},     {1, "\xFD", 2, "\xC5\xBC"},     {1, "\xFE", 2, "\xC5\xBE"},
	    {1, "\xFF", 3, "\xE2\x80\x99"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_901_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_901_P100_1999_to_utf8),
		                                std::size(ibm_901_P100_1999_to_utf8));
