...
//                         DuckDB - Encodings
//
// generated/windows-866-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_866_2000ToUtf {
public:
	Windows_866_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-866-2000";
	// Generated from: windows-866-2000.ucm
	static constexpr map_entry windows_866_2000_to_utf8[] = {
	    ...
	    {1, "\xFC", 3, "\xE2\x84\x96"}, {1, "\xFD", 2, "\xC2\xA4"},     {1, "\xFE", 3, "\xE2\x96\xA0"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Windows_866_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_866_2000_to_utf8),
		                                std::size(windows_866_2000_to_utf8));
