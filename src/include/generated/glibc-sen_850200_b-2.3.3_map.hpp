...
//                         DuckDB - Encodings
//
// generated/glibc-sen_850200_b-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_sen_850200_b_2_3_3ToUtf {
public:
	Glibc_sen_850200_b_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-SEN_850200_B-2.3.3";
	// Generated from: glibc-SEN_850200_B-2.3.3.ucm
	static constexpr map_entry glibc_SEN_850200_B_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x5A", 1, "\x5A"},         {1, "\x5B", 2, "\xC3\x84"}, {1, "\x5C", 2, "\xC3\x96"},
	    {1, "\x5D", 2, "\xC3\x85"},     {1, "\x5E", 1, "\x5E"},     {1, "\x5F", 1, "\x5F"},
	...
	static void Register(const DBConfig &config) {
		const Glibc_sen_850200_b_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_SEN_850200_B_2_3_3_to_utf8),
		                                std::size(glibc_SEN_850200_B_2_3_3_to_utf8));
