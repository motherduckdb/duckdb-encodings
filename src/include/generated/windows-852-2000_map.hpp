...
//                         DuckDB - Encodings
//
// generated/windows-852-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_852_2000ToUtf {
public:
	Windows_852_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-852-2000";
	// Generated from: windows-852-2000.ucm
	static constexpr map_entry windows_852_2000_to_utf8[] = {
	    ...
	    {1, "\xCF", 2, "\xC2\xA4"},     {1, "\xD0", 2, "\xC4\x91"},     {1, "\xD1", 2, "\xC6\x89"},
	    ...
	    {1, "\xE1", 2, "\xCE\xB2"},     {1, "\xE2", 2, "\xC3\x94"},     {1, "\xE3", 2, "\xC5\x83"},
	    ...
	    {1, "\xED", 2, "\xC3\x9D"},     {1, "\xEE", 2, "\xC5\xA3"},     {1, "\xEF", 2, "\xCC\x81"},
	    {1, "\xF0", 2, "\xC2\xAD"},     {1, "\xF1", 2, "\xCB\x9D"},     {1, "\xF2", 2, "\xCB\x9B"},
	    {1, "\xF3", 2, "\xCC\x8C"},     {1, "\xF4", 2, "\xCC\x86"},     {1, "\xF5", 2, "\xC2\xA7"},
	    {1, "\xF6", 2, "\xC3\xB7"},     {1, "\xF7", 2, "\xCC\xA7"},     {1, "\xF8", 3, "\xE2\x88\x98"},
	    {1, "\xF9", 2, "\xCC\x88"},     {1, "\xFA", 2, "\xCC\x87"},     {1, "\xFB", 2, "\xC5\xB1"},
	    {1, "\xFC", 2, "\xC5\x98"},     {1, "\xFD", 2, "\xC5\x99"},     {1, "\xFE", 3, "\xE2\x96\xA0"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Windows_852_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_852_2000_to_utf8),
		                                std::size(windows_852_2000_to_utf8));
