...
public:
	...
	const string name = "IBM904";
	// Generated from: glibc-IBM904-2.1.2.ucm
	static constexpr map_entry IBM904_to_utf8[] = {
	    ...
	    {1, "\x80", 2, "\xC2\xA2"}, {1, "\xFD", 2, "\xC2\xAC"}, {1, "\xFE", 2, "\xC2\xA6"},
	};
	static void Register(const DBConfig &config) {
		const Ibm904ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&IBM904_to_utf8), std::size(IBM904_to_utf8));
