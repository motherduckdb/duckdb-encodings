...
//                         DuckDB - Encodings
//
// generated/glibc-ES2-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_es2_2_3_3ToUtf {
public:
	Glibc_es2_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-ES2-2.3.3";
	// Generated from: glibc-ES2-2.3.3.ucm
	static constexpr map_entry glibc_ES2_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x3F", 1, "\x3F"},     {1, "\x40", 3, "\xE2\x80\xA2"}, {1, "\x41", 1, "\x41"},
	    ...
	    {1, "\x5A", 1, "\x5A"},     {1, "\x5B", 2, "\xC2\xA1"},     {1, "\x5C", 2, "\xC3\x91"},
	    {1, "\x5D", 2, "\xC3\x87"}, {1, "\x5E", 2, "\xC2\xBF"},     {1, "\x5F", 1, "\x5F"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&glibc_ES2_2_3_3_to_utf8),
		                                std::size(glibc_ES2_2_3_3_to_utf8));
