...
//                         DuckDB - Encodings
//
// generated/ibm-868_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_868_p100_1995ToUtf {
public:
	Ibm_868_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-868_P100-1995";
	// Generated from: ibm-868_P100-1995.ucm
	static constexpr map_entry ibm_868_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x90", 3, "\xEF\xA3\xBB"}, {1, "\x91", 3, "\xEF\xBA\x90"}, {1, "\x92", 3, "\xEF\xBA\x92"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_868_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_868_P100_1995_to_utf8),
		                                std::size(ibm_868_P100_1995_to_utf8));
