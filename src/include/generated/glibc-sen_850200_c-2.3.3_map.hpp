...
public:
	...
	// Generated from: glibc-SEN_850200_C-2.3.3.ucm
	static constexpr map_entry glibc_SEN_850200_C_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x40", 2, "\xC3\x89"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"},     {1, "\x43", 1, "\x43"},
	    ...
	    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},     {1, "\x5A", 1, "\x5A"},     {1, "\x5B", 2, "\xC3\x84"},
	    {1, "\x5C", 2, "\xC3\x96"}, {1, "\x5D", 2, "\xC3\x85"}, {1, "\x5E", 2, "\xC3\x9C"}, {1, "\x5F", 1, "\x5F"},
	    {1, "\x60", 2, "\xC3\xA9"}, {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},     {1, "\x63", 1, "\x63"},
	    ...
	    {1, "\x78", 1, "\x78"},     {1, "\x79", 1, "\x79"},     {1, "\x7A", 1, "\x7A"},     {1, "\x7B", 2, "\xC3\xA4"},
	    {1, "\x7C", 2, "\xC3\xB6"}, {1, "\x7D", 2, "\xC3\xA5"}, {1, "\x7E", 2, "\xC3\xBC"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                std::size(glibc_SEN_850200_C_2_3_3_to_utf8));
