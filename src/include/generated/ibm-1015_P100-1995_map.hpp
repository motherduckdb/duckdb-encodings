...
//                         DuckDB - Encodings
//
// generated/ibm-1015_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1015_p100_1995ToUtf {
public:
	Ibm_1015_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1015_P100-1995";
	// Generated from: ibm-1015_P100-1995.ucm
	static constexpr map_entry ibm_1015_P100_1995_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&ibm_1015_P100_1995_to_utf8),
		                                std::size(ibm_1015_P100_1995_to_utf8));
