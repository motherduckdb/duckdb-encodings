...
//                         DuckDB - Encodings
//
// generated/glibc-it-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_it_2_3_3ToUtf {
public:
	Glibc_it_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "glibc-IT-2.3.3";
	// Generated from: glibc-IT-2.3.3.ucm
	static constexpr map_entry glibc_IT_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x40", 2, "\xC2\xA7"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"},     {1, "\x43", 1, "\x43"},
	    ...
	    {1, "\x5C", 2, "\xC3\xA7"}, {1, "\x5D", 2, "\xC3\xA9"}, {1, "\x5E", 1, "\x5E"},     {1, "\x5F", 1, "\x5F"},
	    {1, "\x60", 2, "\xC3\xB9"}, {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},     {1, "\x63", 1, "\x63"},
	    ...
	    {1, "\x78", 1, "\x78"},     {1, "\x79", 1, "\x79"},     {1, "\x7A", 1, "\x7A"},     {1, "\x7B", 2, "\xC3\xA0"},
	    {1, "\x7C", 2, "\xC3\xB2"}, {1, "\x7D", 2, "\xC3\xA8"}, {1, "\x7E", 2, "\xC3\xAC"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_it_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_IT_2_3_3_to_utf8),
		                                std::size(glibc_IT_2_3_3_to_utf8));
