...
//                         DuckDB - Encodings
//
// generated/windows-1256-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_1256_2000ToUtf {
public:
	Windows_1256_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-1256-2000";
	// Generated from: windows-1256-2000.ucm
	static constexpr map_entry windows_1256_2000_to_utf8[] = {
	    ...
	    {1, "\xAE", 2, "\xC2\xAE"},     {1, "\xAF", 2, "\xC2\xAF"},     {1, "\xB0", 2, "\xC2\xB0"},
	...
	static void Register(const DBConfig &config) {
		const Windows_1256_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_1256_2000_to_utf8),
		                                std::size(windows_1256_2000_to_utf8));
