...
//                         DuckDB - Encodings
//
// generated/ibm-1004_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1004_p100_1995ToUtf {
public:
	Ibm_1004_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1004_P100-1995";
	// Generated from: ibm-1004_P100-1995.ucm
	static constexpr map_entry ibm_1004_P100_1995_to_utf8[] = {
	    {1, "\x00", 1, "\x00"},         {1, "\x01", 1, "\x01"},         {1, "\x02", 1, "\x02"},
	    {1, "\x03", 1, "\x03"},         {1, "\x04", 2, "\xC2\xAF"},     {1, "\x05", 2, "\xCB\x98"},
	    {1, "\x06", 2, "\xCB\x99"},     {1, "\x07", 1, "\x07"},         {1, "\x08", 2, "\xCB\x9A"},
	    {1, "\x09", 1, "\x09"},         {1, "\x0A", 2, "\xCB\x9D"},     {1, "\x0B", 2, "\xCB\x9B"},
	    {1, "\x0C", 2, "\xCB\x87"},     {1, "\x0D", 1, "\x0D"},         {1, "\x0E", 1, "\x0E"},
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\x82", 3, "\xE2\x80\x9A"},
	    ...
	    {1, "\xCF", 2, "\xC3\x8F"},     {1, "\xD0", 2, "\xC3\x90"},     {1, "\xD1", 2, "\xC3\x91"},
	    ...
	    {1, "\xDE", 2, "\xC3\x9E"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC3\xA0"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_1004_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1004_P100_1995_to_utf8),
		                                std::size(ibm_1004_P100_1995_to_utf8));
