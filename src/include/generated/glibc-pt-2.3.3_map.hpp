...
//                         DuckDB - Encodings
//
// generated/glibc-pt-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_pt_2_3_3ToUtf {
public:
	Glibc_pt_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "glibc-PT-2.3.3";
	// Generated from: glibc-PT-2.3.3.ucm
	static constexpr map_entry glibc_PT_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x7C", 2, "\xC3\xA7"}, {1, "\x7D", 2, "\xC3\xB5"}, {1, "\x7E", 2, "\xC2\xB0"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_pt_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_PT_2_3_3_to_utf8),
		                                std::size(glibc_PT_2_3_3_to_utf8));
