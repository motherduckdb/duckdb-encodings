...
//                         DuckDB - Encodings
//
// generated/ibm-1125_p100-1997_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1125_p100_1997ToUtf {
public:
	Ibm_1125_p100_1997ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1125_P100-1997";
	// Generated from: ibm-1125_P100-1997.ucm
	static constexpr map_entry ibm_1125_P100_1997_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 3, "\xE2\x8C\x82"}, {1, "\x80", 2, "\xD0\x90"},
	    ...
	    {1, "\x9F", 2, "\xD0\xAF"},     {1, "\xA0", 2, "\xD0\xB0"},     {1, "\xA1", 2, "\xD0\xB1"},
	    {1, "\xA2", 2, "\xD0\xB2"},     {1, "\xA3", 2, "\xD0\xB3"},     {1, "\xA4", 2, "\xD0\xB4"},
	    {1, "\xA5", 2, "\xD0\xB5"},     {1, "\xA6", 2, "\xD0\xB6"},     {1, "\xA7", 2, "\xD0\xB7"},
	    {1, "\xA8", 2, "\xD0\xB8"},     {1, "\xA9", 2, "\xD0\xB9"},     {1, "\xAA", 2, "\xD0\xBA"},
	    {1, "\xAB", 2, "\xD0\xBB"},     {1, "\xAC", 2, "\xD0\xBC"},     {1, "\xAD", 2, "\xD0\xBD"},
	    {1, "\xAE", 2, "\xD0\xBE"},     {1, "\xAF", 2, "\xD0\xBF"},     {1, "\xB0", 3, "\xE2\x96\x91"},
	    ...
	    {1, "\xDE", 3, "\xE2\x96\x90"}, {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 2, "\xD1\x80"},
	    ...
	    {1, "\xF0", 2, "\xD0\x81"},     {1, "\xF1", 2, "\xD1\x91"},     {1, "\xF2", 2, "\xD2\x90"},
	    {1, "\xF3", 2, "\xD2\x91"},     {1, "\xF4", 2, "\xD0\x84"},     {1, "\xF5", 2, "\xD1\x94"},
	    {1, "\xF6", 2, "\xD0\x86"},     {1, "\xF7", 2, "\xD1\x96"},     {1, "\xF8", 2, "\xD0\x87"},
	    {1, "\xF9", 2, "\xD1\x97"},     {1, "\xFA", 2, "\xC3\xB7"},     {1, "\xFB", 2, "\xC2\xB1"},
	    {1, "\xFC", 3, "\xE2\x84\x96"}, {1, "\xFD", 2, "\xC2\xA4"},     {1, "\xFE", 3, "\xEF\xBF\xAD"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1125_p100_1997ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1125_P100_1997_to_utf8),
		                                std::size(ibm_1125_P100_1997_to_utf8));
