...
//                         DuckDB - Encodings
//
// generated/ibm-857_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_857_p100_1995ToUtf {
public:
	Ibm_857_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-857_P100-1995";
	// Generated from: ibm-857_P100-1995.ucm
	static constexpr map_entry ibm_857_P100_1995_to_utf8[] = {
	    ...
	    {1, "\xD6", 2, "\xC3\x8D"},     {1, "\xD7", 2, "\xC3\x8E"},     {1, "\xD8", 2, "\xC3\x8F"},
	    {1, "\xD9", 3, "\xE2\x94\x98"}, {1, "\xDA", 3, "\xE2\x94\x8C"}, {1, "\xDB", 3, "\xE2\x96\x88"},
	    {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 2, "\xC2\xA6"},     {1, "\xDE", 2, "\xC3\x8C"},
	    {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 2, "\xC3\x93"},     {1, "\xE1", 2, "\xC3\x9F"},
	    {1, "\xE2", 2, "\xC3\x94"},     {1, "\xE3", 2, "\xC3\x92"},     {1, "\xE4", 2, "\xC3\xB5"},
	    {1, "\xE5", 2, "\xC3\x95"},     {1, "\xE6", 2, "\xC2\xB5"},     {1, "\xE8", 2, "\xC3\x97"},
	    {1, "\xE9", 2, "\xC3\x9A"},     {1, "\xEA", 2, "\xC3\x9B"},     {1, "\xEB", 2, "\xC3\x99"},
	    {1, "\xEC", 2, "\xC3\xAC"},     {1, "\xED", 2, "\xC3\xBF"},     {1, "\xEE", 3, "\xE2\x80\xBE"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_857_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_857_P100_1995_to_utf8),
		                                std::size(ibm_857_P100_1995_to_utf8));
