...
public:
	...
	static constexpr map_entry ISO_10367_BOX_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xC0", 3, "\xE2\x95\x91"}, {1, "\xC1", 3, "\xE2\x95\x90"},
	    {1, "\xC2", 3, "\xE2\x95\x94"}, {1, "\xC3", 3, "\xE2\x95\x97"}, {1, "\xC4", 3, "\xE2\x95\x9A"},
	    {1, "\xC5", 3, "\xE2\x95\x9D"}, {1, "\xC6", 3, "\xE2\x95\xA0"}, {1, "\xC7", 3, "\xE2\x95\xA3"},
	    {1, "\xC8", 3, "\xE2\x95\xA6"}, {1, "\xC9", 3, "\xE2\x95\xA9"}, {1, "\xCA", 3, "\xE2\x95\xAC"},
	    {1, "\xCB", 3, "\xEE\x80\x99"}, {1, "\xCC", 3, "\xE2\x96\x84"}, {1, "\xCD", 3, "\xE2\x96\x88"},
	    {1, "\xCE", 3, "\xE2\x96\xAA"}, {1, "\xD0", 3, "\xE2\x94\x82"}, {1, "\xD1", 3, "\xE2\x94\x80"},
	    {1, "\xD2", 3, "\xE2\x94\x8C"}, {1, "\xD3", 3, "\xE2\x94\x90"}, {1, "\xD4", 3, "\xE2\x94\x94"},
	    {1, "\xD5", 3, "\xE2\x94\x98"}, {1, "\xD6", 3, "\xE2\x94\x9C"}, {1, "\xD7", 3, "\xE2\x94\xA4"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&ISO_10367_BOX_to_utf8),
		                                std::size(ISO_10367_BOX_to_utf8));
