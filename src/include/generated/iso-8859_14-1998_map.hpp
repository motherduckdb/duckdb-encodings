...
//                         DuckDB - Encodings
//
// generated/iso-8859_14-1998_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Iso_8859_14_1998ToUtf {
public:
	Iso_8859_14_1998ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "iso-8859_14-1998";
	// Generated from: iso-8859_14-1998.ucm
	static constexpr map_entry iso_8859_14_1998_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xE1\xB8\x82"},
	    {1, "\xA2", 3, "\xE1\xB8\x83"}, {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 2, "\xC4\x8A"},
	    {1, "\xA5", 2, "\xC4\x8B"},     {1, "\xA6", 3, "\xE1\xB8\x8A"}, {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 3, "\xE1\xBA\x80"}, {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 3, "\xE1\xBA\x82"},
	    {1, "\xAB", 3, "\xE1\xB8\x8B"}, {1, "\xAC", 3, "\xE1\xBB\xB2"}, {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xC2\xAE"},     {1, "\xAF", 2, "\xC5\xB8"},     {1, "\xB0", 3, "\xE1\xB8\x9E"},
	    {1, "\xB1", 3, "\xE1\xB8\x9F"}, {1, "\xB2", 2, "\xC4\xA0"},     {1, "\xB3", 2, "\xC4\xA1"},
	    {1, "\xB4", 3, "\xE1\xB9\x80"}, {1, "\xB5", 3, "\xE1\xB9\x81"}, {1, "\xB6", 2, "\xC2\xB6"},
	    {1, "\xB7", 3, "\xE1\xB9\x96"}, {1, "\xB8", 3, "\xE1\xBA\x81"}, {1, "\xB9", 3, "\xE1\xB9\x97"},
	    {1, "\xBA", 3, "\xE1\xBA\x83"}, {1, "\xBB", 3, "\xE1\xB9\xA0"}, {1, "\xBC", 3, "\xE1\xBB\xB3"},
	    {1, "\xBD", 3, "\xE1\xBA\x84"}, {1, "\xBE", 3, "\xE1\xBA\x85"}, {1, "\xBF", 3, "\xE1\xB9\xA1"},
	    ...
	    {1, "\xCF", 2, "\xC3\x8F"},     {1, "\xD0", 2, "\xC5\xB4"},     {1, "\xD1", 2, "\xC3\x91"},
	    {1, "\xD2", 2, "\xC3\x92"},     {1, "\xD3", 2, "\xC3\x93"},     {1, "\xD4", 2, "\xC3\x94"},
	    {1, "\xD5", 2, "\xC3\x95"},     {1, "\xD6", 2, "\xC3\x96"},     {1, "\xD7", 3, "\xE1\xB9\xAA"},
	    {1, "\xD8", 2, "\xC3\x98"},     {1, "\xD9", 2, "\xC3\x99"},     {1, "\xDA", 2, "\xC3\x9A"},
	    {1, "\xDB", 2, "\xC3\x9B"},     {1, "\xDC", 2, "\xC3\x9C"},     {1, "\xDD", 2, "\xC3\x9D"},
	    {1, "\xDE", 2, "\xC5\xB6"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC3\xA0"},
	    ...
	    {1, "\xF0", 2, "\xC5\xB5"},     {1, "\xF1", 2, "\xC3\xB1"},     {1, "\xF2", 2, "\xC3\xB2"},
	    {1, "\xF3", 2, "\xC3\xB3"},     {1, "\xF4", 2, "\xC3\xB4"},     {1, "\xF5", 2, "\xC3\xB5"},
	    {1, "\xF6", 2, "\xC3\xB6"},     {1, "\xF7", 3, "\xE1\xB9\xAB"}, {1, "\xF8", 2, "\xC3\xB8"},
	    {1, "\xF9", 2, "\xC3\xB9"},     {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},
	    {1, "\xFC", 2, "\xC3\xBC"},     {1, "\xFD", 2, "\xC3\xBD"},     {1, "\xFE", 2, "\xC5\xB7"},
	    {1, "\xFF", 2, "\xC3\xBF"},
	};
	static void Register(const DBConfig &config) {
		const Iso_8859_14_1998ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&iso_8859_14_1998_to_utf8),
		                                std::size(iso_8859_14_1998_to_utf8));
