...
//                         DuckDB - Encodings
//
// generated/glibc-ARMSCII_8-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_armscii_8_2_3_3ToUtf {
public:
	Glibc_armscii_8_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-ARMSCII_8-2.3.3";
	// Generated from: glibc-ARMSCII_8-2.3.3.ucm
	static constexpr map_entry glibc_ARMSCII_8_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA2", 2, "\xD6\x87"},
	    {1, "\xA3", 2, "\xD6\x89"},     {1, "\xA6", 2, "\xC2\xBB"}, {1, "\xA7", 2, "\xC2\xAB"},
	    {1, "\xA8", 3, "\xE2\x80\x94"}, {1, "\xAA", 2, "\xD5\x9D"}, {1, "\xAD", 2, "\xD6\x8A"},
	    {1, "\xAE", 3, "\xE2\x80\xA6"}, {1, "\xAF", 2, "\xD5\x9C"}, {1, "\xB0", 2, "\xD5\x9B"},
	    {1, "\xB1", 2, "\xD5\x9E"},     {1, "\xB2", 2, "\xD4\xB1"}, {1, "\xB3", 2, "\xD5\xA1"},
	    {1, "\xB4", 2, "\xD4\xB2"},     {1, "\xB5", 2, "\xD5\xA2"}, {1, "\xB6", 2, "\xD4\xB3"},
	    {1, "\xB7", 2, "\xD5\xA3"},     {1, "\xB8", 2, "\xD4\xB4"}, {1, "\xB9", 2, "\xD5\xA4"},
	    {1, "\xBA", 2, "\xD4\xB5"},     {1, "\xBB", 2, "\xD5\xA5"}, {1, "\xBC", 2, "\xD4\xB6"},
	    {1, "\xBD", 2, "\xD5\xA6"},     {1, "\xBE", 2, "\xD4\xB7"}, {1, "\xBF", 2, "\xD5\xA7"},
	    {1, "\xC0", 2, "\xD4\xB8"},     {1, "\xC1", 2, "\xD5\xA8"}, {1, "\xC2", 2, "\xD4\xB9"},
	    {1, "\xC3", 2, "\xD5\xA9"},     {1, "\xC4", 2, "\xD4\xBA"}, {1, "\xC5", 2, "\xD5\xAA"},
	    {1, "\xC6", 2, "\xD4\xBB"},     {1, "\xC7", 2, "\xD5\xAB"}, {1, "\xC8", 2, "\xD4\xBC"},
	    {1, "\xC9", 2, "\xD5\xAC"},     {1, "\xCA", 2, "\xD4\xBD"}, {1, "\xCB", 2, "\xD5\xAD"},
	    {1, "\xCC", 2, "\xD4\xBE"},     {1, "\xCD", 2, "\xD5\xAE"}, {1, "\xCE", 2, "\xD4\xBF"},
	    {1, "\xCF", 2, "\xD5\xAF"},     {1, "\xD0", 2, "\xD5\x80"}, {1, "\xD1", 2, "\xD5\xB0"},
	    {1, "\xD2", 2, "\xD5\x81"},     {1, "\xD3", 2, "\xD5\xB1"}, {1, "\xD4", 2, "\xD5\x82"},
	    {1, "\xD5", 2, "\xD5\xB2"},     {1, "\xD6", 2, "\xD5\x83"}, {1, "\xD7", 2, "\xD5\xB3"},
	    {1, "\xD8", 2, "\xD5\x84"},     {1, "\xD9", 2, "\xD5\xB4"}, {1, "\xDA", 2, "\xD5\x85"},
	    {1, "\xDB", 2, "\xD5\xB5"},     {1, "\xDC", 2, "\xD5\x86"}, {1, "\xDD", 2, "\xD5\xB6"},
	    {1, "\xDE", 2, "\xD5\x87"},     {1, "\xDF", 2, "\xD5\xB7"}, {1, "\xE0", 2, "\xD5\x88"},
	    {1, "\xE1", 2, "\xD5\xB8"},     {1, "\xE2", 2, "\xD5\x89"}, {1, "\xE3", 2, "\xD5\xB9"},
	    {1, "\xE4", 2, "\xD5\x8A"},     {1, "\xE5", 2, "\xD5\xBA"}, {1, "\xE6", 2, "\xD5\x8B"},
	    {1, "\xE7", 2, "\xD5\xBB"},     {1, "\xE8", 2, "\xD5\x8C"}, {1, "\xE9", 2, "\xD5\xBC"},
	    {1, "\xEA", 2, "\xD5\x8D"},     {1, "\xEB", 2, "\xD5\xBD"}, {1, "\xEC", 2, "\xD5\x8E"},
	    {1, "\xED", 2, "\xD5\xBE"},     {1, "\xEE", 2, "\xD5\x8F"}, {1, "\xEF", 2, "\xD5\xBF"},
	    {1, "\xF0", 2, "\xD5\x90"},     {1, "\xF1", 2, "\xD6\x80"}, {1, "\xF2", 2, "\xD5\x91"},
	    {1, "\xF3", 2, "\xD6\x81"},     {1, "\xF4", 2, "\xD5\x92"}, {1, "\xF5", 2, "\xD6\x82"},
	    {1, "\xF6", 2, "\xD5\x93"},     {1, "\xF7", 2, "\xD6\x83"}, {1, "\xF8", 2, "\xD5\x94"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&glibc_ARMSCII_8_2_3_3_to_utf8),
		                                std::size(glibc_ARMSCII_8_2_3_3_to_utf8));
