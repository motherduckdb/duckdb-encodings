...
class Iso8859_3ToUtf {
public:
	Iso8859_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ISO8859_3";
	// Generated from: aix-ISO8859_3-4.3.6.ucm
	static constexpr map_entry ISO8859_3_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&ISO8859_3_to_utf8), std::size(ISO8859_3_to_utf8));
