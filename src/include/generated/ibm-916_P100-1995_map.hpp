...
//                         DuckDB - Encodings
//
// generated/ibm-916_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_916_p100_1995ToUtf {
public:
	Ibm_916_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-916_P100-1995";
	// Generated from: ibm-916_P100-1995.ucm
	static constexpr map_entry ibm_916_P100_1995_to_utf8[] = {
	    ...
	    {1, "\xF9", 2, "\xD7\xA9"},     {1, "\xFA", 2, "\xD7\xAA"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_916_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_916_P100_1995_to_utf8),
		                                std::size(ibm_916_P100_1995_to_utf8));
