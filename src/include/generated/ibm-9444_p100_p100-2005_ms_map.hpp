...
public:
	...
	static constexpr map_entry ibm_9444_P100_P100_2005_MS_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Ibm_9444_p100_p100_2005_msToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_9444_P100_P100_2005_MS_to_utf8),
		                                std::size(ibm_9444_P100_P100_2005_MS_to_utf8));
