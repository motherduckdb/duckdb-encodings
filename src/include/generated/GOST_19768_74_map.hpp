...
//                         DuckDB - Encodings
//
// generated/GOST_19768_74_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Gost_19768_74ToUtf {
public:
	Gost_19768_74ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "GOST_19768_74";
	// Generated from: glibc-GOST_19768_74-2.1.2.ucm
	static constexpr map_entry GOST_19768_74_to_utf8[] = {
	    ...
	    {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA1", 2, "\xD0\x81"}, {1, "\xAD", 2, "\xC2\xAD"}, {1, "\xB0", 2, "\xD0\x90"},
	    {1, "\xB1", 2, "\xD0\x91"}, {1, "\xB2", 2, "\xD0\x92"}, {1, "\xB3", 2, "\xD0\x93"}, {1, "\xB4", 2, "\xD0\x94"},
	    {1, "\xB5", 2, "\xD0\x95"}, {1, "\xB6", 2, "\xD0\x96"}, {1, "\xB7", 2, "\xD0\x97"}, {1, "\xB8", 2, "\xD0\x98"},
	    {1, "\xB9", 2, "\xD0\x99"}, {1, "\xBA", 2, "\xD0\x9A"}, {1, "\xBB", 2, "\xD0\x9B"}, {1, "\xBC", 2, "\xD0\x9C"},
	    {1, "\xBD", 2, "\xD0\x9D"}, {1, "\xBE", 2, "\xD0\x9E"}, {1, "\xBF", 2, "\xD0\x9F"}, {1, "\xC0", 2, "\xD0\xA0"},
	    {1, "\xC1", 2, "\xD0\xA1"}, {1, "\xC2", 2, "\xD0\xA2"}, {1, "\xC3", 2, "\xD0\xA3"}, {1, "\xC4", 2, "\xD0\xA4"},
	    {1, "\xC5", 2, "\xD0\xA5"}, {1, "\xC6", 2, "\xD0\xA6"}, {1, "\xC7", 2, "\xD0\xA7"}, {1, "\xC8", 2, "\xD0\xA8"},
	    {1, "\xC9", 2, "\xD0\xA9"}, {1, "\xCA", 2, "\xD0\xAA"}, {1, "\xCB", 2, "\xD0\xAB"}, {1, "\xCC", 2, "\xD0\xAC"},
	    {1, "\xCD", 2, "\xD0\xAD"}, {1, "\xCE", 2, "\xD0\xAE"}, {1, "\xCF", 2, "\xD0\xAF"}, {1, "\xD0", 2, "\xD0\xB0"},
	    {1, "\xD1", 2, "\xD0\xB1"}, {1, "\xD2", 2, "\xD0\xB2"}, {1, "\xD3", 2, "\xD0\xB3"}, {1, "\xD4", 2, "\xD0\xB4"},
	    {1, "\xD5", 2, "\xD0\xB5"}, {1, "\xD6", 2, "\xD0\xB6"}, {1, "\xD7", 2, "\xD0\xB7"}, {1, "\xD8", 2, "\xD0\xB8"},
	    {1, "\xD9", 2, "\xD0\xB9"}, {1, "\xDA", 2, "\xD0\xBA"}, {1, "\xDB", 2, "\xD0\xBB"}, {1, "\xDC", 2, "\xD0\xBC"},
	    {1, "\xDD", 2, "\xD0\xBD"}, {1, "\xDE", 2, "\xD0\xBE"}, {1, "\xDF", 2, "\xD0\xBF"}, {1, "\xE0", 2, "\xD1\x80"},
	    {1, "\xE1", 2, "\xD1\x81"}, {1, "\xE2", 2, "\xD1\x82"}, {1, "\xE3", 2, "\xD1\x83"}, {1, "\xE4", 2, "\xD1\x84"},
	    {1, "\xE5", 2, "\xD1\x85"}, {1, "\xE6", 2, "\xD1\x86"}, {1, "\xE7", 2, "\xD1\x87"}, {1, "\xE8", 2, "\xD1\x88"},
	    {1, "\xE9", 2, "\xD1\x89"}, {1, "\xEA", 2, "\xD1\x8A"}, {1, "\xEB", 2, "\xD1\x8B"}, {1, "\xEC", 2, "\xD1\x8C"},
	    {1, "\xED", 2, "\xD1\x8D"}, {1, "\xEE", 2, "\xD1\x8E"}, {1, "\xEF", 2, "\xD1\x8F"}, {1, "\xF1", 2, "\xD1\x91"},
	};
	static void Register(const DBConfig &config) {
		const Gost_19768_74ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&GOST_19768_74_to_utf8),
		                                std::size(GOST_19768_74_to_utf8));
