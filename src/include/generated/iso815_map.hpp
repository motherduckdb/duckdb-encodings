...
public:
	...
	const string name = "iso815";
	// Generated from: hpux-iso815-11.0.ucm
	static constexpr map_entry iso815_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Iso815ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&iso815_to_utf8), std::size(iso815_to_utf8));
