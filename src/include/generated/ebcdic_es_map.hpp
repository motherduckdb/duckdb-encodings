...
class Ebcdic_esToUtf {
public:
	Ebcdic_esToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "EBCDIC_ES";
	// Generated from: glibc-EBCDIC_ES-2.1.2.ucm
	static constexpr map_entry EBCDIC_ES_to_utf8[] = {
	    ...
	    {1, "\x60", 1, "\x2D"},     {1, "\x61", 1, "\x2F"},         {1, "\x6A", 2, "\xC3\xB1"},
	    {1, "\x6B", 1, "\x2C"},     {1, "\x6C", 1, "\x25"},         {1, "\x6D", 1, "\x5F"},
	    {1, "\x6E", 1, "\x3E"},     {1, "\x6F", 1, "\x3F"},         {1, "\x79", 1, "\x60"},
	    {1, "\x7A", 1, "\x3A"},     {1, "\x7B", 2, "\xC3\x91"},     {1, "\x7C", 1, "\x40"},
	    ...
	    {1, "\xA1", 2, "\xC2\xA8"}, {1, "\xA2", 1, "\x73"},         {1, "\xA3", 1, "\x74"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&EBCDIC_ES_to_utf8), std::size(EBCDIC_ES_to_utf8));
