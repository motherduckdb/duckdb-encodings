...
//                         DuckDB - Encodings
//
// generated/ibm-813_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_813_p100_1995ToUtf {
public:
	Ibm_813_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-813_P100-1995";
	// Generated from: ibm-813_P100-1995.ucm
	static constexpr map_entry ibm_813_P100_1995_to_utf8[] = {
	    ...
	    {1, "\xA2", 3, "\xE2\x80\x99"}, {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA6", 2, "\xC2\xA6"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_813_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_813_P100_1995_to_utf8),
		                                std::size(ibm_813_P100_1995_to_utf8));
