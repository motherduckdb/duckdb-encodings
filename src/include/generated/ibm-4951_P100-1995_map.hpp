...
//                         DuckDB - Encodings
//
// generated/ibm-4951_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_4951_p100_1995ToUtf {
public:
	Ibm_4951_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-4951_P100-1995";
	// Generated from: ibm-4951_P100-1995.ucm
	static constexpr map_entry ibm_4951_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\x80", 2, "\xD1\x92"},
	    ...
	    {1, "\xB5", 2, "\xD1\x85"},     {1, "\xB6", 2, "\xD0\xA5"},     {1, "\xB7", 2, "\xD0\xB8"},
	    {1, "\xB8", 2, "\xD0\x98"},     {1, "\xBD", 2, "\xD0\xB9"},     {1, "\xBE", 2, "\xD0\x99"},
	    {1, "\xC6", 2, "\xD0\xBA"},     {1, "\xC7", 2, "\xD0\x9A"},     {1, "\xD0", 2, "\xD0\xBB"},
	    {1, "\xD1", 2, "\xD0\x9B"},     {1, "\xD2", 2, "\xD0\xBC"},     {1, "\xD3", 2, "\xD0\x9C"},
	    {1, "\xD4", 2, "\xD0\xBD"},     {1, "\xD5", 2, "\xD0\x9D"},     {1, "\xD6", 2, "\xD0\xBE"},
	    {1, "\xD7", 2, "\xD0\x9E"},     {1, "\xD8", 2, "\xD0\xBF"},     {1, "\xDD", 2, "\xD0\x9F"},
	    {1, "\xDE", 2, "\xD1\x8F"},     {1, "\xE0", 2, "\xD0\xAF"},     {1, "\xE1", 2, "\xD1\x80"},
	    {1, "\xE2", 2, "\xD0\xA0"},     {1, "\xE3", 2, "\xD1\x81"},     {1, "\xE4", 2, "\xD0\xA1"},
	    {1, "\xE5", 2, "\xD1\x82"},     {1, "\xE6", 2, "\xD0\xA2"},     {1, "\xE7", 2, "\xD1\x83"},
	    {1, "\xE8", 2, "\xD0\xA3"},     {1, "\xE9", 2, "\xD0\xB6"},     {1, "\xEA", 2, "\xD0\x96"},
	    {1, "\xEB", 2, "\xD0\xB2"},     {1, "\xEC", 2, "\xD0\x92"},     {1, "\xED", 2, "\xD1\x8C"},
	    {1, "\xEE", 2, "\xD0\xAC"},     {1, "\xEF", 3, "\xE2\x84\x96"}, {1, "\xF0", 2, "\xC2\xAD"},
	    {1, "\xF1", 2, "\xD1\x8B"},     {1, "\xF2", 2, "\xD0\xAB"},     {1, "\xF3", 2, "\xD0\xB7"},
	    {1, "\xF4", 2, "\xD0\x97"},     {1, "\xF5", 2, "\xD1\x88"},     {1, "\xF6", 2, "\xD0\xA8"},
	    {1, "\xF7", 2, "\xD1\x8D"},     {1, "\xF8", 2, "\xD0\xAD"},     {1, "\xF9", 2, "\xD1\x89"},
	    {1, "\xFA", 2, "\xD0\xA9"},     {1, "\xFB", 2, "\xD1\x87"},     {1, "\xFC", 2, "\xD0\xA7"},
	    {1, "\xFD", 2, "\xC2\xA7"},     {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_4951_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_4951_P100_1995_to_utf8),
		                                std::size(ibm_4951_P100_1995_to_utf8));
