...
//                         DuckDB - Encodings
//
// generated/glibc-CSA_Z243.4_1985_1-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_csa_z243_4_1985_1_2_3_3ToUtf {
public:
	Glibc_csa_z243_4_1985_1_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "glibc-CSA_Z243.4_1985_1-2.3.3";
	// Generated from: glibc-CSA_Z243.4_1985_1-2.3.3.ucm
	static constexpr map_entry glibc_CSA_Z243_4_1985_1_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},     {1, "\x5A", 1, "\x5A"},     {1, "\x5B", 2, "\xC3\xA2"},
	    {1, "\x5C", 2, "\xC3\xA7"}, {1, "\x5D", 2, "\xC3\xAA"}, {1, "\x5E", 2, "\xC3\xAE"}, {1, "\x5F", 1, "\x5F"},
	    {1, "\x60", 2, "\xC3\xB4"}, {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},     {1, "\x63", 1, "\x63"},
	    ...
	    {1, "\x7C", 2, "\xC3\xB9"}, {1, "\x7D", 2, "\xC3\xA8"}, {1, "\x7E", 2, "\xC3\xBB"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_csa_z243_4_1985_1_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_CSA_Z243_4_1985_1_2_3_3_to_utf8),
		                                std::size(glibc_CSA_Z243_4_1985_1_2_3_3_to_utf8));
