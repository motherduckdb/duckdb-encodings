...
public:
	...
	// Generated from: ibm-1277_P100-1995.ucm
	static constexpr map_entry ibm_1277_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x27", 3, "\xE2\x80\x99"}, {1, "\x28", 3, "\xEF\xBC\x88"}, {1, "\x29", 3, "\xEF\xBC\x89"},
	    ...
	    {1, "\x60", 3, "\xE2\x80\x98"}, {1, "\x61", 3, "\xEF\xBD\x81"}, {1, "\x62", 3, "\xEF\xBD\x82"},
	    ...
	    {1, "\x90", 2, "\xC4\xB1"},     {1, "\x91", 3, "\xEF\xBD\x80"}, {1, "\x92", 2, "\xC2\xB4"},
	    {1, "\x93", 2, "\xCB\x86"},     {1, "\x94", 2, "\xCB\x9C"},     {1, "\x95", 2, "\xC2\xAF"},
	    {1, "\x96", 2, "\xCB\x98"},     {1, "\x97", 2, "\xCB\x99"},     {1, "\x98", 2, "\xC2\xA8"},
	    {1, "\x99", 2, "\xC2\x99"},     {1, "\x9A", 2, "\xCB\x9A"},     {1, "\x9B", 2, "\xC2\xB8"},
	    {1, "\x9C", 2, "\xC2\x9C"},     {1, "\x9D", 2, "\xCB\x9D"},     {1, "\x9E", 2, "\xCB\x9B"},
	    {1, "\x9F", 2, "\xCB\x87"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xC2\xA1"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_1277_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1277_P100_1995_to_utf8),
		                                std::size(ibm_1277_P100_1995_to_utf8));
