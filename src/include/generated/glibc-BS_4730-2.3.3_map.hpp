...
//                         DuckDB - Encodings
//
// generated/glibc-BS_4730-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_bs_4730_2_3_3ToUtf {
public:
	Glibc_bs_4730_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-BS_4730-2.3.3";
	// Generated from: glibc-BS_4730-2.3.3.ucm
	static constexpr map_entry glibc_BS_4730_2_3_3_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Glibc_bs_4730_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_BS_4730_2_3_3_to_utf8),
		                                std::size(glibc_BS_4730_2_3_3_to_utf8));
