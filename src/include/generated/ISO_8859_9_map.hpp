...
class Iso_8859_9ToUtf {
public:
	Iso_8859_9ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "ISO_8859_9";
	// Generated from: glibc-ISO_8859_9-2.1.2.ucm
	static constexpr map_entry ISO_8859_9_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Iso_8859_9ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ISO_8859_9_to_utf8),
		                                std::size(ISO_8859_9_to_utf8));
