...
//                         DuckDB - Encodings
//
// generated/windows-1255-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_1255_2000ToUtf {
public:
	Windows_1255_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-1255-2000";
	// Generated from: windows-1255-2000.ucm
	static constexpr map_entry windows_1255_2000_to_utf8[] = {
	    ...
	    {1, "\xA2", 2, "\xC2\xA2"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xE2\x82\xAA"},
	    ...
	    {1, "\xC0", 2, "\xD6\xB0"},     {1, "\xC1", 2, "\xD6\xB1"},     {1, "\xC2", 2, "\xD6\xB2"},
	    {1, "\xC3", 2, "\xD6\xB3"},     {1, "\xC4", 2, "\xD6\xB4"},     {1, "\xC5", 2, "\xD6\xB5"},
	    {1, "\xC6", 2, "\xD6\xB6"},     {1, "\xC7", 2, "\xD6\xB7"},     {1, "\xC8", 2, "\xD6\xB8"},
	    {1, "\xC9", 2, "\xD6\xB9"},     {1, "\xCA", 2, "\xD6\xBA"},     {1, "\xCB", 2, "\xD6\xBB"},
	    ...
	    {1, "\xD5", 2, "\xD7\xB1"},     {1, "\xD6", 2, "\xD7\xB2"},     {1, "\xD7", 2, "\xD7\xB3"},
	    {1, "\xD8", 2, "\xD7\xB4"},     {1, "\xD9", 3, "\xEF\xA2\x8D"}, {1, "\xDA", 3, "\xEF\xA2\x8E"},
	    {1, "\xDB", 3, "\xEF\xA2\x8F"}, {1, "\xDC", 3, "\xEF\xA2\x90"}, {1, "\xDD", 3, "\xEF\xA2\x91"},
	    {1, "\xDE", 3, "\xEF\xA2\x92"}, {1, "\xDF", 3, "\xEF\xA2\x93"}, {1, "\xE0", 2, "\xD7\x90"},
	    ...
	    {1, "\xF9", 2, "\xD7\xA9"},     {1, "\xFA", 2, "\xD7\xAA"},     {1, "\xFB", 3, "\xEF\xA2\x94"},
	    {1, "\xFC", 3, "\xEF\xA2\x95"}, {1, "\xFD", 3, "\xE2\x80\x8E"}, {1, "\xFE", 3, "\xE2\x80\x8F"},
	    {1, "\xFF", 3, "\xEF\xA2\x96"},
	};
	static void Register(const DBConfig &config) {
		const Windows_1255_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_1255_2000_to_utf8),
		                                std::size(windows_1255_2000_to_utf8));
