...
public:
	...
	const string name = "IBM281";
	// Generated from: glibc-IBM281-2.1.2.ucm
	static constexpr map_entry IBM281_to_utf8[] = {
	    ...
	    {1, "\xD8", 1, "\x51"},         {1, "\xD9", 1, "\x52"},     {1, "\xE0", 1, "\x24"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&IBM281_to_utf8), std::size(IBM281_to_utf8));
