...
//                         DuckDB - Encodings
//
// generated/glibc-msz_7795.3-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_msz_7795_3_2_3_3ToUtf {
public:
	Glibc_msz_7795_3_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "glibc-MSZ_7795.3-2.3.3";
	// Generated from: glibc-MSZ_7795.3-2.3.3.ucm
	static constexpr map_entry glibc_MSZ_7795_3_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x40", 2, "\xC3\x81"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"},     {1, "\x43", 1, "\x43"},
	    ...
	    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},     {1, "\x5A", 1, "\x5A"},     {1, "\x5B", 2, "\xC3\x89"},
	    {1, "\x5C", 2, "\xC3\x96"}, {1, "\x5D", 2, "\xC3\x9C"}, {1, "\x5E", 1, "\x5E"},     {1, "\x5F", 1, "\x5F"},
	    {1, "\x60", 2, "\xC3\xA1"}, {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},     {1, "\x63", 1, "\x63"},
	    ...
	    {1, "\x7C", 2, "\xC3\xB6"}, {1, "\x7D", 2, "\xC3\xBC"}, {1, "\x7E", 2, "\xCB\x9D"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_msz_7795_3_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_MSZ_7795_3_2_3_3_to_utf8),
		                                std::size(glibc_MSZ_7795_3_2_3_3_to_utf8));
