...
//                         DuckDB - Encodings
//
// generated/glibc-ECMA_CYRILLIC-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_ecma_cyrillic_2_3_3ToUtf {
public:
	Glibc_ecma_cyrillic_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-ECMA_CYRILLIC-2.3.3";
	// Generated from: glibc-ECMA_CYRILLIC-2.3.3.ucm
	static constexpr map_entry glibc_ECMA_CYRILLIC_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"}, {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA1", 2, "\xD1\x92"},
	    {1, "\xA2", 2, "\xD1\x93"}, {1, "\xA3", 2, "\xD1\x91"}, {1, "\xA4", 2, "\xD1\x94"},
	    {1, "\xA5", 2, "\xD1\x95"}, {1, "\xA6", 2, "\xD1\x96"}, {1, "\xA7", 2, "\xD1\x97"},
	    {1, "\xA8", 2, "\xD1\x98"}, {1, "\xA9", 2, "\xD1\x99"}, {1, "\xAA", 2, "\xD1\x9A"},
	    {1, "\xAB", 2, "\xD1\x9B"}, {1, "\xAC", 2, "\xD1\x9C"}, {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xD1\x9E"}, {1, "\xAF", 2, "\xD1\x9F"}, {1, "\xB0", 3, "\xE2\x84\x96"},
	    {1, "\xB1", 2, "\xD0\x82"}, {1, "\xB2", 2, "\xD0\x83"}, {1, "\xB3", 2, "\xD0\x81"},
	    {1, "\xB4", 2, "\xD0\x84"}, {1, "\xB5", 2, "\xD0\x85"}, {1, "\xB6", 2, "\xD0\x86"},
	    {1, "\xB7", 2, "\xD0\x87"}, {1, "\xB8", 2, "\xD0\x88"}, {1, "\xB9", 2, "\xD0\x89"},
	    {1, "\xBA", 2, "\xD0\x8A"}, {1, "\xBB", 2, "\xD0\x8B"}, {1, "\xBC", 2, "\xD0\x8C"},
	    {1, "\xBD", 2, "\xC2\xA4"}, {1, "\xBE", 2, "\xD0\x8E"}, {1, "\xBF", 2, "\xD0\x8F"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&glibc_ECMA_CYRILLIC_2_3_3_to_utf8),
		                                std::size(glibc_ECMA_CYRILLIC_2_3_3_to_utf8));
