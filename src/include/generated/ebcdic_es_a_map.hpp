...
public:
	...
	static constexpr map_entry EBCDIC_ES_A_to_utf8[] = {
	    ...
	    {1, "\xD9", 1, "\x52"},     {1, "\xE2", 1, "\x53"},         {1, "\xE3", 1, "\x54"},
	    ...
	    {1, "\xF9", 1, "\x39"},     {1, "\xFF", 2, "\xC2\x9F"},
	};
	static void Register(const DBConfig &config) {
		const Ebcdic_es_aToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&EBCDIC_ES_A_to_utf8),
		                                std::size(EBCDIC_ES_A_to_utf8));
