...
//                         DuckDB - Encodings
//
// generated/ibm-1163_P100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1163_p100_1999ToUtf {
public:
	Ibm_1163_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1163_P100-1999";
	// Generated from: ibm-1163_P100-1999.ucm
	static constexpr map_entry ibm_1163_P100_1999_to_utf8[] = {
	    ...
	    {1, "\xA8", 2, "\xC5\x93"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 2, "\xC2\xAA"},
	    ...
	    {1, "\xB4", 2, "\xC5\xB8"},     {1, "\xB5", 2, "\xC2\xB5"},     {1, "\xB6", 2, "\xC2\xB6"},
	    {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC5\x92"},     {1, "\xB9", 2, "\xC2\xB9"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_1163_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1163_P100_1999_to_utf8),
		                                std::size(ibm_1163_P100_1999_to_utf8));
