...
//                         DuckDB - Encodings
//
// generated/ibm-1133_p100-1997_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1133_p100_1997ToUtf {
public:
	Ibm_1133_p100_1997ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1133_P100-1997";
	// Generated from: ibm-1133_P100-1997.ucm
	static constexpr map_entry ibm_1133_P100_1997_to_utf8[] = {
	    ...
	    {1, "\xDD", 3, "\xE0\xBB\x9C"}, {1, "\xDE", 3, "\xE0\xBB\x9D"}, {1, "\xDF", 1, "\x6B"},
	    {1, "\xF0", 3, "\xE0\xBB\x90"}, {1, "\xF1", 3, "\xE0\xBB\x91"}, {1, "\xF2", 3, "\xE0\xBB\x92"},
	    {1, "\xF3", 3, "\xE0\xBB\x93"}, {1, "\xF4", 3, "\xE0\xBB\x94"}, {1, "\xF5", 3, "\xE0\xBB\x95"},
	    {1, "\xF6", 3, "\xE0\xBB\x96"}, {1, "\xF7", 3, "\xE0\xBB\x97"}, {1, "\xF8", 3, "\xE0\xBB\x98"},
	    {1, "\xF9", 3, "\xE0\xBB\x99"}, {1, "\xFC", 2, "\xC2\xA2"},     {1, "\xFD", 2, "\xC2\xAC"},
	    {1, "\xFE", 2, "\xC2\xA6"},     {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1133_p100_1997ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1133_P100_1997_to_utf8),
		                                std::size(ibm_1133_P100_1997_to_utf8));
