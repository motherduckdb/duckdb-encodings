...
//                         DuckDB - Encodings
//
// generated/ibm-737_p100-1997_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_737_p100_1997ToUtf {
public:
	Ibm_737_p100_1997ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-737_P100-1997";
	// Generated from: ibm-737_P100-1997.ucm
	static constexpr map_entry ibm_737_P100_1997_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 3, "\xE2\x8C\x82"}, {1, "\x80", 2, "\xCE\x91"},
	    ...
	    {1, "\xAB", 2, "\xCF\x84"},     {1, "\xAC", 2, "\xCF\x85"},     {1, "\xAD", 2, "\xCF\x95"},
	    ...
	    {1, "\xFC", 3, "\xE2\x81\xBF"}, {1, "\xFD", 2, "\xC2\xB2"},     {1, "\xFE", 3, "\xEF\xBF\xAD"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_737_p100_1997ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_737_P100_1997_to_utf8),
		                                std::size(ibm_737_P100_1997_to_utf8));
