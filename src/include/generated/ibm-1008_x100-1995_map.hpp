...
//                         DuckDB - Encodings
//
// generated/ibm-1008_x100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1008_x100_1995ToUtf {
public:
	Ibm_1008_x100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1008_X100-1995";
	// Generated from: ibm-1008_X100-1995.ucm
	static constexpr map_entry ibm_1008_X100_1995_to_utf8[] = {
	    ...
	    {1, "\xA8", 2, "\xD9\x80"},     {1, "\xA9", 3, "\xE2\x80\x8C"}, {1, "\xAA", 3, "\xEF\xBA\x80"},
	    ...
	    {1, "\xCF", 3, "\xEF\xBA\xB0"}, {1, "\xD0", 3, "\xEF\xBA\xB2"}, {1, "\xD1", 3, "\xEF\xBA\xB4"},
	    {1, "\xD2", 3, "\xEF\xBA\xB6"}, {1, "\xD3", 3, "\xEF\xBA\xB8"}, {1, "\xD4", 3, "\xEF\xBA\xBA"},
	    {1, "\xD5", 3, "\xEF\xBA\xBC"}, {1, "\xD6", 3, "\xEF\xBA\xBE"}, {1, "\xD7", 2, "\xC3\x97"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_1008_x100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1008_X100_1995_to_utf8),
		                                std::size(ibm_1008_X100_1995_to_utf8));
