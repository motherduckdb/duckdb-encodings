...
//                         DuckDB - Encodings
//
// generated/ibm-1006_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1006_p100_1995ToUtf {
public:
	Ibm_1006_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1006_P100-1995";
	// Generated from: ibm-1006_P100-1995.ucm
	static constexpr map_entry ibm_1006_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xDB\xB0"},
	    {1, "\xA2", 2, "\xDB\xB1"},     {1, "\xA3", 2, "\xDB\xB2"},     {1, "\xA4", 2, "\xDB\xB3"},
	    {1, "\xA5", 2, "\xDB\xB4"},     {1, "\xA6", 2, "\xDB\xB5"},     {1, "\xA7", 2, "\xDB\xB6"},
	    {1, "\xA8", 2, "\xDB\xB7"},     {1, "\xA9", 2, "\xDB\xB8"},     {1, "\xAA", 2, "\xDB\xB9"},
	    {1, "\xAB", 2, "\xD8\x8C"},     {1, "\xAC", 2, "\xD8\x9B"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xD8\x9F"},     {1, "\xAF", 3, "\xEF\xBA\x81"}, {1, "\xB0", 3, "\xEF\xBA\x8D"},
	    {1, "\xB1", 3, "\xEF\xBA\x8E"}, {1, "\xB2", 3, "\xEF\xA3\xBB"}, {1, "\xB3", 3, "\xEF\xBA\x90"},
	    {1, "\xB4", 3, "\xEF\xBA\x92"}, {1, "\xB5", 3, "\xEF\xAD\x96"}, {1, "\xB6", 3, "\xEF\xAD\x98"},
	    {1, "\xB7", 3, "\xEF\xBA\x94"}, {1, "\xB8", 3, "\xEF\xBA\x96"}, {1, "\xB9", 3, "\xEF\xBA\x98"},
	    {1, "\xBA", 3, "\xEF\xAD\xA6"}, {1, "\xBB", 3, "\xEF\xAD\xA8"}, {1, "\xBC", 3, "\xEF\xBA\x9A"},
	    {1, "\xBD", 3, "\xEF\xBA\x9C"}, {1, "\xBE", 3, "\xEF\xBA\x9E"}, {1, "\xBF", 3, "\xEF\xBA\xA0"},
	    {1, "\xC0", 3, "\xEF\xAD\xBA"}, {1, "\xC1", 3, "\xEF\xAD\xBC"}, {1, "\xC2", 3, "\xEF\xBA\xA2"},
	    {1, "\xC3", 3, "\xEF\xBA\xA4"}, {1, "\xC4", 3, "\xEF\xBA\xA6"}, {1, "\xC5", 3, "\xEF\xBA\xA8"},
	    {1, "\xC6", 3, "\xEF\xBA\xAA"}, {1, "\xC7", 3, "\xEF\xAE\x88"}, {1, "\xC8", 3, "\xEF\xBA\xAC"},
	    {1, "\xC9", 3, "\xEF\xBA\xAE"}, {1, "\xCA", 3, "\xEF\xAE\x8C"}, {1, "\xCB", 3, "\xEF\xBA\xB0"},
	    {1, "\xCC", 3, "\xEF\xAE\x8A"}, {1, "\xCD", 3, "\xEF\xBA\xB2"}, {1, "\xCE", 3, "\xEF\xBA\xB4"},
	    {1, "\xCF", 3, "\xEF\xBA\xB6"}, {1, "\xD0", 3, "\xEF\xBA\xB8"}, {1, "\xD1", 3, "\xEF\xBA\xBA"},
	    {1, "\xD2", 3, "\xEF\xBA\xBC"}, {1, "\xD3", 3, "\xEF\xBA\xBE"}, {1, "\xD4", 3, "\xEF\xBB\x80"},
	    {1, "\xD5", 3, "\xEF\xBB\x84"}, {1, "\xD6", 3, "\xEF\xBB\x88"}, {1, "\xD7", 3, "\xEF\xBB\x89"},
	    {1, "\xD8", 3, "\xEF\xBB\x8A"}, {1, "\xD9", 3, "\xEF\xBB\x8B"}, {1, "\xDA", 3, "\xEF\xBB\x8C"},
	    {1, "\xDB", 3, "\xEF\xBB\x8D"}, {1, "\xDC", 3, "\xEF\xBB\x8E"}, {1, "\xDD", 3, "\xEF\xBB\x8F"},
	    {1, "\xDE", 3, "\xEF\xBB\x90"}, {1, "\xDF", 3, "\xEF\xBB\x92"}, {1, "\xE0", 3, "\xEF\xBB\x94"},
	    {1, "\xE1", 3, "\xEF\xBB\x96"}, {1, "\xE2", 3, "\xEF\xBB\x98"}, {1, "\xE3", 3, "\xEF\xAE\x8E"},
	    {1, "\xE4", 3, "\xEF\xBB\x9C"}, {1, "\xE5", 3, "\xEF\xAE\x92"}, {1, "\xE6", 3, "\xEF\xAE\x94"},
	    {1, "\xE7", 3, "\xEF\xBB\x9E"}, {1, "\xE8", 3, "\xEF\xBB\x9F"}, {1, "\xE9", 3, "\xEF\xBB\xA0"},
	    {1, "\xEA", 3, "\xEF\xBB\xA2"}, {1, "\xEB", 3, "\xEF\xBB\xA4"}, {1, "\xEC", 3, "\xEF\xAE\x9E"},
	    {1, "\xED", 3, "\xEF\xBB\xA6"}, {1, "\xEE", 3, "\xEF\xBB\xA8"}, {1, "\xEF", 3, "\xEF\xBA\x86"},
	    {1, "\xF0", 3, "\xEF\xBB\xAE"}, {1, "\xF1", 3, "\xEF\xAE\xA6"}, {1, "\xF2", 3, "\xEF\xAE\xA8"},
	    {1, "\xF3", 3, "\xEF\xAE\xA9"}, {1, "\xF4", 3, "\xEF\xAE\xAA"}, {1, "\xF5", 3, "\xEF\xBA\x80"},
	    {1, "\xF6", 3, "\xEF\xBA\x89"}, {1, "\xF7", 3, "\xEF\xBA\x8A"}, {1, "\xF8", 3, "\xEF\xBA\x8C"},
	    {1, "\xF9", 3, "\xEF\xAF\xBC"}, {1, "\xFA", 3, "\xEF\xAF\xBD"}, {1, "\xFB", 3, "\xEF\xAF\xBE"},
	    {1, "\xFC", 3, "\xEF\xAE\xB0"}, {1, "\xFD", 3, "\xEF\xAE\xAE"}, {1, "\xFE", 3, "\xEF\xB9\xBC"},
	    {1, "\xFF", 3, "\xEF\xB9\xBD"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1006_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1006_P100_1995_to_utf8),
		                                std::size(ibm_1006_P100_1995_to_utf8));
