...
//                         DuckDB - Encodings
//
// generated/java-ascii-1.3_p_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Java_ascii_1_3_pToUtf {
public:
	Java_ascii_1_3_pToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 1;
	const string name = "java-ASCII-1.3_P";
	// Generated from: java-ASCII-1.3_P.ucm
	static constexpr map_entry java_ASCII_1_3_P_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&java_ASCII_1_3_P_to_utf8),
		                                std::size(java_ASCII_1_3_P_to_utf8));
