...
//                         DuckDB - Encodings
//
// generated/ibm-4948_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_4948_p100_1995ToUtf {
public:
	Ibm_4948_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-4948_P100-1995";
	// Generated from: ibm-4948_P100-1995.ucm
	static constexpr map_entry ibm_4948_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\x80", 2, "\xC3\x87"},
	    ...
	    {1, "\xAC", 2, "\xC4\x8C"},     {1, "\xAD", 2, "\xC5\x9F"},     {1, "\xB5", 2, "\xC3\x81"},
	    {1, "\xB6", 2, "\xC3\x82"},     {1, "\xB7", 2, "\xC4\x9A"},     {1, "\xB8", 2, "\xC5\x9E"},
	    {1, "\xBD", 2, "\xC5\xBB"},     {1, "\xBE", 2, "\xC5\xBC"},     {1, "\xC6", 2, "\xC4\x82"},
	    {1, "\xC7", 2, "\xC4\x83"},     {1, "\xCF", 2, "\xC2\xA4"},     {1, "\xD0", 2, "\xC4\x91"},
	    {1, "\xD1", 2, "\xC4\x90"},     {1, "\xD2", 2, "\xC4\x8E"},     {1, "\xD3", 2, "\xC3\x8B"},
	    {1, "\xD4", 2, "\xC4\x8F"},     {1, "\xD5", 2, "\xC5\x87"},     {1, "\xD6", 2, "\xC3\x8D"},
	    {1, "\xD7", 2, "\xC3\x8E"},     {1, "\xD8", 2, "\xC4\x9B"},     {1, "\xDD", 2, "\xC5\xA2"},
	    {1, "\xDE", 2, "\xC5\xAE"},     {1, "\xE0", 2, "\xC3\x93"},     {1, "\xE1", 2, "\xC3\x9F"},
	    ...
	    {1, "\xFD", 2, "\xC5\x99"},     {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_4948_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_4948_P100_1995_to_utf8),
		                                std::size(ibm_4948_P100_1995_to_utf8));
