...
//                         DuckDB - Encodings
//
// generated/macos-515-10.2_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Macos_515_10_2ToUtf {
public:
	Macos_515_10_2ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "macos-515-10.2";
	// Generated from: macos-515-10.2.ucm
	static constexpr map_entry macos_515_10_2_to_utf8[] = {
	    ...
	    {1, "\xA2", 2, "\xCC\x86"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 2, "\xC2\xA4"},
	    {1, "\xA6", 2, "\xC4\xA4"},     {1, "\xA7", 2, "\xC2\xA7"},     {1, "\xA8", 2, "\xCC\x88"},
	    {1, "\xA9", 2, "\xC4\xB0"},     {1, "\xAA", 2, "\xC5\x9E"},     {1, "\xAB", 2, "\xC4\x9E"},
	    {1, "\xAC", 2, "\xC4\xB4"},     {1, "\xAD", 2, "\xC2\xAD"},     {1, "\xAF", 2, "\xC5\xBB"},
	    {1, "\xB0", 2, "\xC2\xB0"},     {1, "\xB1", 2, "\xC4\xA7"},     {1, "\xB2", 2, "\xC2\xB2"},
	    {1, "\xB3", 2, "\xC2\xB3"},     {1, "\xB4", 2, "\xCC\x81"},     {1, "\xB5", 2, "\xC2\xB5"},
	    {1, "\xB6", 2, "\xC4\xA5"},     {1, "\xB7", 3, "\xE2\x8B\x85"}, {1, "\xB8", 2, "\xCC\xA7"},
	    {1, "\xB9", 2, "\xC4\xB1"},     {1, "\xBA", 2, "\xC5\x9F"},     {1, "\xBB", 2, "\xC4\x9F"},
	    {1, "\xBC", 2, "\xC4\xB5"},     {1, "\xBD", 2, "\xC2\xBD"},     {1, "\xBF", 2, "\xC5\xBC"},
	    {1, "\xC0", 2, "\xC3\x80"},     {1, "\xC1", 2, "\xC3\x81"},     {1, "\xC2", 2, "\xC3\x82"},
	    {1, "\xC4", 2, "\xC3\x84"},     {1, "\xC5", 2, "\xC4\x8A"},     {1, "\xC6", 2, "\xC4\x88"},
	    ...
	    {1, "\xD4", 2, "\xC3\x94"},     {1, "\xD5", 2, "\xC4\xA0"},     {1, "\xD6", 2, "\xC3\x96"},
	    {1, "\xD7", 2, "\xC3\x97"},     {1, "\xD8", 2, "\xC4\x9C"},     {1, "\xD9", 2, "\xC3\x99"},
	    {1, "\xDA", 2, "\xC3\x9A"},     {1, "\xDB", 2, "\xC3\x9B"},     {1, "\xDC", 2, "\xC3\x9C"},
	    {1, "\xDD", 2, "\xC5\xAC"},     {1, "\xDE", 2, "\xC5\x9C"},     {1, "\xDF", 2, "\xC3\x9F"},
	    ...
	    {1, "\xF4", 2, "\xC3\xB4"},     {1, "\xF5", 2, "\xC4\xA1"},     {1, "\xF6", 2, "\xC3\xB6"},
	    {1, "\xF7", 2, "\xC3\xB7"},     {1, "\xF8", 2, "\xC4\x9D"},     {1, "\xF9", 2, "\xC3\xB9"},
	    {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},     {1, "\xFC", 2, "\xC3\xBC"},
	    {1, "\xFD", 2, "\xC5\xAD"},     {1, "\xFE", 2, "\xC5\x9D"},     {1, "\xFF", 2, "\xCC\x87"},
	};
	static void Register(const DBConfig &config) {
		const Macos_515_10_2ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&macos_515_10_2_to_utf8),
		                                std::size(macos_515_10_2_to_utf8));
