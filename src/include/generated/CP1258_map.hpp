...
public:
	...
	const string name = "CP1258";
	// Generated from: glibc-CP1258-2.1.2.ucm
	static constexpr map_entry CP1258_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&CP1258_to_utf8), std::size(CP1258_to_utf8));
