...
//                         DuckDB - Encodings
//
// generated/ibm-9066_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_9066_p100_1995ToUtf {
public:
	Ibm_9066_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-9066_P100-1995";
	// Generated from: ibm-9066_P100-1995.ucm
	static constexpr map_entry ibm_9066_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\xA0", 3, "\xE0\xB9\x88"},
	    ...
	    {1, "\xDA", 3, "\xE0\xB8\xBA"}, {1, "\xDB", 3, "\xE0\xB9\x89"}, {1, "\xDC", 3, "\xE0\xB9\x8A"},
	    {1, "\xDD", 3, "\xE0\xB9\x8B"}, {1, "\xDE", 3, "\xE0\xB9\x8C"}, {1, "\xDF", 3, "\xE0\xB8\xBF"},
	    ...
	    {1, "\xEC", 3, "\xE0\xB9\x8C"}, {1, "\xED", 3, "\xE0\xB9\x8D"}, {1, "\xEE", 3, "\xE0\xB9\x8E"},
	    ...
	    {1, "\xF8", 3, "\xE0\xB9\x98"}, {1, "\xF9", 3, "\xE0\xB9\x99"}, {1, "\xFA", 3, "\xE0\xB9\x9A"},
	    {1, "\xFB", 3, "\xE0\xB9\x9B"}, {1, "\xFC", 2, "\xC2\xA2"},     {1, "\xFD", 2, "\xC2\xAC"},
	    {1, "\xFE", 2, "\xC2\xA6"},     {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_9066_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_9066_P100_1995_to_utf8),
		                                std::size(ibm_9066_P100_1995_to_utf8));
