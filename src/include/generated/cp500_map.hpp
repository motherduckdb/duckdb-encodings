...
public:
	...
	const map<vector<uint8_t>, vector<uint8_t>> cp500_to_utf8 = {
	    ...
	    {{0x48}, {0xC3, 0xA7}}, {{0x49}, {0xC3, 0xB1}}, {{0x4A}, {0x5B}},       {{0x4B}, {0x2E}},
	    {{0x4C}, {0x3C}},       {{0x4D}, {0x28}},       {{0x4E}, {0x2B}},       {{0x4F}, {0x21}},
	    {{0x50}, {0x26}},       {{0x51}, {0xC3, 0xA9}}, {{0x52}, {0xC3, 0xAA}}, {{0x53}, {0xC3, 0xAB}},
	    {{0x54}, {0xC3, 0xA8}}, {{0x55}, {0xC3, 0xAD}}, {{0x56}, {0xC3, 0xAE}}, {{0x57}, {0xC3, 0xAF}},
	    {{0x58}, {0xC3, 0xAC}}, {{0x59}, {0xC3, 0x9F}}, {{0x5A}, {0x5D}},       {{0x5B}, {0x24}},
	    ...
	    {{0xB0}, {0xC2, 0xA2}}, {{0xB1}, {0xC2, 0xA3}}, {{0xB2}, {0xC2, 0xA5}}, {{0xB3}, {0xC2, 0xB7}},
	    {{0xB4}, {0xC2, 0xA9}}, {{0xB5}, {0xC2, 0xA7}}, {{0xB6}, {0xC2, 0xB6}}, {{0xB7}, {0xC2, 0xBC}},
	    {{0xB8}, {0xC2, 0xBD}}, {{0xB9}, {0xC2, 0xBE}}, {{0xBA}, {0xC2, 0xAC}}, {{0xBB}, {0x7C}},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                generated_function.cp500_to_utf8);
