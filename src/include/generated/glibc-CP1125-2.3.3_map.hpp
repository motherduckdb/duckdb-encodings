...
//                         DuckDB - Encodings
//
// generated/glibc-CP1125-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_cp1125_2_3_3ToUtf {
public:
	Glibc_cp1125_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-CP1125-2.3.3";
	// Generated from: glibc-CP1125-2.3.3.ucm
	static constexpr map_entry glibc_CP1125_2_3_3_to_utf8[] = {
	    ...
	    {1, "\xF9", 2, "\xD1\x97"},     {1, "\xFA", 2, "\xC2\xB7"},     {1, "\xFB", 3, "\xE2\x88\x9A"},
	    {1, "\xFC", 3, "\xE2\x84\x96"}, {1, "\xFD", 2, "\xC2\xA4"},     {1, "\xFE", 3, "\xE2\x96\xA0"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_cp1125_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_CP1125_2_3_3_to_utf8),
		                                std::size(glibc_CP1125_2_3_3_to_utf8));
