...
//                         DuckDB - Encodings
//
// generated/ibm-1115_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1115_p100_1995ToUtf {
public:
	Ibm_1115_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1115_P100-1995";
	// Generated from: ibm-1115_P100-1995.ucm
	static constexpr map_entry ibm_1115_P100_1995_to_utf8[] = {
	    {1, "\x00", 1, "\x00"},         {1, "\x01", 3, "\xE2\x95\x94"}, {1, "\x02", 3, "\xE2\x95\x97"},
	    {1, "\x03", 3, "\xE2\x95\x9A"}, {1, "\x04", 3, "\xE2\x95\x9D"}, {1, "\x05", 3, "\xE2\x95\x91"},
	    {1, "\x06", 3, "\xE2\x95\x90"}, {1, "\x07", 3, "\xEF\xBF\xAC"}, {1, "\x08", 3, "\xE2\x97\x98"},
	    {1, "\x09", 3, "\xEF\xBF\xAE"}, {1, "\x0A", 3, "\xE2\x97\x99"}, {1, "\x0B", 3, "\xE3\x80\xBF"},
	    {1, "\x0C", 3, "\xE2\x96\x88"}, {1, "\x0D", 3, "\xE2\x96\x92"}, {1, "\x0E", 3, "\xEF\xBF\xAD"},
	    {1, "\x0F", 3, "\xE2\x98\xBC"}, {1, "\x10", 3, "\xE2\x95\xAC"}, {1, "\x11", 3, "\xE2\x96\x84"},
	    {1, "\x12", 3, "\xE2\x86\x95"}, {1, "\x13", 3, "\xE2\x80\xBC"}, {1, "\x14", 3, "\xE2\x96\x93"},
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\x80", 2, "\xC2\xA3"},
	    {1, "\x81", 2, "\xC2\xAC"},     {1, "\x82", 2, "\xC2\xA5"},     {1, "\x83", 3, "\xE2\x80\xBE"},
	    {1, "\x84", 2, "\xC2\xA6"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1115_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1115_P100_1995_to_utf8),
		                                std::size(ibm_1115_P100_1995_to_utf8));
