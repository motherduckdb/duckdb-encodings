...
//                         DuckDB - Encodings
//
// generated/glibc-ibm1161-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_ibm1161_2_3_3ToUtf {
public:
	Glibc_ibm1161_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-IBM1161-2.3.3";
	// Generated from: glibc-IBM1161-2.3.3.ucm
	static constexpr map_entry glibc_IBM1161_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x7E", 1, "\x7E"},         {1, "\x7F", 1, "\x1A"},         {1, "\xA1", 3, "\xE0\xB8\x81"},
	    ...
	    {1, "\xDE", 3, "\xE2\x82\xAC"}, {1, "\xDF", 3, "\xE0\xB8\xBF"}, {1, "\xE0", 3, "\xE0\xB9\x80"},
	...
	static void Register(const DBConfig &config) {
		const Glibc_ibm1161_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_IBM1161_2_3_3_to_utf8),
		                                std::size(glibc_IBM1161_2_3_3_to_utf8));
