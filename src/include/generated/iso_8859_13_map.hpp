...
public:
	...
	// Generated from: glibc-ISO_8859_13-2.1.2.ucm
	static constexpr map_entry ISO_8859_13_to_utf8[] = {
	    ...
	    {1, "\xB3", 2, "\xC2\xB3"}, {1, "\xB4", 3, "\xE2\x80\x9C"}, {1, "\xB5", 2, "\xC2\xB5"},
	    ...
	    {1, "\xFE", 2, "\xC5\xBE"}, {1, "\xFF", 3, "\xE2\x80\x99"},
	};
	static void Register(const DBConfig &config) {
		const Iso_8859_13ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ISO_8859_13_to_utf8),
		                                std::size(ISO_8859_13_to_utf8));
