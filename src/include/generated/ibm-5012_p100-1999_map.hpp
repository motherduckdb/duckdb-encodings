...
//                         DuckDB - Encodings
//
// generated/ibm-5012_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_5012_p100_1999ToUtf {
public:
	Ibm_5012_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-5012_P100-1999";
	// Generated from: ibm-5012_P100-1999.ucm
	static constexpr map_entry ibm_5012_P100_1999_to_utf8[] = {
	    ...
	    {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 2, "\xC3\x97"},     {1, "\xAB", 2, "\xC2\xAB"},
	    {1, "\xAC", 2, "\xC2\xAC"},     {1, "\xAD", 2, "\xC2\xAD"},     {1, "\xAE", 2, "\xC2\xAE"},
	    {1, "\xAF", 3, "\xE2\x80\xBE"}, {1, "\xB0", 2, "\xC2\xB0"},     {1, "\xB1", 2, "\xC2\xB1"},
	    {1, "\xB2", 2, "\xC2\xB2"},     {1, "\xB3", 2, "\xC2\xB3"},     {1, "\xB4", 2, "\xC2\xB4"},
	    {1, "\xB5", 2, "\xC2\xB5"},     {1, "\xB6", 2, "\xC2\xB6"},     {1, "\xB7", 3, "\xE2\x80\xA2"},
	    {1, "\xB8", 2, "\xC2\xB8"},     {1, "\xB9", 2, "\xC2\xB9"},     {1, "\xBA", 2, "\xC3\xB7"},
	    {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC2\xBC"},     {1, "\xBD", 2, "\xC2\xBD"},
	    {1, "\xBE", 2, "\xC2\xBE"},     {1, "\xDF", 3, "\xE2\x80\x97"}, {1, "\xE0", 2, "\xD7\x90"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_5012_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_5012_P100_1999_to_utf8),
		                                std::size(ibm_5012_P100_1999_to_utf8));
