...
//                         DuckDB - Encodings
//
// generated/ibm-902_P100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_902_p100_1999ToUtf {
public:
	Ibm_902_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-902_P100-1999";
	// Generated from: ibm-902_P100-1999.ucm
	static constexpr map_entry ibm_902_P100_1999_to_utf8[] = {
	    ...
	    {1, "\x8D", 3, "\xE2\x96\x80"}, {1, "\x8E", 3, "\xE2\x89\xA5"}, {1, "\x8F", 3, "\xE2\x94\x90"},
	    ...
	    {1, "\x9F", 3, "\xE2\x89\xA4"}, {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xC2\xA1"},
	    ...
	    {1, "\xC3", 2, "\xC3\x83"},     {1, "\xC4", 2, "\xC3\x84"},     {1, "\xC5", 2, "\xC3\x85"},
	    ...
	    {1, "\xCF", 2, "\xC3\x8F"},     {1, "\xD0", 2, "\xC5\xA0"},     {1, "\xD1", 2, "\xC3\x91"},
	    {1, "\xD2", 2, "\xC3\x92"},     {1, "\xD3", 2, "\xC3\x93"},     {1, "\xD4", 2, "\xC3\x94"},
	    {1, "\xD5", 2, "\xC3\x95"},     {1, "\xD6", 2, "\xC3\x96"},     {1, "\xD7", 2, "\xC3\x97"},
	    {1, "\xD8", 2, "\xC3\x98"},     {1, "\xD9", 2, "\xC3\x99"},     {1, "\xDA", 2, "\xC3\x9A"},
	    {1, "\xDB", 2, "\xC3\x9B"},     {1, "\xDC", 2, "\xC3\x9C"},     {1, "\xDD", 2, "\xC3\x9D"},
	    {1, "\xDE", 2, "\xC5\xBD"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC3\xA0"},
	    ...
	    {1, "\xF0", 2, "\xC5\xA1"},     {1, "\xF1", 2, "\xC3\xB1"},     {1, "\xF2", 2, "\xC3\xB2"},
	    ...
	    {1, "\xFC", 2, "\xC3\xBC"},     {1, "\xFD", 2, "\xC3\xBD"},     {1, "\xFE", 2, "\xC5\xBE"},
	    {1, "\xFF", 2, "\xC3\xBF"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_902_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_902_P100_1999_to_utf8),
		                                std::size(ibm_902_P100_1999_to_utf8));
