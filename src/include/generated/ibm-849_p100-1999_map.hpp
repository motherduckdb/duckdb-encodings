...
//                         DuckDB - Encodings
//
// generated/ibm-849_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_849_p100_1999ToUtf {
public:
	Ibm_849_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-849_P100-1999";
	// Generated from: ibm-849_P100-1999.ucm
	static constexpr map_entry ibm_849_P100_1999_to_utf8[] = {
	    ...
	    {1, "\xF9", 2, "\xD1\x96"},     {1, "\xFA", 2, "\xC2\xB7"},     {1, "\xFB", 3, "\xE2\x82\xAC"},
	    {1, "\xFC", 2, "\xD2\x90"},     {1, "\xFD", 2, "\xD2\x91"},     {1, "\xFE", 3, "\xE2\x88\x99"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_849_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_849_P100_1999_to_utf8),
		                                std::size(ibm_849_P100_1999_to_utf8));
