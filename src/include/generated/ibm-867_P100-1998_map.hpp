...
//                         DuckDB - Encodings
//
// generated/ibm-867_P100-1998_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_867_p100_1998ToUtf {
public:
	Ibm_867_p100_1998ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-867_P100-1998";
	// Generated from: ibm-867_P100-1998.ucm
	static constexpr map_entry ibm_867_P100_1998_to_utf8[] = {
	    ...
	    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xC2\xA5"},     {1, "\x9F", 3, "\xE2\x82\xAA"},
	    {1, "\xA0", 3, "\xE2\x80\x8E"}, {1, "\xA1", 3, "\xE2\x80\x8F"}, {1, "\xA2", 3, "\xE2\x80\xAA"},
	    {1, "\xA3", 3, "\xE2\x80\xAB"}, {1, "\xA4", 3, "\xE2\x80\xAD"}, {1, "\xA5", 3, "\xE2\x80\xAE"},
	    {1, "\xA6", 3, "\xE2\x80\xAC"}, {1, "\xA9", 3, "\xE2\x8C\x90"}, {1, "\xAA", 2, "\xC2\xAC"},
	    {1, "\xAB", 2, "\xC2\xBD"},     {1, "\xAC", 2, "\xC2\xBC"},     {1, "\xAD", 3, "\xE2\x82\xAC"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_867_p100_1998ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_867_P100_1998_to_utf8),
		                                std::size(ibm_867_P100_1998_to_utf8));
