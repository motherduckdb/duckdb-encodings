...
//                         DuckDB - Encodings
//
// generated/hpux-cp1255-11.11_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Hpux_cp1255_11_11ToUtf {
public:
	Hpux_cp1255_11_11ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "hpux-cp1255-11.11";
	// Generated from: hpux-cp1255-11.11.ucm
	static constexpr map_entry hpux_cp1255_11_11_to_utf8[] = {
	    ...
	    {1, "\x9B", 3, "\xE2\x80\xBA"}, {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xC2\xA1"},
	...
	static void Register(const DBConfig &config) {
		const Hpux_cp1255_11_11ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&hpux_cp1255_11_11_to_utf8),
		                                std::size(hpux_cp1255_11_11_to_utf8));
