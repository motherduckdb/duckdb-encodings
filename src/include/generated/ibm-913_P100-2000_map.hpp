...
public:
	...
	// Generated from: ibm-913_P100-2000.ucm
	static constexpr map_entry ibm_913_P100_2000_to_utf8[] = {
	    ...
	    {1, "\xA6", 2, "\xC4\xA4"},     {1, "\xA7", 2, "\xC2\xA7"},     {1, "\xA8", 2, "\xC2\xA8"},
	    ...
	    {1, "\xB6", 2, "\xC4\xA5"},     {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC2\xB8"},
	    ...
	    {1, "\xFD", 2, "\xC5\xAD"},     {1, "\xFE", 2, "\xC5\x9D"},     {1, "\xFF", 2, "\xCB\x99"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_913_p100_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_913_P100_2000_to_utf8),
		                                std::size(ibm_913_P100_2000_to_utf8));
