...
//                         DuckDB - Encodings
//
// generated/windows-28597-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_28597_2000ToUtf {
public:
	Windows_28597_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-28597-2000";
	// Generated from: windows-28597-2000.ucm
	static constexpr map_entry windows_28597_2000_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xCA\xBD"},
	    {1, "\xA2", 2, "\xCA\xBC"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xEF\x9F\x82"},
	    {1, "\xA5", 3, "\xEF\x9F\x83"}, {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC2\xA8"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 3, "\xEF\x9F\x84"},
	    {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC2\xAC"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 3, "\xEF\x9F\x85"}, {1, "\xAF", 3, "\xE2\x80\x95"}, {1, "\xB0", 2, "\xC2\xB0"},
	    {1, "\xB1", 2, "\xC2\xB1"},     {1, "\xB2", 2, "\xC2\xB2"},     {1, "\xB3", 2, "\xC2\xB3"},
	    {1, "\xB4", 2, "\xCE\x84"},     {1, "\xB5", 2, "\xCE\x85"},     {1, "\xB6", 2, "\xCE\x86"},
	    ...
	    {1, "\xD2", 3, "\xEF\x9F\x86"}, {1, "\xD3", 2, "\xCE\xA3"},     {1, "\xD4", 2, "\xCE\xA4"},
	...
	static void Register(const DBConfig &config) {
		const Windows_28597_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_28597_2000_to_utf8),
		                                std::size(windows_28597_2000_to_utf8));
