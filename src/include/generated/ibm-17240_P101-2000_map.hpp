...
//                         DuckDB - Encodings
//
// generated/ibm-17240_P101-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_17240_p101_2000ToUtf {
public:
	Ibm_17240_p101_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-17240_P101-2000";
	// Generated from: ibm-17240_P101-2000.ucm
	static constexpr map_entry ibm_17240_P101_2000_to_utf8[] = {
	    ...
	    {1, "\x99", 2, "\xD7\xA9"},     {1, "\x9A", 2, "\xD7\xAA"},     {1, "\x9B", 2, "\xC2\x9B"},
	    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xC2\x9D"},     {1, "\x9E", 2, "\xC3\x97"},
	    {1, "\x9F", 3, "\xE2\x82\xAA"}, {1, "\xA0", 3, "\xE2\x80\x8E"}, {1, "\xA1", 3, "\xE2\x80\x8F"},
	    {1, "\xA2", 3, "\xE2\x80\xAA"}, {1, "\xA3", 3, "\xE2\x80\xAB"}, {1, "\xA4", 3, "\xE2\x80\xAD"},
	    {1, "\xA5", 3, "\xE2\x80\xAE"}, {1, "\xA6", 3, "\xE2\x80\xAC"}, {1, "\xA9", 2, "\xC2\xAE"},
	    ...
	    {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 2, "\xC2\xA6"},     {1, "\xDF", 3, "\xE2\x96\x80"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_17240_p101_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_17240_P101_2000_to_utf8),
		                                std::size(ibm_17240_P101_2000_to_utf8));
