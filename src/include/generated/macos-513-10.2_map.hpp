...
//                         DuckDB - Encodings
//
// generated/macos-513-10.2_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
public:
	...
	static constexpr map_entry macos_513_10_2_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&macos_513_10_2_to_utf8),
		                                std::size(macos_513_10_2_to_utf8));
