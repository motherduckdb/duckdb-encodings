...
public:
	...
	const string name = "IBM_1129";
	// Generated from: aix-IBM_1129-4.3.6.ucm
	static constexpr map_entry IBM_1129_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&IBM_1129_to_utf8), std::size(IBM_1129_to_utf8));
