...
//                         DuckDB - Encodings
//
// generated/ibm-915_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_915_p100_1995ToUtf {
public:
	Ibm_915_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-915_P100-1995";
	// Generated from: ibm-915_P100-1995.ucm
	static constexpr map_entry ibm_915_P100_1995_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Ibm_915_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_915_P100_1995_to_utf8),
		                                std::size(ibm_915_P100_1995_to_utf8));
