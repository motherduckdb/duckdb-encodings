...
public:
	...
	// Generated from: java-TIS620-1.3_P.ucm
	static constexpr map_entry java_TIS620_1_3_P_to_utf8[] = {
	    ...
	    {1, "\x7E", 1, "\x7E"},         {1, "\x7F", 1, "\x7F"},         {1, "\xA0", 2, "\xC2\xA0"},
	...
	static void Register(const DBConfig &config) {
		const Java_tis620_1_3_pToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&java_TIS620_1_3_P_to_utf8),
		                                std::size(java_TIS620_1_3_P_to_utf8));
