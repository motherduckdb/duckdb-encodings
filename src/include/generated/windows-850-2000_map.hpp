...
//                         DuckDB - Encodings
//
// generated/windows-850-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_850_2000ToUtf {
public:
	Windows_850_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-850-2000";
	// Generated from: windows-850-2000.ucm
	static constexpr map_entry windows_850_2000_to_utf8[] = {
	    ...
	    {1, "\xD5", 2, "\xC4\xB1"},     {1, "\xD6", 2, "\xC3\x8D"},     {1, "\xD7", 2, "\xC3\x8E"},
	...
	static void Register(const DBConfig &config) {
		const Windows_850_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_850_2000_to_utf8),
		                                std::size(windows_850_2000_to_utf8));
