...
public:
	...
	// Generated from: ibm-9448_X100-2005.ucm
	static constexpr map_entry ibm_9448_X100_2005_to_utf8[] = {
	    ...
	    {1, "\x1E", 1, "\x1E"},         {1, "\x1F", 1, "\x1F"},         {1, "\x20", 3, "\xEF\xB9\xB3"},
	    ...
	    {1, "\x81", 3, "\xEF\xAD\x99"}, {1, "\x82", 3, "\xE2\x80\x9A"}, {1, "\x83", 2, "\xC6\x92"},
	    {1, "\x84", 3, "\xE2\x80\x9E"}, {1, "\x85", 3, "\xE2\x80\xA6"}, {1, "\x86", 3, "\xE2\x80\xA0"},
	    {1, "\x87", 3, "\xE2\x80\xA1"}, {1, "\x88", 2, "\xCB\x86"},     {1, "\x89", 3, "\xE2\x80\xB0"},
	    {1, "\x8A", 3, "\xEF\xAD\xA9"}, {1, "\x8B", 3, "\xE2\x80\xB9"}, {1, "\x8C", 2, "\xC5\x92"},
	    {1, "\x8D", 3, "\xEF\xAD\xBD"}, {1, "\x8E", 3, "\xEF\xAE\x8B"}, {1, "\x8F", 3, "\xEF\xAE\x89"},
	    {1, "\x90", 3, "\xEF\xAE\x95"}, {1, "\x91", 3, "\xE2\x80\x98"}, {1, "\x92", 3, "\xE2\x80\x99"},
	    {1, "\x93", 3, "\xE2\x80\x9C"}, {1, "\x94", 3, "\xE2\x80\x9D"}, {1, "\x95", 3, "\xE2\x80\xA2"},
	    {1, "\x96", 3, "\xE2\x80\x93"}, {1, "\x97", 3, "\xE2\x80\x94"}, {1, "\x98", 3, "\xEF\xAE\x91"},
	    {1, "\x99", 3, "\xE2\x84\xA2"}, {1, "\x9A", 3, "\xEF\xAE\x8D"}, {1, "\x9B", 3, "\xE2\x80\xBA"},
	    {1, "\x9C", 2, "\xC5\x93"},     {1, "\x9D", 3, "\xE2\x80\x8C"}, {1, "\x9E", 3, "\xE2\x80\x8D"},
	    {1, "\x9F", 3, "\xEF\xAE\x9F"}, {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xD8\x8C"},
	    {1, "\xA2", 2, "\xC2\xA2"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 2, "\xC2\xA4"},
	    {1, "\xA5", 2, "\xC2\xA5"},     {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC2\xA8"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 3, "\xEF\xAE\xAD"},
	    ...
	    {1, "\xC0", 3, "\xEF\xAE\xA9"}, {1, "\xC1", 3, "\xEF\xBA\x80"}, {1, "\xC2", 3, "\xEF\xBA\x82"},
	    ...
	    {1, "\xD5", 3, "\xEF\xBA\xBC"}, {1, "\xD6", 3, "\xEF\xBB\x80"}, {1, "\xD7", 2, "\xC3\x97"},
	    {1, "\xD8", 3, "\xEF\xBB\x84"}, {1, "\xD9", 3, "\xEF\xBB\x88"}, {1, "\xDA", 3, "\xEF\xBB\x8C"},
	    {1, "\xDB", 3, "\xEF\xBB\x90"}, {1, "\xDC", 2, "\xD9\x80"},     {1, "\xDD", 3, "\xEF\xBB\x94"},
	    {1, "\xDE", 3, "\xEF\xBB\x98"}, {1, "\xDF", 3, "\xEF\xBB\x9C"}, {1, "\xE0", 2, "\xC3\xA0"},
	    {1, "\xE1", 3, "\xEF\xBB\xA0"}, {1, "\xE2", 2, "\xC3\xA2"},     {1, "\xE3", 3, "\xEF\xBB\xA4"},
	    {1, "\xE4", 3, "\xEF\xBB\xA8"}, {1, "\xE5", 3, "\xEF\xBB\xAC"}, {1, "\xE6", 3, "\xEF\xBB\xAE"},
	    {1, "\xE7", 2, "\xC3\xA7"},     {1, "\xE8", 2, "\xC3\xA8"},     {1, "\xE9", 2, "\xC3\xA9"},
	    {1, "\xEA", 2, "\xC3\xAA"},     {1, "\xEB", 2, "\xC3\xAB"},     {1, "\xEC", 3, "\xEF\xBB\xB0"},
	    {1, "\xED", 3, "\xEF\xBB\xB4"}, {1, "\xEE", 2, "\xC3\xAE"},     {1, "\xEF", 2, "\xC3\xAF"},
	    {1, "\xF0", 3, "\xEF\xB9\xB1"}, {1, "\xF1", 3, "\xEF\xB9\xB2"}, {1, "\xF2", 3, "\xEF\xB9\xB4"},
	    {1, "\xF3", 3, "\xEF\xB9\xB7"}, {1, "\xF4", 2, "\xC3\xB4"},     {1, "\xF5", 3, "\xEF\xB9\xB9"},
	    {1, "\xF6", 3, "\xEF\xB9\xBB"}, {1, "\xF7", 2, "\xC3\xB7"},     {1, "\xF8", 3, "\xEF\xB9\xBD"},
	    {1, "\xF9", 2, "\xC3\xB9"},     {1, "\xFA", 3, "\xEF\xB9\xBF"}, {1, "\xFB", 2, "\xC3\xBB"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                std::size(ibm_9448_X100_2005_to_utf8));
