...
public:
	...
	// Generated from: glibc-NATS_DANO-2.1.2.ucm
	static constexpr map_entry NATS_DANO_to_utf8[] = {
	    ...
	    {1, "\x21", 1, "\x21"},         {1, "\x22", 2, "\xC2\xAB"},     {1, "\x23", 2, "\xC2\xBB"},
	    ...
	    {1, "\x5A", 1, "\x5A"},         {1, "\x5B", 2, "\xC3\x86"},     {1, "\x5C", 2, "\xC3\x98"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&NATS_DANO_to_utf8), std::size(NATS_DANO_to_utf8));
