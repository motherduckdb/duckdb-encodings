...
//                         DuckDB - Encodings
//
// generated/ibm-861_P100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_861_p100_1995ToUtf {
public:
	Ibm_861_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-861_P100-1995";
	// Generated from: ibm-861_P100-1995.ucm
	static constexpr map_entry ibm_861_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x8A", 2, "\xC3\xA8"},     {1, "\x8B", 2, "\xC3\x90"},     {1, "\x8C", 2, "\xC3\xB0"},
	    {1, "\x8D", 2, "\xC3\x9E"},     {1, "\x8E", 2, "\xC3\x84"},     {1, "\x8F", 2, "\xC3\x85"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_861_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_861_P100_1995_to_utf8),
		                                std::size(ibm_861_P100_1995_to_utf8));
