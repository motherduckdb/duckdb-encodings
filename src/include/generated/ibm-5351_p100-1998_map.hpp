...
//                         DuckDB - Encodings
//
// generated/ibm-5351_p100-1998_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_5351_p100_1998ToUtf {
public:
	Ibm_5351_p100_1998ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-5351_P100-1998";
	// Generated from: ibm-5351_P100-1998.ucm
	static constexpr map_entry ibm_5351_P100_1998_to_utf8[] = {
	    ...
	    {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xE2\x82\xAA"}, {1, "\xA5", 2, "\xC2\xA5"},
	    {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},     {1, "\xA8", 2, "\xC2\xA8"},
	    {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC2\xAC"},
	    ...
	    {1, "\xB6", 2, "\xC2\xB6"},     {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB9", 2, "\xC2\xB9"},
	    {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC2\xBC"},     {1, "\xBD", 2, "\xC2\xBD"},
	    {1, "\xBE", 2, "\xC2\xBE"},     {1, "\xC0", 2, "\xD6\xB0"},     {1, "\xC1", 2, "\xD6\xB1"},
	    {1, "\xC2", 2, "\xD6\xB2"},     {1, "\xC3", 2, "\xD6\xB3"},     {1, "\xC4", 2, "\xD6\xB4"},
	    {1, "\xC5", 2, "\xD6\xB5"},     {1, "\xC6", 2, "\xD6\xB6"},     {1, "\xC7", 2, "\xD6\xB7"},
	    {1, "\xC8", 2, "\xD6\xB8"},     {1, "\xC9", 2, "\xD6\xB9"},     {1, "\xCB", 2, "\xD6\xBB"},
	    {1, "\xCC", 2, "\xD6\xBC"},     {1, "\xCD", 2, "\xD6\xBD"},     {1, "\xCE", 2, "\xD6\xBE"},
	    {1, "\xCF", 2, "\xD6\xBF"},     {1, "\xD0", 2, "\xD7\x80"},     {1, "\xD1", 2, "\xD7\x81"},
	    {1, "\xD2", 2, "\xD7\x82"},     {1, "\xD3", 2, "\xD7\x83"},     {1, "\xD4", 2, "\xD7\xB0"},
	    {1, "\xD5", 2, "\xD7\xB1"},     {1, "\xD6", 2, "\xD7\xB2"},     {1, "\xE0", 2, "\xD7\x90"},
	    {1, "\xE1", 2, "\xD7\x91"},     {1, "\xE2", 2, "\xD7\x92"},     {1, "\xE3", 2, "\xD7\x93"},
	    {1, "\xE4", 2, "\xD7\x94"},     {1, "\xE5", 2, "\xD7\x95"},     {1, "\xE6", 2, "\xD7\x96"},
	    {1, "\xE7", 2, "\xD7\x97"},     {1, "\xE8", 2, "\xD7\x98"},     {1, "\xE9", 2, "\xD7\x99"},
	    {1, "\xEA", 2, "\xD7\x9A"},     {1, "\xEB", 2, "\xD7\x9B"},     {1, "\xEC", 2, "\xD7\x9C"},
	    {1, "\xED", 2, "\xD7\x9D"},     {1, "\xEE", 2, "\xD7\x9E"},     {1, "\xEF", 2, "\xD7\x9F"},
	    {1, "\xF0", 2, "\xD7\xA0"},     {1, "\xF1", 2, "\xD7\xA1"},     {1, "\xF2", 2, "\xD7\xA2"},
	    {1, "\xF3", 2, "\xD7\xA3"},     {1, "\xF4", 2, "\xD7\xA4"},     {1, "\xF5", 2, "\xD7\xA5"},
	    {1, "\xF6", 2, "\xD7\xA6"},     {1, "\xF7", 2, "\xD7\xA7"},     {1, "\xF8", 2, "\xD7\xA8"},
	    {1, "\xF9", 2, "\xD7\xA9"},     {1, "\xFA", 2, "\xD7\xAA"},     {1, "\xFD", 3, "\xE2\x80\x8E"},
	    {1, "\xFE", 3, "\xE2\x80\x8F"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_5351_p100_1998ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_5351_P100_1998_to_utf8),
		                                std::size(ibm_5351_P100_1998_to_utf8));
