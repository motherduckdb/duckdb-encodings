...
public:
	...
	// Generated from: ibm-1126_P100_P100-1997_U3.ucm
	static constexpr map_entry ibm_1126_P100_P100_1997_U3_to_utf8[] = {
	    {1, "\x00", 1, "\x00"},         {1, "\x01", 3, "\xE2\x94\x8C"}, {1, "\x02", 3, "\xE2\x94\x90"},
	    {1, "\x03", 3, "\xE2\x94\x94"}, {1, "\x04", 3, "\xE2\x94\x98"}, {1, "\x05", 3, "\xEF\xBF\xA8"},
	    {1, "\x06", 3, "\xE2\x94\x80"}, {1, "\x07", 3, "\xE2\x80\xA2"}, {1, "\x08", 3, "\xE2\x97\x98"},
	    {1, "\x09", 3, "\xEF\xBF\xAE"}, {1, "\x0A", 3, "\xE2\x97\x99"}, {1, "\x0B", 3, "\xE2\x99\x82"},
	    {1, "\x0C", 3, "\xE2\x99\x80"}, {1, "\x0D", 3, "\xE2\x99\xAA"}, {1, "\x0E", 3, "\xE2\x99\xAC"},
	    {1, "\x0F", 3, "\xE2\x98\xBC"}, {1, "\x10", 3, "\xE2\x94\xBC"}, {1, "\x11", 3, "\xE2\x97\x84"},
	    {1, "\x12", 3, "\xE2\x86\x95"}, {1, "\x13", 3, "\xE2\x80\xBC"}, {1, "\x14", 2, "\xC2\xB6"},
	    {1, "\x15", 3, "\xE2\x94\xB4"}, {1, "\x16", 3, "\xE2\x94\xAC"}, {1, "\x17", 3, "\xE2\x94\xA4"},
	    {1, "\x18", 3, "\xEF\xBF\xAA"}, {1, "\x19", 3, "\xE2\x94\x9C"}, {1, "\x1A", 3, "\xEF\xBF\xAB"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                std::size(ibm_1126_P100_P100_1997_U3_to_utf8));
