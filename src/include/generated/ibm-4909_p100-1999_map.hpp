...
//                         DuckDB - Encodings
//
// generated/ibm-4909_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_4909_p100_1999ToUtf {
public:
	Ibm_4909_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-4909_P100-1999";
	// Generated from: ibm-4909_P100-1999.ucm
	static constexpr map_entry ibm_4909_P100_1999_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xE2\x80\x98"},
	    {1, "\xA2", 3, "\xE2\x80\x99"}, {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xE2\x82\xAC"},
	    {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},     {1, "\xA8", 2, "\xC2\xA8"},
	    {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC2\xAC"},
	    {1, "\xAD", 2, "\xC2\xAD"},     {1, "\xAF", 3, "\xE2\x80\x95"}, {1, "\xB0", 2, "\xC2\xB0"},
	    {1, "\xB1", 2, "\xC2\xB1"},     {1, "\xB2", 2, "\xC2\xB2"},     {1, "\xB3", 2, "\xC2\xB3"},
	    {1, "\xB4", 2, "\xC2\xB4"},     {1, "\xB5", 2, "\xCE\x85"},     {1, "\xB6", 2, "\xCE\x86"},
	    {1, "\xB7", 2, "\xCE\x87"},     {1, "\xB8", 2, "\xCE\x88"},     {1, "\xB9", 2, "\xCE\x89"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_4909_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_4909_P100_1999_to_utf8),
		                                std::size(ibm_4909_P100_1999_to_utf8));
