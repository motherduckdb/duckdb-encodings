...
//                         DuckDB - Encodings
//
// generated/ibm-891_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_891_p100_1995ToUtf {
public:
	Ibm_891_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-891_P100-1995";
	// Generated from: ibm-891_P100-1995.ucm
	static constexpr map_entry ibm_891_P100_1995_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&ibm_891_P100_1995_to_utf8),
		                                std::size(ibm_891_P100_1995_to_utf8));
