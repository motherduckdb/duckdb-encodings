...
//                         DuckDB - Encodings
//
// generated/windows-28594-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_28594_2000ToUtf {
public:
	Windows_28594_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-28594-2000";
	// Generated from: windows-28594-2000.ucm
	static constexpr map_entry windows_28594_2000_to_utf8[] = {
	    ...
	    {1, "\xA8", 2, "\xC2\xA8"},     {1, "\xA9", 2, "\xC5\xA0"},     {1, "\xAA", 2, "\xC4\x92"},
	    {1, "\xAB", 2, "\xC4\xA2"},     {1, "\xAC", 2, "\xC5\xA6"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xC5\xBD"},     {1, "\xAF", 2, "\xC2\xAF"},     {1, "\xB0", 2, "\xC2\xB0"},
	    {1, "\xB1", 2, "\xC4\x85"},     {1, "\xB2", 2, "\xCB\x9B"},     {1, "\xB3", 2, "\xC5\x97"},
	    {1, "\xB4", 2, "\xC2\xB4"},     {1, "\xB5", 2, "\xC4\xA9"},     {1, "\xB6", 2, "\xC4\xBC"},
	...
	static void Register(const DBConfig &config) {
		const Windows_28594_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_28594_2000_to_utf8),
		                                std::size(windows_28594_2000_to_utf8));
