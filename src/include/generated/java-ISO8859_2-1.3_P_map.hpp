...
//                         DuckDB - Encodings
//
// generated/java-ISO8859_2-1.3_P_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Java_iso8859_2_1_3_pToUtf {
public:
	Java_iso8859_2_1_3_pToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "java-ISO8859_2-1.3_P";
	// Generated from: java-ISO8859_2-1.3_P.ucm
	static constexpr map_entry java_ISO8859_2_1_3_P_to_utf8[] = {
	    ...
	    {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA1", 2, "\xC4\x84"}, {1, "\xA2", 2, "\xCB\x98"}, {1, "\xA3", 2, "\xC5\x81"},
	    {1, "\xA4", 2, "\xC2\xA4"}, {1, "\xA5", 2, "\xC4\xBD"}, {1, "\xA6", 2, "\xC5\x9A"}, {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC2\xA8"}, {1, "\xA9", 2, "\xC5\xA0"}, {1, "\xAA", 2, "\xC5\x9E"}, {1, "\xAB", 2, "\xC5\xA4"},
	    {1, "\xAC", 2, "\xC5\xB9"}, {1, "\xAD", 2, "\xC2\xAD"}, {1, "\xAE", 2, "\xC5\xBD"}, {1, "\xAF", 2, "\xC5\xBB"},
	    {1, "\xB0", 2, "\xC2\xB0"}, {1, "\xB1", 2, "\xC4\x85"}, {1, "\xB2", 2, "\xCB\x9B"}, {1, "\xB3", 2, "\xC5\x82"},
	    {1, "\xB4", 2, "\xC2\xB4"}, {1, "\xB5", 2, "\xC4\xBE"}, {1, "\xB6", 2, "\xC5\x9B"}, {1, "\xB7", 2, "\xCB\x87"},
	    {1, "\xB8", 2, "\xC2\xB8"}, {1, "\xB9", 2, "\xC5\xA1"}, {1, "\xBA", 2, "\xC5\x9F"}, {1, "\xBB", 2, "\xC5\xA5"},
	    {1, "\xBC", 2, "\xC5\xBA"}, {1, "\xBD", 2, "\xCB\x9D"}, {1, "\xBE", 2, "\xC5\xBE"}, {1, "\xBF", 2, "\xC5\xBC"},
	    {1, "\xC0", 2, "\xC5\x94"}, {1, "\xC1", 2, "\xC3\x81"}, {1, "\xC2", 2, "\xC3\x82"}, {1, "\xC3", 2, "\xC4\x82"},
	    {1, "\xC4", 2, "\xC3\x84"}, {1, "\xC5", 2, "\xC4\xB9"}, {1, "\xC6", 2, "\xC4\x86"}, {1, "\xC7", 2, "\xC3\x87"},
	    {1, "\xC8", 2, "\xC4\x8C"}, {1, "\xC9", 2, "\xC3\x89"}, {1, "\xCA", 2, "\xC4\x98"}, {1, "\xCB", 2, "\xC3\x8B"},
	    {1, "\xCC", 2, "\xC4\x9A"}, {1, "\xCD", 2, "\xC3\x8D"}, {1, "\xCE", 2, "\xC3\x8E"}, {1, "\xCF", 2, "\xC4\x8E"},
	    {1, "\xD0", 2, "\xC4\x90"}, {1, "\xD1", 2, "\xC5\x83"}, {1, "\xD2", 2, "\xC5\x87"}, {1, "\xD3", 2, "\xC3\x93"},
	    {1, "\xD4", 2, "\xC3\x94"}, {1, "\xD5", 2, "\xC5\x90"}, {1, "\xD6", 2, "\xC3\x96"}, {1, "\xD7", 2, "\xC3\x97"},
	    {1, "\xD8", 2, "\xC5\x98"}, {1, "\xD9", 2, "\xC5\xAE"}, {1, "\xDA", 2, "\xC3\x9A"}, {1, "\xDB", 2, "\xC5\xB0"},
	    {1, "\xDC", 2, "\xC3\x9C"}, {1, "\xDD", 2, "\xC3\x9D"}, {1, "\xDE", 2, "\xC5\xA2"}, {1, "\xDF", 2, "\xC3\x9F"},
	    {1, "\xE0", 2, "\xC5\x95"}, {1, "\xE1", 2, "\xC3\xA1"}, {1, "\xE2", 2, "\xC3\xA2"}, {1, "\xE3", 2, "\xC4\x83"},
	    {1, "\xE4", 2, "\xC3\xA4"}, {1, "\xE5", 2, "\xC4\xBA"}, {1, "\xE6", 2, "\xC4\x87"}, {1, "\xE7", 2, "\xC3\xA7"},
	    {1, "\xE8", 2, "\xC4\x8D"}, {1, "\xE9", 2, "\xC3\xA9"}, {1, "\xEA", 2, "\xC4\x99"}, {1, "\xEB", 2, "\xC3\xAB"},
	    {1, "\xEC", 2, "\xC4\x9B"}, {1, "\xED", 2, "\xC3\xAD"}, {1, "\xEE", 2, "\xC3\xAE"}, {1, "\xEF", 2, "\xC4\x8F"},
	    {1, "\xF0", 2, "\xC4\x91"}, {1, "\xF1", 2, "\xC5\x84"}, {1, "\xF2", 2, "\xC5\x88"}, {1, "\xF3", 2, "\xC3\xB3"},
	    {1, "\xF4", 2, "\xC3\xB4"}, {1, "\xF5", 2, "\xC5\x91"}, {1, "\xF6", 2, "\xC3\xB6"}, {1, "\xF7", 2, "\xC3\xB7"},
	...
	static void Register(const DBConfig &config) {
		const Java_iso8859_2_1_3_pToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&java_ISO8859_2_1_3_P_to_utf8),
		                                std::size(java_ISO8859_2_1_3_P_to_utf8));
