...
//                         DuckDB - Encodings
//
// generated/ibm-5354_p100-1998_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_5354_p100_1998ToUtf {
public:
	Ibm_5354_p100_1998ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-5354_P100-1998";
	// Generated from: ibm-5354_P100-1998.ucm
	static constexpr map_entry ibm_5354_P100_1998_to_utf8[] = {
	    ...
	    {1, "\xC3", 2, "\xC4\x82"},     {1, "\xC4", 2, "\xC3\x84"},     {1, "\xC5", 2, "\xC3\x85"},
	    {1, "\xC6", 2, "\xC3\x86"},     {1, "\xC7", 2, "\xC3\x87"},     {1, "\xC8", 2, "\xC3\x88"},
	    {1, "\xC9", 2, "\xC3\x89"},     {1, "\xCA", 2, "\xC3\x8A"},     {1, "\xCB", 2, "\xC3\x8B"},
	    {1, "\xCC", 2, "\xCC\x80"},     {1, "\xCD", 2, "\xC3\x8D"},     {1, "\xCE", 2, "\xC3\x8E"},
	    {1, "\xCF", 2, "\xC3\x8F"},     {1, "\xD0", 2, "\xC4\x90"},     {1, "\xD1", 2, "\xC3\x91"},
	    {1, "\xD2", 2, "\xCC\x89"},     {1, "\xD3", 2, "\xC3\x93"},     {1, "\xD4", 2, "\xC3\x94"},
	    {1, "\xD5", 2, "\xC6\xA0"},     {1, "\xD6", 2, "\xC3\x96"},     {1, "\xD7", 2, "\xC3\x97"},
	    {1, "\xD8", 2, "\xC3\x98"},     {1, "\xD9", 2, "\xC3\x99"},     {1, "\xDA", 2, "\xC3\x9A"},
	    {1, "\xDB", 2, "\xC3\x9B"},     {1, "\xDC", 2, "\xC3\x9C"},     {1, "\xDD", 2, "\xC6\xAF"},
	    {1, "\xDE", 2, "\xCC\x83"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC3\xA0"},
	    ...
	    {1, "\xEA", 2, "\xC3\xAA"},     {1, "\xEB", 2, "\xC3\xAB"},     {1, "\xEC", 2, "\xCC\x81"},
	    {1, "\xED", 2, "\xC3\xAD"},     {1, "\xEE", 2, "\xC3\xAE"},     {1, "\xEF", 2, "\xC3\xAF"},
	    {1, "\xF0", 2, "\xC4\x91"},     {1, "\xF1", 2, "\xC3\xB1"},     {1, "\xF2", 2, "\xCC\xA3"},
	    {1, "\xF3", 2, "\xC3\xB3"},     {1, "\xF4", 2, "\xC3\xB4"},     {1, "\xF5", 2, "\xC6\xA1"},
	    {1, "\xF6", 2, "\xC3\xB6"},     {1, "\xF7", 2, "\xC3\xB7"},     {1, "\xF8", 2, "\xC3\xB8"},
	    {1, "\xF9", 2, "\xC3\xB9"},     {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},
	    {1, "\xFC", 2, "\xC3\xBC"},     {1, "\xFD", 2, "\xC6\xB0"},     {1, "\xFE", 3, "\xE2\x82\xAB"},
	    {1, "\xFF", 2, "\xC3\xBF"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_5354_p100_1998ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_5354_P100_1998_to_utf8),
		                                std::size(ibm_5354_P100_1998_to_utf8));
