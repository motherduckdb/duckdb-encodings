...
//                         DuckDB - Encodings
//
// generated/ibm-865_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_865_p100_1995ToUtf {
public:
	Ibm_865_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-865_P100-1995";
	// Generated from: ibm-865_P100-1995.ucm
	static constexpr map_entry ibm_865_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xC3\x98"},     {1, "\x9E", 3, "\xE2\x82\xA7"},
	    ...
	    {1, "\xAE", 2, "\xC2\xAB"},     {1, "\xAF", 2, "\xC2\xA4"},     {1, "\xB0", 3, "\xE2\x96\x91"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_865_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_865_P100_1995_to_utf8),
		                                std::size(ibm_865_P100_1995_to_utf8));
