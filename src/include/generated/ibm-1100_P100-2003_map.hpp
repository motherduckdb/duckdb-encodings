...
//                         DuckDB - Encodings
//
// generated/ibm-1100_P100-2003_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1100_p100_2003ToUtf {
public:
	Ibm_1100_p100_2003ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1100_P100-2003";
	// Generated from: ibm-1100_P100-2003.ucm
	static constexpr map_entry ibm_1100_P100_2003_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA1", 2, "\xC2\xA1"},     {1, "\xA2", 2, "\xC2\xA2"},
	    {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA5", 2, "\xC2\xA5"},     {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC2\xA4"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 2, "\xC2\xAA"},
	    {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xB0", 2, "\xC2\xB0"},     {1, "\xB1", 2, "\xC2\xB1"},
	    {1, "\xB2", 2, "\xC2\xB2"},     {1, "\xB3", 2, "\xC2\xB3"},     {1, "\xB5", 2, "\xC2\xB5"},
	    {1, "\xB6", 2, "\xC2\xB6"},     {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB9", 2, "\xC2\xB9"},
	    {1, "\xBA", 2, "\xC2\xBA"},     {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC2\xBC"},
	    {1, "\xBD", 2, "\xC2\xBD"},     {1, "\xBF", 2, "\xC2\xBF"},     {1, "\xC0", 2, "\xC3\x80"},
	    ...
	    {1, "\xD7", 2, "\xC5\x92"},     {1, "\xD8", 2, "\xC3\x98"},     {1, "\xD9", 2, "\xC3\x99"},
	    {1, "\xDA", 2, "\xC3\x9A"},     {1, "\xDB", 2, "\xC3\x9B"},     {1, "\xDC", 2, "\xC3\x9C"},
	    {1, "\xDD", 2, "\xC5\xB8"},     {1, "\xDF", 2, "\xC3\x9F"},     {1, "\xE0", 2, "\xC3\xA0"},
	    ...
	    {1, "\xF7", 2, "\xC5\x93"},     {1, "\xF8", 2, "\xC3\xB8"},     {1, "\xF9", 2, "\xC3\xB9"},
	    {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},     {1, "\xFC", 2, "\xC3\xBC"},
	    {1, "\xFD", 2, "\xC3\xBF"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1100_p100_2003ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1100_P100_2003_to_utf8),
		                                std::size(ibm_1100_P100_2003_to_utf8));
