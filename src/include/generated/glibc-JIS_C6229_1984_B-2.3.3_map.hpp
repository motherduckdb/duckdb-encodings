...
//                         DuckDB - Encodings
//
// generated/glibc-JIS_C6229_1984_B-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_jis_c6229_1984_b_2_3_3ToUtf {
public:
	Glibc_jis_c6229_1984_b_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-JIS_C6229_1984_B-2.3.3";
	// Generated from: glibc-JIS_C6229_1984_B-2.3.3.ucm
	static constexpr map_entry glibc_JIS_C6229_1984_B_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x5A", 1, "\x5A"},         {1, "\x5B", 3, "\xE2\x8C\xA9"}, {1, "\x5C", 2, "\xC2\xA5"},
	    {1, "\x5D", 3, "\xE2\x8C\xAA"}, {1, "\x5E", 1, "\x5E"},         {1, "\x5F", 1, "\x5F"},
	    ...
	    {1, "\x7C", 1, "\x7C"},         {1, "\x7D", 1, "\x7D"},         {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_jis_c6229_1984_b_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_JIS_C6229_1984_B_2_3_3_to_utf8),
		                                std::size(glibc_JIS_C6229_1984_B_2_3_3_to_utf8));
