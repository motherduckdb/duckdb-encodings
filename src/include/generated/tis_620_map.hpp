...
public:
	...
	// Generated from: aix-TIS_620-4.3.6.ucm
	static constexpr map_entry TIS_620_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x7F"},         {1, "\xA1", 3, "\xE0\xB8\x81"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&TIS_620_to_utf8), std::size(TIS_620_to_utf8));
