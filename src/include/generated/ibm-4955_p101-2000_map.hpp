...
//                         DuckDB - Encodings
//
// generated/ibm-4955_p101-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_4955_p101_2000ToUtf {
public:
	Ibm_4955_p101_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-4955_P101-2000";
	// Generated from: ibm-4955_P101-2000.ucm
	static constexpr map_entry ibm_4955_P101_2000_to_utf8[] = {
	    ...
	    {1, "\xAB", 2, "\xC5\x93"},     {1, "\xAC", 2, "\xC5\x92"},     {1, "\xAD", 2, "\xC2\xA1"},
	    ...
	    {1, "\xCF", 2, "\xC2\xA4"},     {1, "\xD0", 2, "\xC3\xB0"},     {1, "\xD1", 2, "\xC4\x90"},
	    ...
	    {1, "\xDB", 3, "\xE2\x96\x88"}, {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 2, "\xC5\xA0"},
	    ...
	    {1, "\xED", 2, "\xC3\x9D"},     {1, "\xEE", 3, "\xE2\x80\xBE"}, {1, "\xEF", 2, "\xC5\xBD"},
	    {1, "\xF0", 2, "\xC2\xAD"},     {1, "\xF1", 2, "\xC2\xB1"},     {1, "\xF3", 2, "\xC5\xB8"},
	    {1, "\xF4", 2, "\xC2\xB6"},     {1, "\xF5", 2, "\xC2\xA7"},     {1, "\xF6", 2, "\xC3\xB7"},
	    {1, "\xF7", 2, "\xC5\xBE"},     {1, "\xF8", 2, "\xC2\xB0"},     {1, "\xF9", 2, "\xC5\xA1"},
	    {1, "\xFA", 2, "\xC2\xB7"},     {1, "\xFB", 2, "\xC2\xB9"},     {1, "\xFC", 2, "\xC2\xB3"},
	    {1, "\xFD", 2, "\xC2\xB2"},     {1, "\xFE", 3, "\xEF\xBF\xAD"}, {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_4955_p101_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_4955_P101_2000_to_utf8),
		                                std::size(ibm_4955_P101_2000_to_utf8));
