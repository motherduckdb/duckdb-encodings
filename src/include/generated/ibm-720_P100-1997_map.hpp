...
//                         DuckDB - Encodings
//
// generated/ibm-720_P100-1997_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_720_p100_1997ToUtf {
public:
	Ibm_720_p100_1997ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-720_P100-1997";
	// Generated from: ibm-720_P100-1997.ucm
	static constexpr map_entry ibm_720_P100_1997_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\x82", 2, "\xC3\xA9"},
	    {1, "\x83", 2, "\xC3\xA2"},     {1, "\x85", 2, "\xC3\xA0"},     {1, "\x87", 2, "\xC3\xA7"},
	    {1, "\x88", 2, "\xC3\xAA"},     {1, "\x89", 2, "\xC3\xAB"},     {1, "\x8A", 2, "\xC3\xA8"},
	    {1, "\x8B", 2, "\xC3\xAF"},     {1, "\x8C", 2, "\xC3\xAE"},     {1, "\x91", 2, "\xD9\x91"},
	    {1, "\x92", 2, "\xD9\x92"},     {1, "\x93", 2, "\xC3\xB4"},     {1, "\x94", 2, "\xC2\xA4"},
	    {1, "\x95", 2, "\xD9\x80"},     {1, "\x96", 2, "\xC3\xBB"},     {1, "\x97", 2, "\xC3\xB9"},
	    {1, "\x98", 2, "\xD8\xA1"},     {1, "\x99", 2, "\xD8\xA2"},     {1, "\x9A", 2, "\xD8\xA3"},
	    {1, "\x9B", 2, "\xD8\xA4"},     {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xD8\xA5"},
	    {1, "\x9E", 2, "\xD8\xA6"},     {1, "\x9F", 2, "\xD8\xA7"},     {1, "\xA0", 2, "\xD8\xA8"},
	    {1, "\xA1", 2, "\xD8\xA9"},     {1, "\xA2", 2, "\xD8\xAA"},     {1, "\xA3", 2, "\xD8\xAB"},
	    {1, "\xA4", 2, "\xD8\xAC"},     {1, "\xA5", 2, "\xD8\xAD"},     {1, "\xA6", 2, "\xD8\xAE"},
	    {1, "\xA7", 2, "\xD8\xAF"},     {1, "\xA8", 2, "\xD8\xB0"},     {1, "\xA9", 2, "\xD8\xB1"},
	    {1, "\xAA", 2, "\xD8\xB2"},     {1, "\xAB", 2, "\xD8\xB3"},     {1, "\xAC", 2, "\xD8\xB4"},
	    {1, "\xAD", 2, "\xD8\xB5"},     {1, "\xAE", 2, "\xC2\xAB"},     {1, "\xAF", 2, "\xC2\xBB"},
	    ...
	    {1, "\xE0", 2, "\xD8\xB6"},     {1, "\xE1", 2, "\xD8\xB7"},     {1, "\xE2", 2, "\xD8\xB8"},
	    {1, "\xE3", 2, "\xD8\xB9"},     {1, "\xE4", 2, "\xD8\xBA"},     {1, "\xE5", 2, "\xD9\x81"},
	    {1, "\xE6", 2, "\xC2\xB5"},     {1, "\xE7", 2, "\xD9\x82"},     {1, "\xE8", 2, "\xD9\x83"},
	    {1, "\xE9", 2, "\xD9\x84"},     {1, "\xEA", 2, "\xD9\x85"},     {1, "\xEB", 2, "\xD9\x86"},
	    {1, "\xEC", 2, "\xD9\x87"},     {1, "\xED", 2, "\xD9\x88"},     {1, "\xEE", 2, "\xD9\x89"},
	    {1, "\xEF", 2, "\xD9\x8A"},     {1, "\xF0", 3, "\xE2\x89\xA1"}, {1, "\xF1", 2, "\xD9\x8B"},
	    {1, "\xF2", 2, "\xD9\x8C"},     {1, "\xF3", 2, "\xD9\x8D"},     {1, "\xF4", 2, "\xD9\x8E"},
	    {1, "\xF5", 2, "\xD9\x8F"},     {1, "\xF6", 2, "\xD9\x90"},     {1, "\xF7", 3, "\xE2\x89\x88"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_720_p100_1997ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_720_P100_1997_to_utf8),
		                                std::size(ibm_720_P100_1997_to_utf8));
