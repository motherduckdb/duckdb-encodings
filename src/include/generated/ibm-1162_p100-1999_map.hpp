...
//                         DuckDB - Encodings
//
// generated/ibm-1162_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1162_p100_1999ToUtf {
public:
	Ibm_1162_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1162_P100-1999";
	// Generated from: ibm-1162_P100-1999.ucm
	static constexpr map_entry ibm_1162_P100_1999_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Ibm_1162_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1162_P100_1999_to_utf8),
		                                std::size(ibm_1162_P100_1999_to_utf8));
