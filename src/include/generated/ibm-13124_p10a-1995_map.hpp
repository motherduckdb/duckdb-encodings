...
public:
	...
	static constexpr map_entry ibm_13124_P10A_1995_to_utf8[] = {
	    ...
	    {1, "\x5A", 1, "\x21"},     {1, "\x5B", 2, "\xC2\xA5"},     {1, "\x5C", 1, "\x2A"},
	    ...
	    {1, "\xA0", 1, "\x7E"},     {1, "\xA1", 3, "\xE2\x80\xBE"}, {1, "\xA2", 1, "\x73"},
	    {1, "\xA3", 1, "\x74"},     {1, "\xA4", 1, "\x75"},         {1, "\xA5", 1, "\x76"},
	    {1, "\xA6", 1, "\x77"},     {1, "\xA7", 1, "\x78"},         {1, "\xA8", 1, "\x79"},
	    {1, "\xA9", 1, "\x7A"},     {1, "\xB0", 1, "\x5E"},         {1, "\xB2", 1, "\x5C"},
	    {1, "\xBA", 1, "\x5B"},     {1, "\xBB", 1, "\x5D"},         {1, "\xC0", 1, "\x7B"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                std::size(ibm_13124_P10A_1995_to_utf8));
