...
//                         DuckDB - Encodings
//
// generated/glibc-PT2-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_pt2_2_3_3ToUtf {
public:
	Glibc_pt2_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 2;
	const string name = "glibc-PT2-2.3.3";
	// Generated from: glibc-PT2-2.3.3.ucm
	static constexpr map_entry glibc_PT2_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x40", 2, "\xC2\xB4"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"}, {1, "\x43", 1, "\x43"},
	    ...
	    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},     {1, "\x5A", 1, "\x5A"}, {1, "\x5B", 2, "\xC3\x83"},
	    {1, "\x5C", 2, "\xC3\x87"}, {1, "\x5D", 2, "\xC3\x95"}, {1, "\x5E", 1, "\x5E"}, {1, "\x5F", 1, "\x5F"},
	    ...
	    {1, "\x78", 1, "\x78"},     {1, "\x79", 1, "\x79"},     {1, "\x7A", 1, "\x7A"}, {1, "\x7B", 2, "\xC3\xA3"},
	    {1, "\x7C", 2, "\xC3\xA7"}, {1, "\x7D", 2, "\xC3\xB5"}, {1, "\x7E", 1, "\x7E"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_pt2_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_PT2_2_3_3_to_utf8),
		                                std::size(glibc_PT2_2_3_3_to_utf8));
