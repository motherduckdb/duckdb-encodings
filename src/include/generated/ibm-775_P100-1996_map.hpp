...
//                         DuckDB - Encodings
//
// generated/ibm-775_P100-1996_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_775_p100_1996ToUtf {
public:
	Ibm_775_p100_1996ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-775_P100-1996";
	// Generated from: ibm-775_P100-1996.ucm
	static constexpr map_entry ibm_775_P100_1996_to_utf8[] = {
	    ...
	    {1, "\xE1", 2, "\xC3\x9F"},     {1, "\xE2", 2, "\xC5\x8C"},     {1, "\xE3", 2, "\xC5\x83"},
	    ...
	    {1, "\xF6", 2, "\xC3\xB7"},     {1, "\xF7", 3, "\xE2\x80\x9E"}, {1, "\xF8", 2, "\xC2\xB0"},
	    {1, "\xF9", 3, "\xE2\x88\x99"}, {1, "\xFA", 2, "\xC2\xB7"},     {1, "\xFB", 2, "\xC2\xB9"},
	    {1, "\xFC", 2, "\xC2\xB3"},     {1, "\xFD", 2, "\xC2\xB2"},     {1, "\xFE", 3, "\xEF\xBF\xAD"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_775_p100_1996ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_775_P100_1996_to_utf8),
		                                std::size(ibm_775_P100_1996_to_utf8));
