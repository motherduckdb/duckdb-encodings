...
public:
	...
	const string name = "iso88";
	// Generated from: hpux-iso88-11.0.ucm
	static constexpr map_entry iso88_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Iso88ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&iso88_to_utf8), std::size(iso88_to_utf8));
