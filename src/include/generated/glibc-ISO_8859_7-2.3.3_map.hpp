...
//                         DuckDB - Encodings
//
// generated/glibc-ISO_8859_7-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_iso_8859_7_2_3_3ToUtf {
public:
	Glibc_iso_8859_7_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-ISO_8859_7-2.3.3";
	// Generated from: glibc-ISO_8859_7-2.3.3.ucm
	static constexpr map_entry glibc_ISO_8859_7_2_3_3_to_utf8[] = {
	    ...
	    {1, "\xB2", 2, "\xC2\xB2"},     {1, "\xB3", 2, "\xC2\xB3"}, {1, "\xB4", 2, "\xCE\x84"},
	    {1, "\xB5", 2, "\xCE\x85"},     {1, "\xB6", 2, "\xCE\x86"}, {1, "\xB7", 2, "\xC2\xB7"},
	    ...
	    {1, "\xF5", 2, "\xCF\x85"},     {1, "\xF6", 2, "\xCF\x86"}, {1, "\xF7", 2, "\xCF\x87"},
	    {1, "\xF8", 2, "\xCF\x88"},     {1, "\xF9", 2, "\xCF\x89"}, {1, "\xFA", 2, "\xCF\x8A"},
	    {1, "\xFB", 2, "\xCF\x8B"},     {1, "\xFC", 2, "\xCF\x8C"}, {1, "\xFD", 2, "\xCF\x8D"},
	    {1, "\xFE", 2, "\xCF\x8E"},
	};
	static void Register(const DBConfig &config) {
		const Glibc_iso_8859_7_2_3_3ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&glibc_ISO_8859_7_2_3_3_to_utf8),
		                                std::size(glibc_ISO_8859_7_2_3_3_to_utf8));
