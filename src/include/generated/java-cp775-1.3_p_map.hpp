...
//                         DuckDB - Encodings
//
// generated/java-cp775-1.3_p_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Java_cp775_1_3_pToUtf {
public:
	Java_cp775_1_3_pToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "java-Cp775-1.3_P";
	// Generated from: java-Cp775-1.3_P.ucm
	static constexpr map_entry java_Cp775_1_3_P_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		const Java_cp775_1_3_pToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&java_Cp775_1_3_P_to_utf8),
		                                std::size(java_Cp775_1_3_P_to_utf8));
