...
//                         DuckDB - Encodings
//
// generated/windows-862-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_862_2000ToUtf {
public:
	Windows_862_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-862-2000";
	// Generated from: windows-862-2000.ucm
	static constexpr map_entry windows_862_2000_to_utf8[] = {
	    ...
	    {1, "\x09", 3, "\xE3\x80\x87"}, {1, "\x0A", 3, "\xE2\x97\x99"}, {1, "\x0B", 3, "\xE2\x99\x82"},
	    ...
	    {1, "\x9C", 3, "\xE2\x82\xA4"}, {1, "\x9D", 2, "\xC2\xA5"},     {1, "\x9E", 3, "\xE2\x82\xA7"},
	    ...
	    {1, "\xED", 3, "\xE2\x88\x85"}, {1, "\xEE", 2, "\xCE\xB5"},     {1, "\xEF", 3, "\xE2\x88\xA9"},
	    ...
	    {1, "\xF9", 3, "\xE2\x88\x99"}, {1, "\xFA", 3, "\xE3\x83\xBB"}, {1, "\xFB", 3, "\xE2\x9C\x93"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&windows_862_2000_to_utf8),
		                                std::size(windows_862_2000_to_utf8));
