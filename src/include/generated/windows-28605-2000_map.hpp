...
//                         DuckDB - Encodings
//
// generated/windows-28605-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_28605_2000ToUtf {
public:
	Windows_28605_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-28605-2000";
	// Generated from: windows-28605-2000.ucm
	static constexpr map_entry windows_28605_2000_to_utf8[] = {
	    ...
	    {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC5\xBE"},     {1, "\xB9", 2, "\xC2\xB9"},
	...
	static void Register(const DBConfig &config) {
		const Windows_28605_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_28605_2000_to_utf8),
		                                std::size(windows_28605_2000_to_utf8));
