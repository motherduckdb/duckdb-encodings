...
public:
	...
	// Generated from: glibc-NATS_SEFI-2.1.2.ucm
	static constexpr map_entry NATS_SEFI_to_utf8[] = {
	    ...
	    {1, "\x3F", 1, "\x3F"},         {1, "\x40", 3, "\xEE\x80\x98"}, {1, "\x41", 1, "\x41"},
	    ...
	    {1, "\x5D", 2, "\xC3\x85"},     {1, "\x5E", 3, "\xE2\x96\xA0"}, {1, "\x5F", 1, "\x5F"},
	    {1, "\x60", 3, "\xEE\x80\x99"}, {1, "\x61", 1, "\x61"},         {1, "\x62", 1, "\x62"},
	    ...
	    {1, "\x7E", 3, "\xE2\x80\x93"}, {1, "\x7F", 1, "\x7F"},
	};
	static void Register(const DBConfig &config) {
		const Nats_sefiToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&NATS_SEFI_to_utf8), std::size(NATS_SEFI_to_utf8));
