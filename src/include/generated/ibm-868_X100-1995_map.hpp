...
//                         DuckDB - Encodings
//
// generated/ibm-868_X100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_868_x100_1995ToUtf {
public:
	Ibm_868_x100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-868_X100-1995";
	// Generated from: ibm-868_X100-1995.ucm
	static constexpr map_entry ibm_868_X100_1995_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 3, "\xE2\x8C\x82"}, {1, "\x80", 2, "\xDB\xB0"},
	    {1, "\x81", 2, "\xDB\xB1"},     {1, "\x82", 2, "\xDB\xB2"},     {1, "\x83", 2, "\xDB\xB3"},
	    {1, "\x84", 2, "\xDB\xB4"},     {1, "\x85", 2, "\xDB\xB5"},     {1, "\x86", 2, "\xDB\xB6"},
	    {1, "\x87", 2, "\xDB\xB7"},     {1, "\x88", 2, "\xDB\xB8"},     {1, "\x89", 2, "\xDB\xB9"},
	    {1, "\x8A", 2, "\xD8\x8C"},     {1, "\x8B", 2, "\xD8\x9B"},     {1, "\x8C", 2, "\xD8\x9F"},
	    {1, "\x8D", 3, "\xEF\xBA\x81"}, {1, "\x8E", 3, "\xEF\xBA\x8D"}, {1, "\x8F", 3, "\xEF\xBA\x8E"},
	    {1, "\x90", 3, "\xEF\xBA\x8E"}, {1, "\x91", 3, "\xEF\xBA\x90"}, {1, "\x92", 3, "\xEF\xBA\x92"},
	    {1, "\x93", 3, "\xEF\xAD\x96"}, {1, "\x94", 3, "\xEF\xAD\x98"}, {1, "\x95", 3, "\xEF\xBA\x94"},
	    {1, "\x96", 3, "\xEF\xBA\x96"}, {1, "\x97", 3, "\xEF\xBA\x98"}, {1, "\x98", 3, "\xEF\xAD\xA6"},
	    {1, "\x99", 3, "\xEF\xAD\xA8"}, {1, "\x9A", 3, "\xEF\xBA\x9A"}, {1, "\x9B", 3, "\xEF\xBA\x9C"},
	    {1, "\x9C", 3, "\xEF\xBA\x9E"}, {1, "\x9D", 3, "\xEF\xBA\xA0"}, {1, "\x9E", 3, "\xEF\xAD\xBA"},
	    {1, "\x9F", 3, "\xEF\xAD\xBC"}, {1, "\xA0", 3, "\xEF\xBA\xA2"}, {1, "\xA1", 3, "\xEF\xBA\xA4"},
	    {1, "\xA2", 3, "\xEF\xBA\xA6"}, {1, "\xA3", 3, "\xEF\xBA\xA8"}, {1, "\xA4", 3, "\xEF\xBA\xAA"},
	    {1, "\xA5", 3, "\xEF\xAE\x88"}, {1, "\xA6", 3, "\xEF\xBA\xAC"}, {1, "\xA7", 3, "\xEF\xBA\xAE"},
	    {1, "\xA8", 3, "\xEF\xAE\x8C"}, {1, "\xA9", 3, "\xEF\xBA\xB0"}, {1, "\xAA", 3, "\xEF\xAE\x8A"},
	    {1, "\xAB", 3, "\xEF\xBA\xB2"}, {1, "\xAC", 3, "\xEF\xBA\xB4"}, {1, "\xAD", 3, "\xEF\xBA\xB6"},
	    {1, "\xAE", 2, "\xC2\xAB"},     {1, "\xAF", 2, "\xC2\xBB"},     {1, "\xB0", 3, "\xE2\x96\x91"},
	    {1, "\xB1", 3, "\xE2\x96\x92"}, {1, "\xB2", 3, "\xE2\x96\x93"}, {1, "\xB3", 3, "\xEF\xBF\xA8"},
	    {1, "\xB4", 3, "\xE2\x94\xA4"}, {1, "\xB5", 3, "\xEF\xBA\xB8"}, {1, "\xB6", 3, "\xEF\xBA\xBA"},
	    {1, "\xB7", 3, "\xEF\xBA\xBC"}, {1, "\xB8", 3, "\xEF\xBA\xBE"}, {1, "\xB9", 3, "\xE2\x95\xA3"},
	    {1, "\xBA", 3, "\xE2\x95\x91"}, {1, "\xBB", 3, "\xE2\x95\x97"}, {1, "\xBC", 3, "\xE2\x95\x9D"},
	    {1, "\xBD", 3, "\xEF\xBB\x80"}, {1, "\xBE", 3, "\xEF\xBB\x84"}, {1, "\xBF", 3, "\xE2\x94\x90"},
	    {1, "\xC0", 3, "\xE2\x94\x94"}, {1, "\xC1", 3, "\xE2\x94\xB4"}, {1, "\xC2", 3, "\xE2\x94\xAC"},
	    {1, "\xC3", 3, "\xE2\x94\x9C"}, {1, "\xC4", 3, "\xE2\x94\x80"}, {1, "\xC5", 3, "\xE2\x94\xBC"},
	    {1, "\xC6", 3, "\xEF\xBB\x88"}, {1, "\xC7", 3, "\xEF\xBB\x89"}, {1, "\xC8", 3, "\xE2\x95\x9A"},
	    {1, "\xC9", 3, "\xE2\x95\x94"}, {1, "\xCA", 3, "\xE2\x95\xA9"}, {1, "\xCB", 3, "\xE2\x95\xA6"},
	    {1, "\xCC", 3, "\xE2\x95\xA0"}, {1, "\xCD", 3, "\xE2\x95\x90"}, {1, "\xCE", 3, "\xE2\x95\xAC"},
	    {1, "\xCF", 3, "\xEF\xBB\x8A"}, {1, "\xD0", 3, "\xEF\xBB\x8B"}, {1, "\xD1", 3, "\xEF\xBB\x8C"},
	    {1, "\xD2", 3, "\xEF\xBB\x8D"}, {1, "\xD3", 3, "\xEF\xBB\x8E"}, {1, "\xD4", 3, "\xEF\xBB\x8F"},
	    {1, "\xD5", 3, "\xEF\xBB\x90"}, {1, "\xD6", 3, "\xEF\xBB\x92"}, {1, "\xD7", 3, "\xEF\xBB\x94"},
	    {1, "\xD8", 3, "\xEF\xBB\x96"}, {1, "\xD9", 3, "\xE2\x94\x98"}, {1, "\xDA", 3, "\xE2\x94\x8C"},
	    {1, "\xDB", 3, "\xE2\x96\x88"}, {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 3, "\xEF\xBB\x98"},
	    {1, "\xDE", 3, "\xEF\xAE\x8E"}, {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 3, "\xEF\xBB\x9C"},
	    {1, "\xE1", 3, "\xEF\xAE\x92"}, {1, "\xE2", 3, "\xEF\xAE\x94"}, {1, "\xE3", 3, "\xEF\xBB\x9E"},
	    {1, "\xE4", 3, "\xEF\xBB\x9F"}, {1, "\xE5", 3, "\xEF\xBB\xA0"}, {1, "\xE6", 3, "\xEF\xBB\xA2"},
	    {1, "\xE7", 3, "\xEF\xBB\xA4"}, {1, "\xE8", 3, "\xEF\xAE\x9E"}, {1, "\xE9", 3, "\xEF\xBB\xA6"},
	    {1, "\xEA", 3, "\xEF\xBB\xA8"}, {1, "\xEB", 3, "\xEF\xBA\x86"}, {1, "\xEC", 3, "\xEF\xBB\xAE"},
	    {1, "\xED", 3, "\xEF\xAE\xA6"}, {1, "\xEE", 3, "\xEF\xAE\xA8"}, {1, "\xEF", 3, "\xEF\xAE\xA9"},
	    {1, "\xF0", 2, "\xC2\xAD"},     {1, "\xF1", 3, "\xEF\xAE\xAA"}, {1, "\xF2", 3, "\xEF\xBA\x80"},
	    {1, "\xF3", 3, "\xEF\xBA\x89"}, {1, "\xF4", 3, "\xEF\xBA\x8A"}, {1, "\xF5", 3, "\xEF\xBA\x8C"},
	    {1, "\xF6", 3, "\xEF\xAF\xBC"}, {1, "\xF7", 3, "\xEF\xAF\xBD"}, {1, "\xF8", 3, "\xEF\xAF\xBE"},
	    {1, "\xF9", 3, "\xEF\xAE\xB0"}, {1, "\xFA", 3, "\xEF\xAE\xAE"}, {1, "\xFB", 3, "\xEF\xB9\xBC"},
	    {1, "\xFC", 3, "\xEF\xB9\xBD"}, {1, "\xFE", 3, "\xEF\xBF\xAD"}, {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_868_x100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_868_X100_1995_to_utf8),
		                                std::size(ibm_868_X100_1995_to_utf8));
