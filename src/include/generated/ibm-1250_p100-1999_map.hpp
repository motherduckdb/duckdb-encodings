...
//                         DuckDB - Encodings
//
// generated/ibm-1250_p100-1999_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1250_p100_1999ToUtf {
public:
	Ibm_1250_p100_1999ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1250_P100-1999";
	// Generated from: ibm-1250_P100-1999.ucm
	static constexpr map_entry ibm_1250_P100_1999_to_utf8[] = {
	    ...
	    {1, "\x9F", 2, "\xC5\xBA"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xCB\x87"},
	    {1, "\xA2", 2, "\xCB\x98"},     {1, "\xA3", 2, "\xC5\x81"},     {1, "\xA4", 2, "\xC2\xA4"},
	    {1, "\xA5", 2, "\xC4\x84"},     {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},
	    {1, "\xA8", 2, "\xC2\xA8"},     {1, "\xA9", 2, "\xC2\xA9"},     {1, "\xAA", 2, "\xC5\x9E"},
	    {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC2\xAC"},     {1, "\xAD", 2, "\xC2\xAD"},
	    {1, "\xAE", 2, "\xC2\xAE"},     {1, "\xAF", 2, "\xC5\xBB"},     {1, "\xB0", 2, "\xC2\xB0"},
	    {1, "\xB1", 2, "\xC2\xB1"},     {1, "\xB2", 2, "\xCB\x9B"},     {1, "\xB3", 2, "\xC5\x82"},
	    {1, "\xB4", 2, "\xC2\xB4"},     {1, "\xB5", 2, "\xC2\xB5"},     {1, "\xB6", 2, "\xC2\xB6"},
	    {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC2\xB8"},     {1, "\xB9", 2, "\xC4\x85"},
	    {1, "\xBA", 2, "\xC5\x9F"},     {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC4\xBD"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_1250_p100_1999ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1250_P100_1999_to_utf8),
		                                std::size(ibm_1250_P100_1999_to_utf8));
