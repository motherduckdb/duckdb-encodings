...
//                         DuckDB - Encodings
//
// generated/ibm-851_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_851_p100_1995ToUtf {
public:
	Ibm_851_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-851_P100-1995";
	// Generated from: ibm-851_P100-1995.ucm
	static constexpr map_entry ibm_851_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x84", 2, "\xC3\xA4"},     {1, "\x85", 2, "\xC3\xA0"},     {1, "\x86", 2, "\xCE\x86"},
	    {1, "\x87", 2, "\xC3\xA7"},     {1, "\x88", 2, "\xC3\xAA"},     {1, "\x89", 2, "\xC3\xAB"},
	    {1, "\x8A", 2, "\xC3\xA8"},     {1, "\x8B", 2, "\xC3\xAF"},     {1, "\x8C", 2, "\xC3\xAE"},
	    {1, "\x8D", 2, "\xCE\x88"},     {1, "\x8E", 2, "\xC3\x84"},     {1, "\x8F", 2, "\xCE\x89"},
	    {1, "\x90", 2, "\xCE\x8A"},     {1, "\x92", 2, "\xCE\x8C"},     {1, "\x93", 2, "\xC3\xB4"},
	    {1, "\x94", 2, "\xC3\xB6"},     {1, "\x95", 2, "\xCE\x8E"},     {1, "\x96", 2, "\xC3\xBB"},
	    {1, "\x97", 2, "\xC3\xB9"},     {1, "\x98", 2, "\xCE\x8F"},     {1, "\x99", 2, "\xC3\x96"},
	    {1, "\x9A", 2, "\xC3\x9C"},     {1, "\x9B", 2, "\xCE\xAC"},     {1, "\x9C", 2, "\xC2\xA3"},
	    {1, "\x9D", 2, "\xCE\xAD"},     {1, "\x9E", 2, "\xCE\xAE"},     {1, "\x9F", 2, "\xCE\xAF"},
	    {1, "\xA0", 2, "\xCF\x8A"},     {1, "\xA1", 2, "\xCE\x90"},     {1, "\xA2", 2, "\xCF\x8C"},
	    {1, "\xA3", 2, "\xCF\x8D"},     {1, "\xA4", 2, "\xCE\x91"},     {1, "\xA5", 2, "\xCE\x92"},
	    {1, "\xA6", 2, "\xCE\x93"},     {1, "\xA7", 2, "\xCE\x94"},     {1, "\xA8", 2, "\xCE\x95"},
	    {1, "\xA9", 2, "\xCE\x96"},     {1, "\xAA", 2, "\xCE\x97"},     {1, "\xAB", 2, "\xC2\xBD"},
	    {1, "\xAC", 2, "\xCE\x98"},     {1, "\xAD", 2, "\xCE\x99"},     {1, "\xAE", 2, "\xC2\xAB"},
	    {1, "\xAF", 2, "\xC2\xBB"},     {1, "\xB0", 3, "\xE2\x96\x91"}, {1, "\xB1", 3, "\xE2\x96\x92"},
	    {1, "\xB2", 3, "\xE2\x96\x93"}, {1, "\xB3", 3, "\xEF\xBF\xA8"}, {1, "\xB4", 3, "\xE2\x94\xA4"},
	    {1, "\xB5", 2, "\xCE\x9A"},     {1, "\xB6", 2, "\xCE\x9B"},     {1, "\xB7", 2, "\xCE\x9C"},
	    {1, "\xB8", 2, "\xCE\x9D"},     {1, "\xB9", 3, "\xE2\x95\xA3"}, {1, "\xBA", 3, "\xE2\x95\x91"},
	    {1, "\xBB", 3, "\xE2\x95\x97"}, {1, "\xBC", 3, "\xE2\x95\x9D"}, {1, "\xBD", 2, "\xCE\x9E"},
	    {1, "\xBE", 2, "\xCE\x9F"},     {1, "\xBF", 3, "\xE2\x94\x90"}, {1, "\xC0", 3, "\xE2\x94\x94"},
	    {1, "\xC1", 3, "\xE2\x94\xB4"}, {1, "\xC2", 3, "\xE2\x94\xAC"}, {1, "\xC3", 3, "\xE2\x94\x9C"},
	    {1, "\xC4", 3, "\xE2\x94\x80"}, {1, "\xC5", 3, "\xE2\x94\xBC"}, {1, "\xC6", 2, "\xCE\xA0"},
	    {1, "\xC7", 2, "\xCE\xA1"},     {1, "\xC8", 3, "\xE2\x95\x9A"}, {1, "\xC9", 3, "\xE2\x95\x94"},
	    {1, "\xCA", 3, "\xE2\x95\xA9"}, {1, "\xCB", 3, "\xE2\x95\xA6"}, {1, "\xCC", 3, "\xE2\x95\xA0"},
	    {1, "\xCD", 3, "\xE2\x95\x90"}, {1, "\xCE", 3, "\xE2\x95\xAC"}, {1, "\xCF", 2, "\xCE\xA3"},
	    {1, "\xD0", 2, "\xCE\xA4"},     {1, "\xD1", 2, "\xCE\xA5"},     {1, "\xD2", 2, "\xCE\xA6"},
	    {1, "\xD3", 2, "\xCE\xA7"},     {1, "\xD4", 2, "\xCE\xA8"},     {1, "\xD5", 2, "\xCE\xA9"},
	    {1, "\xD6", 2, "\xCE\xB1"},     {1, "\xD7", 2, "\xCE\xB2"},     {1, "\xD8", 2, "\xCE\xB3"},
	    {1, "\xD9", 3, "\xE2\x94\x98"}, {1, "\xDA", 3, "\xE2\x94\x8C"}, {1, "\xDB", 3, "\xE2\x96\x88"},
	    {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 2, "\xCE\xB4"},     {1, "\xDE", 2, "\xCE\xB5"},
	    {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 2, "\xCE\xB6"},     {1, "\xE1", 2, "\xCE\xB7"},
	    {1, "\xE2", 2, "\xCE\xB8"},     {1, "\xE3", 2, "\xCE\xB9"},     {1, "\xE4", 2, "\xCE\xBA"},
	    {1, "\xE5", 2, "\xCE\xBB"},     {1, "\xE6", 2, "\xCE\xBC"},     {1, "\xE7", 2, "\xCE\xBD"},
	    {1, "\xE8", 2, "\xCE\xBE"},     {1, "\xE9", 2, "\xCE\xBF"},     {1, "\xEA", 2, "\xCF\x80"},
	    {1, "\xEB", 2, "\xCF\x81"},     {1, "\xEC", 2, "\xCF\x83"},     {1, "\xED", 2, "\xCF\x82"},
	    {1, "\xEE", 2, "\xCF\x84"},     {1, "\xEF", 2, "\xC2\xB4"},     {1, "\xF0", 2, "\xC2\xAD"},
	    {1, "\xF1", 2, "\xC2\xB1"},     {1, "\xF2", 2, "\xCF\x85"},     {1, "\xF3", 2, "\xCF\x95"},
	    {1, "\xF4", 2, "\xCF\x87"},     {1, "\xF5", 2, "\xC2\xA7"},     {1, "\xF6", 2, "\xCF\x88"},
	    {1, "\xF7", 2, "\xC2\xB8"},     {1, "\xF8", 2, "\xC2\xB0"},     {1, "\xF9", 2, "\xC2\xA8"},
	    {1, "\xFA", 2, "\xCF\x89"},     {1, "\xFB", 2, "\xCF\x8B"},     {1, "\xFC", 2, "\xCE\xB0"},
	    {1, "\xFD", 2, "\xCF\x8E"},     {1, "\xFE", 3, "\xEF\xBF\xAD"}, {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_851_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_851_P100_1995_to_utf8),
		                                std::size(ibm_851_P100_1995_to_utf8));
