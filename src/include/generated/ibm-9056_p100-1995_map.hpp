...
//                         DuckDB - Encodings
//
// generated/ibm-9056_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_9056_p100_1995ToUtf {
public:
	Ibm_9056_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-9056_P100-1995";
	// Generated from: ibm-9056_P100-1995.ucm
	static constexpr map_entry ibm_9056_P100_1995_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\xA0", 2, "\xC2\xA0"},
	    {1, "\xA1", 2, "\xC2\xAD"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 2, "\xC2\xA4"},
	    {1, "\xAC", 2, "\xD8\x8C"},     {1, "\xB0", 2, "\xD9\xA0"},     {1, "\xB1", 2, "\xD9\xA1"},
	    {1, "\xB2", 2, "\xD9\xA2"},     {1, "\xB3", 2, "\xD9\xA3"},     {1, "\xB4", 2, "\xD9\xA4"},
	    {1, "\xB5", 2, "\xD9\xA5"},     {1, "\xB6", 2, "\xD9\xA6"},     {1, "\xB7", 2, "\xD9\xA7"},
	    {1, "\xB8", 2, "\xD9\xA8"},     {1, "\xB9", 2, "\xD9\xA9"},     {1, "\xBB", 2, "\xD8\x9B"},
	    ...
	    {1, "\xDE", 2, "\xC3\x97"},     {1, "\xE0", 2, "\xD9\x80"},     {1, "\xE1", 3, "\xEF\xBB\x94"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_9056_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_9056_P100_1995_to_utf8),
		                                std::size(ibm_9056_P100_1995_to_utf8));
