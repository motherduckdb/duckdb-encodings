...
//                         DuckDB - Encodings
//
// generated/ibm-1131_P100-1997_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1131_p100_1997ToUtf {
public:
	Ibm_1131_p100_1997ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1131_P100-1997";
	// Generated from: ibm-1131_P100-1997.ucm
	static constexpr map_entry ibm_1131_P100_1997_to_utf8[] = {
	    ...
	    {1, "\xF0", 2, "\xD0\x81"},     {1, "\xF1", 2, "\xD1\x91"},     {1, "\xF2", 2, "\xD0\x84"},
	    {1, "\xF3", 2, "\xD1\x94"},     {1, "\xF4", 2, "\xD0\x87"},     {1, "\xF5", 2, "\xD1\x97"},
	    {1, "\xF6", 2, "\xD0\x8E"},     {1, "\xF7", 2, "\xD1\x9E"},     {1, "\xF8", 2, "\xD0\x86"},
	    {1, "\xF9", 2, "\xD1\x96"},     {1, "\xFA", 2, "\xC2\xB7"},     {1, "\xFB", 2, "\xC2\xA4"},
	    {1, "\xFC", 2, "\xD2\x90"},     {1, "\xFD", 2, "\xD2\x91"},     {1, "\xFE", 3, "\xE2\x88\x99"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1131_p100_1997ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1131_P100_1997_to_utf8),
		                                std::size(ibm_1131_P100_1997_to_utf8));
