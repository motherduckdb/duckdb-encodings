...
//                         DuckDB - Encodings
//
// generated/ibm-9447_p100-2002_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_9447_p100_2002ToUtf {
public:
	Ibm_9447_p100_2002ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-9447_P100-2002";
	// Generated from: ibm-9447_P100-2002.ucm
	static constexpr map_entry ibm_9447_P100_2002_to_utf8[] = {
	    ...
	    {1, "\xC9", 2, "\xD6\xB9"},     {1, "\xCB", 2, "\xD6\xBB"},     {1, "\xCC", 2, "\xD6\xBC"},
	    {1, "\xCD", 2, "\xD6\xBD"},     {1, "\xCE", 2, "\xD6\xBE"},     {1, "\xCF", 2, "\xD6\xBF"},
	    {1, "\xD0", 2, "\xD7\x80"},     {1, "\xD1", 2, "\xD7\x81"},     {1, "\xD2", 2, "\xD7\x82"},
	    {1, "\xD3", 2, "\xD7\x83"},     {1, "\xD4", 2, "\xD7\xB0"},     {1, "\xD5", 2, "\xD7\xB1"},
	    {1, "\xD6", 2, "\xD7\xB2"},     {1, "\xD7", 2, "\xD7\xB3"},     {1, "\xD8", 2, "\xD7\xB4"},
	...
	static void Register(const DBConfig &config) {
		const Ibm_9447_p100_2002ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_9447_P100_2002_to_utf8),
		                                std::size(ibm_9447_P100_2002_to_utf8));
