...
//                         DuckDB - Encodings
//
// generated/glibc-ksc5636-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_ksc5636_2_3_3ToUtf {
public:
	Glibc_ksc5636_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-KSC5636-2.3.3";
	// Generated from: glibc-KSC5636-2.3.3.ucm
	static constexpr map_entry glibc_KSC5636_2_3_3_to_utf8[] = {
	    ...
	    {1, "\x5C", 3, "\xE2\x82\xA9"}, {1, "\x5D", 1, "\x5D"}, {1, "\x5E", 1, "\x5E"}, {1, "\x5F", 1, "\x5F"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&glibc_KSC5636_2_3_3_to_utf8),
		                                std::size(glibc_KSC5636_2_3_3_to_utf8));
