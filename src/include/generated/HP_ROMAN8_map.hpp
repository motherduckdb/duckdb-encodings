...
public:
	...
	// Generated from: glibc-HP_ROMAN8-2.1.2.ucm
	static constexpr map_entry HP_ROMAN8_to_utf8[] = {
	    ...
	    {1, "\xA8", 2, "\xC2\xB4"},     {1, "\xA9", 2, "\xCB\x8B"},     {1, "\xAA", 2, "\xCB\x86"},
	    {1, "\xAB", 2, "\xC2\xA8"},     {1, "\xAC", 2, "\xCB\x9C"},     {1, "\xAD", 2, "\xC3\x99"},
	    ...
	    {1, "\xF6", 3, "\xE2\x80\x94"}, {1, "\xF7", 2, "\xC2\xBC"},     {1, "\xF8", 2, "\xC2\xBD"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&HP_ROMAN8_to_utf8), std::size(HP_ROMAN8_to_utf8));
