...
//                         DuckDB - Encodings
//
// generated/glibc-IBM874-2.3.3_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Glibc_ibm874_2_3_3ToUtf {
public:
	Glibc_ibm874_2_3_3ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "glibc-IBM874-2.3.3";
	// Generated from: glibc-IBM874-2.3.3.ucm
	static constexpr map_entry glibc_IBM874_2_3_3_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&glibc_IBM874_2_3_3_to_utf8),
		                                std::size(glibc_IBM874_2_3_3_to_utf8));
