...
//                         DuckDB - Encodings
//
// generated/windows-720-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_720_2000ToUtf {
public:
	Windows_720_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-720-2000";
	// Generated from: windows-720-2000.ucm
	static constexpr map_entry windows_720_2000_to_utf8[] = {
	    ...
	    {1, "\x81", 2, "\xC2\x81"},     {1, "\x82", 2, "\xC3\xA9"},     {1, "\x83", 2, "\xC3\xA2"},
	    {1, "\x84", 2, "\xC2\x84"},     {1, "\x85", 2, "\xC3\xA0"},     {1, "\x86", 2, "\xC2\x86"},
	    ...
	    {1, "\x90", 2, "\xC2\x90"},     {1, "\x91", 3, "\xEF\xB9\xBD"}, {1, "\x92", 3, "\xEF\xB9\xBF"},
	    {1, "\x93", 2, "\xC3\xB4"},     {1, "\x94", 2, "\xC2\xA4"},     {1, "\x95", 2, "\xD9\x80"},
	    {1, "\x96", 2, "\xC3\xBB"},     {1, "\x97", 2, "\xC3\xB9"},     {1, "\x98", 3, "\xEF\xBA\x80"},
	    {1, "\x99", 3, "\xEF\xBA\x82"}, {1, "\x9A", 3, "\xEF\xBA\x84"}, {1, "\x9B", 3, "\xEF\xBA\x86"},
	    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 3, "\xEF\xBA\x88"}, {1, "\x9E", 3, "\xEF\xBA\x8C"},
	    {1, "\x9F", 3, "\xEF\xBA\x8E"}, {1, "\xA0", 3, "\xEF\xBA\x92"}, {1, "\xA1", 3, "\xEF\xBA\x94"},
	    {1, "\xA2", 3, "\xEF\xBA\x98"}, {1, "\xA3", 3, "\xEF\xBA\x9C"}, {1, "\xA4", 3, "\xEF\xBA\xA0"},
	    {1, "\xA5", 3, "\xEF\xBA\xA4"}, {1, "\xA6", 3, "\xEF\xBA\xA8"}, {1, "\xA7", 3, "\xEF\xBA\xAA"},
	    {1, "\xA8", 3, "\xEF\xBA\xAC"}, {1, "\xA9", 3, "\xEF\xBA\xAE"}, {1, "\xAA", 3, "\xEF\xBA\xB0"},
	    {1, "\xAB", 3, "\xEF\xBA\xB4"}, {1, "\xAC", 3, "\xEF\xBA\xB8"}, {1, "\xAD", 3, "\xEF\xBA\xBC"},
	    ...
	    {1, "\xDE", 3, "\xE2\x96\x90"}, {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 3, "\xEF\xBB\x80"},
	    {1, "\xE1", 3, "\xEF\xBB\x84"}, {1, "\xE2", 3, "\xEF\xBB\x88"}, {1, "\xE3", 3, "\xEF\xBB\x8C"},
	    {1, "\xE4", 3, "\xEF\xBB\x90"}, {1, "\xE5", 3, "\xEF\xBB\x94"}, {1, "\xE6", 2, "\xC2\xB5"},
	    {1, "\xE7", 3, "\xEF\xBB\x98"}, {1, "\xE8", 3, "\xEF\xBB\x9C"}, {1, "\xE9", 3, "\xEF\xBB\xA0"},
	    {1, "\xEA", 3, "\xEF\xBB\xA4"}, {1, "\xEB", 3, "\xEF\xBB\xA8"}, {1, "\xEC", 3, "\xEF\xBB\xAC"},
	    {1, "\xED", 3, "\xEF\xBB\xAE"}, {1, "\xEE", 3, "\xEF\xBB\xB0"}, {1, "\xEF", 3, "\xEF\xBB\xB4"},
	    {1, "\xF0", 3, "\xE2\x89\xA1"}, {1, "\xF1", 3, "\xEF\xB9\xB1"}, {1, "\xF2", 3, "\xEF\xB9\xB2"},
	    {1, "\xF3", 3, "\xEF\xB9\xB4"}, {1, "\xF4", 3, "\xEF\xB9\xB7"}, {1, "\xF5", 3, "\xEF\xB9\xB9"},
	    {1, "\xF6", 3, "\xEF\xB9\xBB"}, {1, "\xF7", 3, "\xE2\x89\x88"}, {1, "\xF8", 2, "\xC2\xB0"},
	    {1, "\xF9", 3, "\xE2\x88\x99"}, {1, "\xFA", 2, "\xC2\xB7"},     {1, "\xFB", 3, "\xE2\x88\x9A"},
	    {1, "\xFC", 3, "\xE2\x81\xBF"}, {1, "\xFD", 2, "\xC2\xB2"},     {1, "\xFE", 3, "\xE2\x96\xA0"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Windows_720_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_720_2000_to_utf8),
		                                std::size(windows_720_2000_to_utf8));
