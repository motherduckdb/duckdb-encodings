...
//                         DuckDB - Encodings
//
// generated/windows-1257-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_1257_2000ToUtf {
public:
	Windows_1257_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-1257-2000";
	// Generated from: windows-1257-2000.ucm
	static constexpr map_entry windows_1257_2000_to_utf8[] = {
	    ...
	    {1, "\x9C", 2, "\xC2\x9C"},     {1, "\x9D", 2, "\xC2\xAF"},     {1, "\x9E", 2, "\xCB\x9B"},
	    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 3, "\xEF\xA3\xBC"},
	    {1, "\xA2", 2, "\xC2\xA2"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 2, "\xC2\xA4"},
	    {1, "\xA5", 3, "\xEF\xA3\xBD"}, {1, "\xA6", 2, "\xC2\xA6"},     {1, "\xA7", 2, "\xC2\xA7"},
	...
	static void Register(const DBConfig &config) {
		const Windows_1257_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_1257_2000_to_utf8),
		                                std::size(windows_1257_2000_to_utf8));
