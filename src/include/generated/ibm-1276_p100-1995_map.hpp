...
//                         DuckDB - Encodings
//
// generated/ibm-1276_p100-1995_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Ibm_1276_p100_1995ToUtf {
public:
	Ibm_1276_p100_1995ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "ibm-1276_P100-1995";
	// Generated from: ibm-1276_P100-1995.ucm
	static constexpr map_entry ibm_1276_P100_1995_to_utf8[] = {
	    ...
	    {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xE2\x81\x84"}, {1, "\xA5", 2, "\xC2\xA5"},
	    {1, "\xA6", 2, "\xC6\x92"},     {1, "\xA7", 2, "\xC2\xA7"},     {1, "\xA8", 2, "\xC2\xA4"},
	    {1, "\xA9", 3, "\xEF\xBC\x87"}, {1, "\xAA", 3, "\xE2\x80\x9C"}, {1, "\xAB", 2, "\xC2\xAB"},
	    {1, "\xAC", 3, "\xE2\x80\xB9"}, {1, "\xAD", 3, "\xE2\x80\xBA"}, {1, "\xAE", 3, "\xEF\xAC\x81"},
	    {1, "\xAF", 3, "\xEF\xAC\x82"}, {1, "\xB1", 3, "\xE2\x80\x93"}, {1, "\xB2", 3, "\xE2\x80\xA0"},
	    {1, "\xB3", 3, "\xE2\x80\xA1"}, {1, "\xB4", 2, "\xC2\xB7"},     {1, "\xB6", 2, "\xC2\xB6"},
	    {1, "\xB7", 3, "\xE2\x80\xA2"}, {1, "\xB8", 3, "\xE2\x80\x9A"}, {1, "\xB9", 3, "\xE2\x80\x9E"},
	    {1, "\xBA", 3, "\xE2\x80\x9D"}, {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 3, "\xE2\x80\xA6"},
	    {1, "\xBD", 3, "\xE2\x80\xB0"}, {1, "\xBF", 2, "\xC2\xBF"},     {1, "\xC1", 3, "\xEF\xBD\x80"},
	    {1, "\xC2", 2, "\xC2\xB4"},     {1, "\xC3", 2, "\xCB\x86"},     {1, "\xC4", 2, "\xCB\x9C"},
	    {1, "\xC5", 2, "\xC2\xAF"},     {1, "\xC6", 2, "\xCB\x98"},     {1, "\xC7", 2, "\xCB\x99"},
	    {1, "\xC8", 2, "\xC2\xA8"},     {1, "\xCA", 2, "\xCB\x9A"},     {1, "\xCB", 2, "\xC2\xB8"},
	    {1, "\xCD", 2, "\xCB\x9D"},     {1, "\xCE", 2, "\xCB\x9B"},     {1, "\xCF", 2, "\xCB\x87"},
	    {1, "\xD0", 3, "\xE2\x80\x94"}, {1, "\xE1", 2, "\xC3\x86"},     {1, "\xE3", 2, "\xC2\xAA"},
	    {1, "\xE8", 2, "\xC5\x81"},     {1, "\xE9", 2, "\xC3\x98"},     {1, "\xEA", 2, "\xC5\x92"},
	    {1, "\xEB", 2, "\xC2\xBA"},     {1, "\xF1", 2, "\xC3\xA6"},     {1, "\xF5", 2, "\xC4\xB1"},
	    {1, "\xF8", 2, "\xC5\x82"},     {1, "\xF9", 2, "\xC3\xB8"},     {1, "\xFA", 2, "\xC5\x93"},
	    {1, "\xFB", 2, "\xC3\x9F"},
	};
	static void Register(const DBConfig &config) {
		const Ibm_1276_p100_1995ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&ibm_1276_P100_1995_to_utf8),
		                                std::size(ibm_1276_P100_1995_to_utf8));
