...
public:
	...
	const string name = "8859_1";
	// Generated from: solaris-8859_1-2.7.ucm
	static constexpr map_entry _8859_1_to_utf8[] = {
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&_8859_1_to_utf8), std::size(_8859_1_to_utf8));
