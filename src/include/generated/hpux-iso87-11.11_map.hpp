...
//                         DuckDB - Encodings
//
// generated/hpux-iso87-11.11_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Hpux_iso87_11_11ToUtf {
public:
	Hpux_iso87_11_11ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "hpux-iso87-11.11";
	// Generated from: hpux-iso87-11.11.ucm
	static constexpr map_entry hpux_iso87_11_11_to_utf8[] = {
	    ...
	    {1, "\xA2", 2, "\xCA\xBC"},     {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 3, "\xE2\x82\xAC"},
	    ...
	    {1, "\xAE", 2, "\xCD\xBE"},     {1, "\xAF", 3, "\xE2\x80\x95"}, {1, "\xB0", 2, "\xC2\xB0"},
	...
	static void Register(const DBConfig &config) {
		const Hpux_iso87_11_11ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&hpux_iso87_11_11_to_utf8),
		                                std::size(hpux_iso87_11_11_to_utf8));
