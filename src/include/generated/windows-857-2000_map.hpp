...
//                         DuckDB - Encodings
//
// generated/windows-857-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_857_2000ToUtf {
public:
	Windows_857_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-857-2000";
	// Generated from: windows-857-2000.ucm
	static constexpr map_entry windows_857_2000_to_utf8[] = {
	    ...
	    {1, "\xD5", 3, "\xEF\xA2\xBB"}, {1, "\xD6", 2, "\xC3\x8D"},     {1, "\xD7", 2, "\xC3\x8E"},
	    ...
	    {1, "\xE7", 3, "\xEF\xA2\xBC"}, {1, "\xE8", 2, "\xC3\x97"},     {1, "\xE9", 2, "\xC3\x9A"},
	    {1, "\xEA", 2, "\xC3\x9B"},     {1, "\xEB", 2, "\xC3\x99"},     {1, "\xEC", 2, "\xC3\xAC"},
	    {1, "\xED", 2, "\xC3\xBF"},     {1, "\xEE", 2, "\xC2\xAF"},     {1, "\xEF", 2, "\xCC\x81"},
	    {1, "\xF0", 2, "\xC2\xAD"},     {1, "\xF1", 3, "\xE2\x88\x93"}, {1, "\xF2", 3, "\xEF\xA2\xBD"},
	    {1, "\xF3", 2, "\xC2\xBE"},     {1, "\xF4", 2, "\xC2\xB6"},     {1, "\xF5", 2, "\xC2\xA7"},
	    {1, "\xF6", 2, "\xC3\xB7"},     {1, "\xF7", 2, "\xCC\xA7"},     {1, "\xF8", 3, "\xE2\x88\x98"},
	    {1, "\xF9", 2, "\xCC\x88"},     {1, "\xFA", 2, "\xCC\x87"},     {1, "\xFB", 2, "\xC2\xB9"},
	    {1, "\xFC", 2, "\xC2\xB3"},     {1, "\xFD", 2, "\xC2\xB2"},     {1, "\xFE", 3, "\xE2\x96\xA0"},
	    {1, "\xFF", 2, "\xC2\xA0"},
	};
	static void Register(const DBConfig &config) {
		const Windows_857_2000ToUtf generated_function;
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
		                                reinterpret_cast<uintptr_t>(&windows_857_2000_to_utf8),
		                                std::size(windows_857_2000_to_utf8));
