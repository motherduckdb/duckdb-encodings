...
//                         DuckDB - Encodings
//
// generated/windows-874-2000_map.hpp
//
//
//===----------------------------------------------------------------------===//
...
class Windows_874_2000ToUtf {
public:
	Windows_874_2000ToUtf() {};
	const idx_t lookup_bytes = 1;
	const idx_t max_bytes_per_byte = 3;
	const string name = "windows-874-2000";
	// Generated from: windows-874-2000.ucm
	static constexpr map_entry windows_874_2000_to_utf8[] = {
	    ...
	    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 3, "\xE2\x8C\x82"}, {1, "\x80", 3, "\xE2\x82\xAC"},
	    ...
	    {1, "\xB1", 3, "\xE0\xB8\x91"}, {1, "\xB2", 3, "\xE0\xB8\x92"}, {1, "\xB3", 3, "\xE2\x94\x82"},
	    ...
	    {1, "\xBD", 3, "\xE0\xB8\x9D"}, {1, "\xBE", 3, "\xE0\xB8\x9E"}, {1, "\xBF", 3, "\xE2\x94\x90"},
	    {1, "\xC0", 3, "\xE2\x94\x94"}, {1, "\xC1", 3, "\xE0\xB8\xA1"}, {1, "\xC2", 3, "\xE0\xB8\xA2"},
	    {1, "\xC3", 3, "\xE0\xB8\xA3"}, {1, "\xC4", 3, "\xE2\x94\x80"}, {1, "\xC5", 3, "\xE0\xB8\xA5"},
	    {1, "\xC6", 3, "\xE0\xB8\xA6"}, {1, "\xC7", 3, "\xE0\xB8\xA7"}, {1, "\xC8", 3, "\xE2\x95\x9A"},
	    {1, "\xC9", 3, "\xE2\x95\x94"}, {1, "\xCA", 3, "\xE0\xB8\xAA"}, {1, "\xCB", 3, "\xE0\xB8\xAB"},
	    {1, "\xCC", 3, "\xE0\xB8\xAC"}, {1, "\xCD", 3, "\xE2\x95\x90"}, {1, "\xCE", 3, "\xE0\xB8\xAE"},
	    ...
	    {1, "\xD8", 3, "\xE0\xB8\xB8"}, {1, "\xD9", 3, "\xE2\x94\x98"}, {1, "\xDA", 3, "\xE2\x94\x8C"},
	    {1, "\xDB", 3, "\xEF\xA3\x81"}, {1, "\xDC", 3, "\xEF\xA3\x82"}, {1, "\xDD", 3, "\xEF\xA3\x83"},
	    {1, "\xDE", 3, "\xEF\xA3\x84"}, {1, "\xDF", 3, "\xE0\xB8\xBF"}, {1, "\xE0", 3, "\xE0\xB9\x80"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&windows_874_2000_to_utf8),
		                                std::size(windows_874_2000_to_utf8));
