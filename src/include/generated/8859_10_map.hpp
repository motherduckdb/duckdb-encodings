...
public:
	...
	static constexpr map_entry _8859_10_to_utf8[] = {
	    ...
	    {1, "\xBD", 3, "\xE2\x88\x92"}, {1, "\xBE", 2, "\xC5\xAB"}, {1, "\xBF", 2, "\xC5\x8B"},
	...
	static void Register(const DBConfig &config) {
		...
		const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
		                                ...
		                                reinterpret_cast<uintptr_t>(&_8859_10_to_utf8), std::size(_8859_10_to_utf8));
