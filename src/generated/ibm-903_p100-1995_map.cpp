...
// Generated from: ibm-903_P100-1995.ucm
static const map_entry_encoding ibm_903_P100_1995_to_utf8[] = {
    ...
    {1, "\x7E", 3, "\xE2\x80\xBE"}, {1, "\x7F", 1, "\x1A"},
};
void Ibm_903_p100_1995ToUtf::Register(const DBConfig &config) {
	const Ibm_903_p100_1995ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_903_P100_1995_to_utf8, generated_function.size);
