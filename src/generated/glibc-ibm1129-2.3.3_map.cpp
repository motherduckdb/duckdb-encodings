...
// Generated from: glibc-IBM1129-2.3.3.ucm
static const map_entry_encoding glibc_IBM1129_2_3_3_to_utf8[] = {
    ...
    {1, "\xA8", 2, "\xC5\x93"}, {1, "\xA9", 2, "\xC2\xA9"}, {1, "\xAA", 2, "\xC2\xAA"},     {1, "\xAB", 2, "\xC2\xAB"},
    ...
    {1, "\xB4", 2, "\xC5\xB8"}, {1, "\xB5", 2, "\xC2\xB5"}, {1, "\xB6", 2, "\xC2\xB6"},     {1, "\xB7", 2, "\xC2\xB7"},
    {1, "\xB8", 2, "\xC5\x92"}, {1, "\xB9", 2, "\xC2\xB9"}, {1, "\xBA", 2, "\xC2\xBA"},     {1, "\xBB", 2, "\xC2\xBB"},
    {1, "\xBC", 2, "\xC2\xBC"}, {1, "\xBD", 2, "\xC2\xBD"}, {1, "\xBE", 2, "\xC2\xBE"},     {1, "\xBF", 2, "\xC2\xBF"},
    {1, "\xC0", 2, "\xC3\x80"}, {1, "\xC1", 2, "\xC3\x81"}, {1, "\xC2", 2, "\xC3\x82"},     {1, "\xC3", 2, "\xC4\x82"},
    ...
    {1, "\xCC", 2, "\xCC\x80"}, {1, "\xCD", 2, "\xC3\x8D"}, {1, "\xCE", 2, "\xC3\x8E"},     {1, "\xCF", 2, "\xC3\x8F"},
    {1, "\xD0", 2, "\xC4\x90"}, {1, "\xD1", 2, "\xC3\x91"}, {1, "\xD2", 2, "\xCC\x89"},     {1, "\xD3", 2, "\xC3\x93"},
    {1, "\xD4", 2, "\xC3\x94"}, {1, "\xD5", 2, "\xC6\xA0"}, {1, "\xD6", 2, "\xC3\x96"},     {1, "\xD7", 2, "\xC3\x97"},
    {1, "\xD8", 2, "\xC3\x98"}, {1, "\xD9", 2, "\xC3\x99"}, {1, "\xDA", 2, "\xC3\x9A"},     {1, "\xDB", 2, "\xC3\x9B"},
    {1, "\xDC", 2, "\xC3\x9C"}, {1, "\xDD", 2, "\xC6\xAF"}, {1, "\xDE", 2, "\xCC\x83"},     {1, "\xDF", 2, "\xC3\x9F"},
    {1, "\xE0", 2, "\xC3\xA0"}, {1, "\xE1", 2, "\xC3\xA1"}, {1, "\xE2", 2, "\xC3\xA2"},     {1, "\xE3", 2, "\xC4\x83"},
    ...
    {1, "\xEC", 2, "\xCC\x81"}, {1, "\xED", 2, "\xC3\xAD"}, {1, "\xEE", 2, "\xC3\xAE"},     {1, "\xEF", 2, "\xC3\xAF"},
    {1, "\xF0", 2, "\xC4\x91"}, {1, "\xF1", 2, "\xC3\xB1"}, {1, "\xF2", 2, "\xCC\xA3"},     {1, "\xF3", 2, "\xC3\xB3"},
    {1, "\xF4", 2, "\xC3\xB4"}, {1, "\xF5", 2, "\xC6\xA1"}, {1, "\xF6", 2, "\xC3\xB6"},     {1, "\xF7", 2, "\xC3\xB7"},
    {1, "\xF8", 2, "\xC3\xB8"}, {1, "\xF9", 2, "\xC3\xB9"}, {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},
    {1, "\xFC", 2, "\xC3\xBC"}, {1, "\xFD", 2, "\xC6\xB0"}, {1, "\xFE", 3, "\xE2\x82\xAB"}, {1, "\xFF", 2, "\xC3\xBF"},
};
void Glibc_ibm1129_2_3_3ToUtf::Register(const DBConfig &config) {
	const Glibc_ibm1129_2_3_3ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                glibc_IBM1129_2_3_3_to_utf8, generated_function.size);
