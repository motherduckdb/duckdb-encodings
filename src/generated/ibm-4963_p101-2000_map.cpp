...
// Generated from: ibm-4963_P101-2000.ucm
static const map_entry_encoding ibm_4963_P101_2000_to_utf8[] = {
    ...
    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x7F"},         {1, "\x80", 2, "\xD7\x90"},
    ...
    {1, "\x99", 2, "\xD7\xA9"},     {1, "\x9A", 2, "\xD7\xAA"},     {1, "\x9B", 2, "\xC2\xA2"},
    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xC2\xA5"},     {1, "\x9E", 2, "\xC2\x9E"},
    {1, "\x9F", 3, "\xE2\x82\xAA"}, {1, "\xA0", 3, "\xE2\x80\x8E"}, {1, "\xA1", 3, "\xE2\x80\x8F"},
    {1, "\xA2", 3, "\xE2\x80\xAA"}, {1, "\xA3", 3, "\xE2\x80\xAB"}, {1, "\xA4", 3, "\xE2\x80\xAD"},
    {1, "\xA5", 3, "\xE2\x80\xAE"}, {1, "\xA6", 3, "\xE2\x80\xAC"}, {1, "\xA9", 3, "\xE2\x8C\x90"},
    {1, "\xAA", 2, "\xC2\xAC"},     {1, "\xAB", 2, "\xC2\xBD"},     {1, "\xAC", 2, "\xC2\xBC"},
    {1, "\xAD", 3, "\xE2\x82\xAC"}, {1, "\xAE", 2, "\xC2\xAB"},     {1, "\xAF", 2, "\xC2\xBB"},
    {1, "\xB0", 3, "\xE2\x96\x91"}, {1, "\xB1", 3, "\xE2\x96\x92"}, {1, "\xB2", 3, "\xE2\x96\x93"},
    {1, "\xB3", 3, "\xEF\xBF\xA8"}, {1, "\xB4", 3, "\xE2\x94\xA4"}, {1, "\xB5", 3, "\xE2\x95\xA1"},
    {1, "\xB6", 3, "\xE2\x95\xA2"}, {1, "\xB7", 3, "\xE2\x95\x96"}, {1, "\xB8", 3, "\xE2\x95\x95"},
    {1, "\xB9", 3, "\xE2\x95\xA3"}, {1, "\xBA", 3, "\xE2\x95\x91"}, {1, "\xBB", 3, "\xE2\x95\x97"},
    {1, "\xBC", 3, "\xE2\x95\x9D"}, {1, "\xBD", 3, "\xE2\x95\x9C"}, {1, "\xBE", 3, "\xE2\x95\x9B"},
    {1, "\xBF", 3, "\xE2\x94\x90"}, {1, "\xC0", 3, "\xE2\x94\x94"}, {1, "\xC1", 3, "\xE2\x94\xB4"},
    {1, "\xC2", 3, "\xE2\x94\xAC"}, {1, "\xC3", 3, "\xE2\x94\x9C"}, {1, "\xC4", 3, "\xE2\x94\x80"},
    {1, "\xC5", 3, "\xE2\x94\xBC"}, {1, "\xC6", 3, "\xE2\x95\x9E"}, {1, "\xC7", 3, "\xE2\x95\x9F"},
    {1, "\xC8", 3, "\xE2\x95\x9A"}, {1, "\xC9", 3, "\xE2\x95\x94"}, {1, "\xCA", 3, "\xE2\x95\xA9"},
    {1, "\xCB", 3, "\xE2\x95\xA6"}, {1, "\xCC", 3, "\xE2\x95\xA0"}, {1, "\xCD", 3, "\xE2\x95\x90"},
    {1, "\xCE", 3, "\xE2\x95\xAC"}, {1, "\xCF", 3, "\xE2\x95\xA7"}, {1, "\xD0", 3, "\xE2\x95\xA8"},
    {1, "\xD1", 3, "\xE2\x95\xA4"}, {1, "\xD2", 3, "\xE2\x95\xA5"}, {1, "\xD3", 3, "\xE2\x95\x99"},
    {1, "\xD4", 3, "\xE2\x95\x98"}, {1, "\xD5", 3, "\xE2\x95\x92"}, {1, "\xD6", 3, "\xE2\x95\x93"},
    {1, "\xD7", 3, "\xE2\x95\xAB"}, {1, "\xD8", 3, "\xE2\x95\xAA"}, {1, "\xD9", 3, "\xE2\x94\x98"},
    {1, "\xDA", 3, "\xE2\x94\x8C"}, {1, "\xDB", 3, "\xE2\x96\x88"}, {1, "\xDC", 3, "\xE2\x96\x84"},
    {1, "\xDD", 3, "\xE2\x96\x8C"}, {1, "\xDE", 3, "\xE2\x96\x90"}, {1, "\xDF", 3, "\xE2\x96\x80"},
    {1, "\xE0", 2, "\xCE\xB1"},     {1, "\xE1", 2, "\xC3\x9F"},     {1, "\xE2", 2, "\xCE\x93"},
    {1, "\xE3", 2, "\xCF\x80"},     {1, "\xE4", 2, "\xCE\xA3"},     {1, "\xE5", 2, "\xCF\x83"},
    {1, "\xE6", 2, "\xCE\xBC"},     {1, "\xE7", 2, "\xCF\x84"},     {1, "\xE8", 2, "\xCE\xA6"},
    {1, "\xE9", 2, "\xCE\x98"},     {1, "\xEA", 2, "\xCE\xA9"},     {1, "\xEB", 2, "\xCE\xB4"},
    {1, "\xEC", 3, "\xE2\x88\x9E"}, {1, "\xED", 2, "\xCF\x86"},     {1, "\xEE", 2, "\xCE\xB5"},
    {1, "\xEF", 3, "\xE2\x88\xA9"}, {1, "\xF0", 3, "\xE2\x89\xA1"}, {1, "\xF1", 2, "\xC2\xB1"},
    {1, "\xF2", 3, "\xE2\x89\xA5"}, {1, "\xF3", 3, "\xE2\x89\xA4"}, {1, "\xF4", 3, "\xE2\x8C\xA0"},
    {1, "\xF5", 3, "\xE2\x8C\xA1"}, {1, "\xF6", 2, "\xC3\xB7"},     {1, "\xF7", 3, "\xE2\x89\x88"},
    {1, "\xF8", 2, "\xC2\xB0"},     {1, "\xF9", 3, "\xE2\x88\x99"}, {1, "\xFA", 2, "\xC2\xB7"},
    {1, "\xFB", 3, "\xE2\x88\x9A"}, {1, "\xFC", 3, "\xE2\x81\xBF"}, {1, "\xFD", 2, "\xC2\xB2"},
    {1, "\xFE", 3, "\xEF\xBF\xAD"}, {1, "\xFF", 2, "\xC2\xA0"},
};
void Ibm_4963_p101_2000ToUtf::Register(const DBConfig &config) {
	const Ibm_4963_p101_2000ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_4963_P101_2000_to_utf8, generated_function.size);
