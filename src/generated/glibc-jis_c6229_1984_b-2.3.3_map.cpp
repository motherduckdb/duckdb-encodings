...
static const map_entry_encoding glibc_JIS_C6229_1984_B_2_3_3_to_utf8[] = {
    ...
    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},         {1, "\x5A", 1, "\x5A"}, {1, "\x5B", 3, "\xE2\x8C\xA9"},
    {1, "\x5C", 2, "\xC2\xA5"}, {1, "\x5D", 3, "\xE2\x8C\xAA"}, {1, "\x5E", 1, "\x5E"}, {1, "\x5F", 1, "\x5F"},
    {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},         {1, "\x63", 1, "\x63"}, {1, "\x64", 1, "\x64"},
    {1, "\x65", 1, "\x65"},     {1, "\x66", 1, "\x66"},         {1, "\x67", 1, "\x67"}, {1, "\x68", 1, "\x68"},
    {1, "\x69", 1, "\x69"},     {1, "\x6A", 1, "\x6A"},         {1, "\x6B", 1, "\x6B"}, {1, "\x6C", 1, "\x6C"},
    {1, "\x6D", 1, "\x6D"},     {1, "\x6E", 1, "\x6E"},         {1, "\x6F", 1, "\x6F"}, {1, "\x70", 1, "\x70"},
    {1, "\x71", 1, "\x71"},     {1, "\x72", 1, "\x72"},         {1, "\x73", 1, "\x73"}, {1, "\x74", 1, "\x74"},
    {1, "\x75", 1, "\x75"},     {1, "\x76", 1, "\x76"},         {1, "\x77", 1, "\x77"}, {1, "\x78", 1, "\x78"},
    {1, "\x79", 1, "\x79"},     {1, "\x7A", 1, "\x7A"},         {1, "\x7B", 1, "\x7B"}, {1, "\x7C", 1, "\x7C"},
    {1, "\x7D", 1, "\x7D"},     {1, "\x7F", 1, "\x7F"},
};
void Glibc_jis_c6229_1984_b_2_3_3ToUtf::Register(const DBConfig &config) {
	const Glibc_jis_c6229_1984_b_2_3_3ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                glibc_JIS_C6229_1984_B_2_3_3_to_utf8, generated_function.size);
