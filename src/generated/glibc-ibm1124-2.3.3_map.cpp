...
static const map_entry_encoding glibc_IBM1124_2_3_3_to_utf8[] = {
    ...
    {1, "\xA0", 2, "\xC2\xA0"},     {1, "\xA1", 2, "\xD0\x81"}, {1, "\xA2", 2, "\xD0\x82"}, {1, "\xA3", 2, "\xD2\x90"},
    ...
    {1, "\xF0", 3, "\xE2\x84\x96"}, {1, "\xF1", 2, "\xD1\x91"}, {1, "\xF2", 2, "\xD1\x92"}, {1, "\xF3", 2, "\xD2\x91"},
...
void Glibc_ibm1124_2_3_3ToUtf::Register(const DBConfig &config) {
	const Glibc_ibm1124_2_3_3ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                glibc_IBM1124_2_3_3_to_utf8, generated_function.size);
