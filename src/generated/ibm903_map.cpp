...
// Generated from: glibc-IBM903-2.1.2.ucm
static const map_entry_encoding IBM903_to_utf8[] = {
...
void Ibm903ToUtf::Register(const DBConfig &config) {
	const Ibm903ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                IBM903_to_utf8, generated_function.size);
