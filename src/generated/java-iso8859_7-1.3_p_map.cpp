...
// Generated from: java-ISO8859_7-1.3_P.ucm
static const map_entry_encoding java_ISO8859_7_1_3_P_to_utf8[] = {
    ...
    {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA1", 2, "\xCA\xBD"}, {1, "\xA2", 2, "\xCA\xBC"}, {1, "\xA3", 2, "\xC2\xA3"},
    {1, "\xA6", 2, "\xC2\xA6"}, {1, "\xA7", 2, "\xC2\xA7"}, {1, "\xA8", 2, "\xC2\xA8"}, {1, "\xA9", 2, "\xC2\xA9"},
    {1, "\xAB", 2, "\xC2\xAB"}, {1, "\xAC", 2, "\xC2\xAC"}, {1, "\xAD", 2, "\xC2\xAD"}, {1, "\xAF", 3, "\xE2\x80\x95"},
    {1, "\xB0", 2, "\xC2\xB0"}, {1, "\xB1", 2, "\xC2\xB1"}, {1, "\xB2", 2, "\xC2\xB2"}, {1, "\xB3", 2, "\xC2\xB3"},
    {1, "\xB4", 2, "\xCE\x84"}, {1, "\xB5", 2, "\xCE\x85"}, {1, "\xB6", 2, "\xCE\x86"}, {1, "\xB7", 2, "\xC2\xB7"},
    {1, "\xB8", 2, "\xCE\x88"}, {1, "\xB9", 2, "\xCE\x89"}, {1, "\xBA", 2, "\xCE\x8A"}, {1, "\xBB", 2, "\xC2\xBB"},
    {1, "\xBC", 2, "\xCE\x8C"}, {1, "\xBD", 2, "\xC2\xBD"}, {1, "\xBE", 2, "\xCE\x8E"}, {1, "\xBF", 2, "\xCE\x8F"},
    {1, "\xC0", 2, "\xCE\x90"}, {1, "\xC1", 2, "\xCE\x91"}, {1, "\xC2", 2, "\xCE\x92"}, {1, "\xC3", 2, "\xCE\x93"},
    {1, "\xC4", 2, "\xCE\x94"}, {1, "\xC5", 2, "\xCE\x95"}, {1, "\xC6", 2, "\xCE\x96"}, {1, "\xC7", 2, "\xCE\x97"},
    {1, "\xC8", 2, "\xCE\x98"}, {1, "\xC9", 2, "\xCE\x99"}, {1, "\xCA", 2, "\xCE\x9A"}, {1, "\xCB", 2, "\xCE\x9B"},
    {1, "\xCC", 2, "\xCE\x9C"}, {1, "\xCD", 2, "\xCE\x9D"}, {1, "\xCE", 2, "\xCE\x9E"}, {1, "\xCF", 2, "\xCE\x9F"},
    {1, "\xD0", 2, "\xCE\xA0"}, {1, "\xD1", 2, "\xCE\xA1"}, {1, "\xD3", 2, "\xCE\xA3"}, {1, "\xD4", 2, "\xCE\xA4"},
    {1, "\xD5", 2, "\xCE\xA5"}, {1, "\xD6", 2, "\xCE\xA6"}, {1, "\xD7", 2, "\xCE\xA7"}, {1, "\xD8", 2, "\xCE\xA8"},
    {1, "\xD9", 2, "\xCE\xA9"}, {1, "\xDA", 2, "\xCE\xAA"}, {1, "\xDB", 2, "\xCE\xAB"}, {1, "\xDC", 2, "\xCE\xAC"},
    {1, "\xDD", 2, "\xCE\xAD"}, {1, "\xDE", 2, "\xCE\xAE"}, {1, "\xDF", 2, "\xCE\xAF"}, {1, "\xE0", 2, "\xCE\xB0"},
    {1, "\xE1", 2, "\xCE\xB1"}, {1, "\xE2", 2, "\xCE\xB2"}, {1, "\xE3", 2, "\xCE\xB3"}, {1, "\xE4", 2, "\xCE\xB4"},
    {1, "\xE5", 2, "\xCE\xB5"}, {1, "\xE6", 2, "\xCE\xB6"}, {1, "\xE7", 2, "\xCE\xB7"}, {1, "\xE8", 2, "\xCE\xB8"},
    {1, "\xE9", 2, "\xCE\xB9"}, {1, "\xEA", 2, "\xCE\xBA"}, {1, "\xEB", 2, "\xCE\xBB"}, {1, "\xEC", 2, "\xCE\xBC"},
    {1, "\xED", 2, "\xCE\xBD"}, {1, "\xEE", 2, "\xCE\xBE"}, {1, "\xEF", 2, "\xCE\xBF"}, {1, "\xF0", 2, "\xCF\x80"},
    {1, "\xF1", 2, "\xCF\x81"}, {1, "\xF2", 2, "\xCF\x82"}, {1, "\xF3", 2, "\xCF\x83"}, {1, "\xF4", 2, "\xCF\x84"},
    {1, "\xF5", 2, "\xCF\x85"}, {1, "\xF6", 2, "\xCF\x86"}, {1, "\xF7", 2, "\xCF\x87"}, {1, "\xF8", 2, "\xCF\x88"},
    {1, "\xF9", 2, "\xCF\x89"}, {1, "\xFA", 2, "\xCF\x8A"}, {1, "\xFB", 2, "\xCF\x8B"}, {1, "\xFC", 2, "\xCF\x8C"},
    {1, "\xFD", 2, "\xCF\x8D"}, {1, "\xFE", 2, "\xCF\x8E"},
};
void Java_iso8859_7_1_3_pToUtf::Register(const DBConfig &config) {
	const Java_iso8859_7_1_3_pToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                java_ISO8859_7_1_3_P_to_utf8, generated_function.size);
