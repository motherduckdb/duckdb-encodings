...
static const map_entry_encoding java_Cp863_1_3_P_to_utf8[] = {
...
void Java_cp863_1_3_pToUtf::Register(const DBConfig &config) {
	const Java_cp863_1_3_pToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                java_Cp863_1_3_P_to_utf8, generated_function.size);
