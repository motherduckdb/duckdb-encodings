...
static const map_entry_encoding ISO_8859_10_to_utf8[] = {
    ...
    {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA1", 2, "\xC4\x84"},     {1, "\xA2", 2, "\xC4\x92"}, {1, "\xA3", 2, "\xC4\xA2"},
    {1, "\xA4", 2, "\xC4\xAA"}, {1, "\xA5", 2, "\xC4\xA8"},     {1, "\xA6", 2, "\xC4\xB6"}, {1, "\xA7", 2, "\xC2\xA7"},
    {1, "\xA8", 2, "\xC4\xBB"}, {1, "\xA9", 2, "\xC4\x90"},     {1, "\xAA", 2, "\xC5\xA0"}, {1, "\xAB", 2, "\xC5\xA6"},
    {1, "\xAC", 2, "\xC5\xBD"}, {1, "\xAD", 2, "\xC2\xAD"},     {1, "\xAE", 2, "\xC5\xAA"}, {1, "\xAF", 2, "\xC5\x8A"},
    {1, "\xB0", 2, "\xC2\xB0"}, {1, "\xB1", 2, "\xC4\x85"},     {1, "\xB2", 2, "\xC4\x93"}, {1, "\xB3", 2, "\xC4\xA3"},
    {1, "\xB4", 2, "\xC4\xAB"}, {1, "\xB5", 2, "\xC4\xA9"},     {1, "\xB6", 2, "\xC4\xB7"}, {1, "\xB7", 2, "\xC2\xB7"},
    {1, "\xB8", 2, "\xC4\xBC"}, {1, "\xB9", 2, "\xC4\x91"},     {1, "\xBA", 2, "\xC5\xA1"}, {1, "\xBB", 2, "\xC5\xA7"},
    {1, "\xBC", 2, "\xC5\xBE"}, {1, "\xBD", 3, "\xE2\x80\x95"}, {1, "\xBE", 2, "\xC5\xAB"}, {1, "\xBF", 2, "\xC5\x8B"},
    ...
    {1, "\xCC", 2, "\xC4\x96"}, {1, "\xCD", 2, "\xC3\x8D"},     {1, "\xCE", 2, "\xC3\x8E"}, {1, "\xCF", 2, "\xC3\x8F"},
    {1, "\xD0", 2, "\xC3\x90"}, {1, "\xD1", 2, "\xC5\x85"},     {1, "\xD2", 2, "\xC5\x8C"}, {1, "\xD3", 2, "\xC3\x93"},
    {1, "\xD4", 2, "\xC3\x94"}, {1, "\xD5", 2, "\xC3\x95"},     {1, "\xD6", 2, "\xC3\x96"}, {1, "\xD7", 2, "\xC5\xA8"},
    {1, "\xD8", 2, "\xC3\x98"}, {1, "\xD9", 2, "\xC5\xB2"},     {1, "\xDA", 2, "\xC3\x9A"}, {1, "\xDB", 2, "\xC3\x9B"},
    {1, "\xDC", 2, "\xC3\x9C"}, {1, "\xDD", 2, "\xC3\x9D"},     {1, "\xDE", 2, "\xC3\x9E"}, {1, "\xDF", 2, "\xC3\x9F"},
    ...
    {1, "\xEC", 2, "\xC4\x97"}, {1, "\xED", 2, "\xC3\xAD"},     {1, "\xEE", 2, "\xC3\xAE"}, {1, "\xEF", 2, "\xC3\xAF"},
    {1, "\xF0", 2, "\xC3\xB0"}, {1, "\xF1", 2, "\xC5\x86"},     {1, "\xF2", 2, "\xC5\x8D"}, {1, "\xF3", 2, "\xC3\xB3"},
    {1, "\xF4", 2, "\xC3\xB4"}, {1, "\xF5", 2, "\xC3\xB5"},     {1, "\xF6", 2, "\xC3\xB6"}, {1, "\xF7", 2, "\xC5\xA9"},
    {1, "\xF8", 2, "\xC3\xB8"}, {1, "\xF9", 2, "\xC5\xB3"},     {1, "\xFA", 2, "\xC3\xBA"}, {1, "\xFB", 2, "\xC3\xBB"},
    {1, "\xFC", 2, "\xC3\xBC"}, {1, "\xFD", 2, "\xC3\xBD"},     {1, "\xFE", 2, "\xC3\xBE"}, {1, "\xFF", 2, "\xC4\xB8"},
};
void Iso_8859_10ToUtf::Register(const DBConfig &config) {
	const Iso_8859_10ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ISO_8859_10_to_utf8, generated_function.size);
