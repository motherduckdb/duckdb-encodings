...
// Generated from: ibm-9306_P101-2000.ucm
static const map_entry_encoding ibm_9306_P101_2000_to_utf8[] = {
    ...
    {1, "\x24", 3, "\xEF\xBC\x84"}, {1, "\x26", 3, "\xEF\xBC\x86"}, {1, "\x27", 3, "\xEF\xBC\x87"},
    {1, "\x28", 3, "\xEF\xBC\x88"}, {1, "\x29", 3, "\xEF\xBC\x89"}, {1, "\x2B", 3, "\xEF\xBC\x8B"},
    {1, "\x2C", 3, "\xEF\xBC\x8C"}, {1, "\x2D", 3, "\xEF\xBC\x8D"}, {1, "\x2E", 3, "\xEF\xBC\x8E"},
    {1, "\x2F", 3, "\xEF\xBC\x8F"}, {1, "\x30", 3, "\xEF\xBC\x90"}, {1, "\x31", 3, "\xEF\xBC\x91"},
    {1, "\x32", 3, "\xEF\xBC\x92"}, {1, "\x33", 3, "\xEF\xBC\x93"}, {1, "\x34", 3, "\xEF\xBC\x94"},
    {1, "\x35", 3, "\xEF\xBC\x95"}, {1, "\x36", 3, "\xEF\xBC\x96"}, {1, "\x37", 3, "\xEF\xBC\x97"},
    {1, "\x38", 3, "\xEF\xBC\x98"}, {1, "\x39", 3, "\xEF\xBC\x99"}, {1, "\x3A", 3, "\xEF\xBC\x9A"},
    {1, "\x3B", 3, "\xEF\xBC\x9B"}, {1, "\x3C", 3, "\xEF\xBC\x9C"}, {1, "\x3D", 3, "\xEF\xBC\x9D"},
    {1, "\x3E", 3, "\xEF\xBC\x9E"}, {1, "\x3F", 3, "\xEF\xBC\x9F"}, {1, "\x40", 3, "\xEF\xBC\xA0"},
    {1, "\x41", 3, "\xEF\xBC\xA1"}, {1, "\x42", 3, "\xEF\xBC\xA2"}, {1, "\x43", 3, "\xEF\xBC\xA3"},
    {1, "\x44", 3, "\xEF\xBC\xA4"}, {1, "\x45", 3, "\xEF\xBC\xA5"}, {1, "\x46", 3, "\xEF\xBC\xA6"},
    {1, "\x47", 3, "\xEF\xBC\xA7"}, {1, "\x48", 3, "\xEF\xBC\xA8"}, {1, "\x49", 3, "\xEF\xBC\xA9"},
    {1, "\x4A", 3, "\xEF\xBC\xAA"}, {1, "\x4B", 3, "\xEF\xBC\xAB"}, {1, "\x4C", 3, "\xEF\xBC\xAC"},
    {1, "\x4D", 3, "\xEF\xBC\xAD"}, {1, "\x4E", 3, "\xEF\xBC\xAE"}, {1, "\x4F", 3, "\xEF\xBC\xAF"},
    {1, "\x50", 3, "\xEF\xBC\xB0"}, {1, "\x51", 3, "\xEF\xBC\xB1"}, {1, "\x52", 3, "\xEF\xBC\xB2"},
    {1, "\x53", 3, "\xEF\xBC\xB3"}, {1, "\x54", 3, "\xEF\xBC\xB4"}, {1, "\x55", 3, "\xEF\xBC\xB5"},
    {1, "\x56", 3, "\xEF\xBC\xB6"}, {1, "\x57", 3, "\xEF\xBC\xB7"}, {1, "\x58", 3, "\xEF\xBC\xB8"},
    {1, "\x59", 3, "\xEF\xBC\xB9"}, {1, "\x5A", 3, "\xEF\xBC\xBA"}, {1, "\x5B", 3, "\xEF\xBC\xBB"},
    {1, "\x5C", 3, "\xEF\xBC\xBC"}, {1, "\x5D", 3, "\xEF\xBC\xBD"}, {1, "\x5F", 3, "\xEF\xBC\xBF"},
...
void Ibm_9306_p101_2000ToUtf::Register(const DBConfig &config) {
	const Ibm_9306_p101_2000ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_9306_P101_2000_to_utf8, generated_function.size);
