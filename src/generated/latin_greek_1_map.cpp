...
// Generated from: glibc-LATIN_GREEK_1-2.1.2.ucm
static const map_entry_encoding LATIN_GREEK_1_to_utf8[] = {
    ...
    {1, "\x20", 1, "\x20"},     {1, "\x21", 2, "\xCE\x9E"}, {1, "\x22", 1, "\x22"},         {1, "\x23", 2, "\xCE\x93"},
    ...
    {1, "\x38", 1, "\x38"},     {1, "\x39", 1, "\x39"},     {1, "\x3A", 2, "\xCE\xA8"},     {1, "\x3B", 1, "\x3B"},
    {1, "\x3C", 1, "\x3C"},     {1, "\x3D", 1, "\x3D"},     {1, "\x3E", 1, "\x3E"},         {1, "\x3F", 2, "\xCE\xA0"},
    {1, "\x40", 2, "\xCE\x94"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"},         {1, "\x43", 1, "\x43"},
    ...
    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},     {1, "\x5A", 1, "\x5A"},         {1, "\x5B", 2, "\xCE\xA9"},
    {1, "\x5C", 2, "\xCE\x98"}, {1, "\x5D", 2, "\xCE\xA6"}, {1, "\x5E", 2, "\xCE\x9B"},     {1, "\x5F", 2, "\xCE\xA3"},
...
void Latin_greek_1ToUtf::Register(const DBConfig &config) {
	const Latin_greek_1ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                LATIN_GREEK_1_to_utf8, generated_function.size);
