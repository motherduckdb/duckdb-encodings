...
// Generated from: windows-20108-2000.ucm
static const map_entry_encoding windows_20108_2000_to_utf8[] = {
    ...
    {1, "\x21", 3, "\xEF\xBC\x81"}, {1, "\x22", 3, "\xEF\xBC\x82"}, {1, "\x23", 2, "\xC2\xA7"},
    ...
    {1, "\x7E", 2, "\xC2\xA6"},     {1, "\x7F", 1, "\x7F"},
};
void Windows_20108_2000ToUtf::Register(const DBConfig &config) {
	const Windows_20108_2000ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                windows_20108_2000_to_utf8, generated_function.size);
