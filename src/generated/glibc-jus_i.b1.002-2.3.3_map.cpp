...
// Generated from: glibc-JUS_I.B1.002-2.3.3.ucm
static const map_entry_encoding glibc_JUS_I_B1_002_2_3_3_to_utf8[] = {
    ...
    {1, "\x40", 2, "\xC5\xBD"}, {1, "\x41", 1, "\x41"},     {1, "\x42", 1, "\x42"},     {1, "\x43", 1, "\x43"},
    ...
    {1, "\x58", 1, "\x58"},     {1, "\x59", 1, "\x59"},     {1, "\x5A", 1, "\x5A"},     {1, "\x5B", 2, "\xC5\xA0"},
    {1, "\x5C", 2, "\xC4\x90"}, {1, "\x5D", 2, "\xC4\x86"}, {1, "\x5E", 2, "\xC4\x8C"}, {1, "\x5F", 1, "\x5F"},
    {1, "\x60", 2, "\xC5\xBE"}, {1, "\x61", 1, "\x61"},     {1, "\x62", 1, "\x62"},     {1, "\x63", 1, "\x63"},
    ...
    {1, "\x78", 1, "\x78"},     {1, "\x79", 1, "\x79"},     {1, "\x7A", 1, "\x7A"},     {1, "\x7B", 2, "\xC5\xA1"},
    {1, "\x7C", 2, "\xC4\x91"}, {1, "\x7D", 2, "\xC4\x87"}, {1, "\x7E", 2, "\xC4\x8D"}, {1, "\x7F", 1, "\x7F"},
};
void Glibc_jus_i_b1_002_2_3_3ToUtf::Register(const DBConfig &config) {
	const Glibc_jus_i_b1_002_2_3_3ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                glibc_JUS_I_B1_002_2_3_3_to_utf8, generated_function.size);
