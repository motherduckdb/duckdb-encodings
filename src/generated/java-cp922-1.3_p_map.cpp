...
// Generated from: java-Cp922-1.3_P.ucm
static const map_entry_encoding java_Cp922_1_3_P_to_utf8[] = {
    ...
    {1, "\xAC", 2, "\xC2\xAC"}, {1, "\xAD", 2, "\xC2\xAD"}, {1, "\xAE", 2, "\xC2\xAE"}, {1, "\xAF", 3, "\xE2\x80\xBE"},
    ...
    {1, "\xD0", 2, "\xC5\xA0"}, {1, "\xD1", 2, "\xC3\x91"}, {1, "\xD2", 2, "\xC3\x92"}, {1, "\xD3", 2, "\xC3\x93"},
    ...
    {1, "\xDC", 2, "\xC3\x9C"}, {1, "\xDD", 2, "\xC3\x9D"}, {1, "\xDE", 2, "\xC5\xBD"}, {1, "\xDF", 2, "\xC3\x9F"},
    ...
    {1, "\xF0", 2, "\xC5\xA1"}, {1, "\xF1", 2, "\xC3\xB1"}, {1, "\xF2", 2, "\xC3\xB2"}, {1, "\xF3", 2, "\xC3\xB3"},
    ...
    {1, "\xFC", 2, "\xC3\xBC"}, {1, "\xFD", 2, "\xC3\xBD"}, {1, "\xFE", 2, "\xC5\xBE"}, {1, "\xFF", 2, "\xC3\xBF"},
};
void Java_cp922_1_3_pToUtf::Register(const DBConfig &config) {
	const Java_cp922_1_3_pToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                java_Cp922_1_3_P_to_utf8, generated_function.size);
