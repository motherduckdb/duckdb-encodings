...
// Generated from: glibc-BALTIC-2.1.2.ucm
static const map_entry_encoding BALTIC_to_utf8[] = {
    ...
    {1, "\xA8", 2, "\xC3\x98"},     {1, "\xA9", 2, "\xC2\xA9"}, {1, "\xAA", 3, "\xE2\x80\x9E"},
    ...
    {1, "\xBA", 3, "\xE2\x80\x9C"}, {1, "\xBB", 2, "\xC2\xBB"}, {1, "\xBC", 2, "\xC2\xBC"},
    {1, "\xBD", 2, "\xC2\xBD"},     {1, "\xBE", 2, "\xC2\xBE"}, {1, "\xBF", 2, "\xC3\xA6"},
    {1, "\xC0", 2, "\xC4\xAE"},     {1, "\xC1", 2, "\xC4\x96"}, {1, "\xC2", 2, "\xC4\x80"},
    {1, "\xC3", 2, "\xC4\x86"},     {1, "\xC4", 2, "\xC3\x84"}, {1, "\xC5", 2, "\xC3\x85"},
    {1, "\xC6", 2, "\xC4\x84"},     {1, "\xC7", 2, "\xC4\x8C"}, {1, "\xC8", 2, "\xC4\xA2"},
    {1, "\xC9", 2, "\xC3\x89"},     {1, "\xCA", 2, "\xC5\xBD"}, {1, "\xCB", 2, "\xC4\x98"},
    {1, "\xCC", 2, "\xC4\x92"},     {1, "\xCD", 2, "\xC4\xB6"}, {1, "\xCE", 2, "\xC4\xAA"},
    {1, "\xCF", 2, "\xC4\xBB"},     {1, "\xD0", 2, "\xC5\x81"}, {1, "\xD1", 2, "\xC5\x85"},
    {1, "\xD2", 2, "\xC5\x83"},     {1, "\xD3", 2, "\xC3\x93"}, {1, "\xD4", 2, "\xC5\x8C"},
    {1, "\xD5", 2, "\xC3\x95"},     {1, "\xD6", 2, "\xC3\x96"}, {1, "\xD7", 2, "\xC3\x97"},
    {1, "\xD8", 2, "\xC5\xB2"},     {1, "\xD9", 2, "\xC5\xA0"}, {1, "\xDA", 2, "\xC5\x9A"},
    {1, "\xDB", 2, "\xC5\xAA"},     {1, "\xDC", 2, "\xC3\x9C"}, {1, "\xDD", 2, "\xC5\xBB"},
    {1, "\xDE", 2, "\xC5\xB9"},     {1, "\xDF", 2, "\xC3\x9F"}, {1, "\xE0", 2, "\xC4\xAF"},
    {1, "\xE1", 2, "\xC4\x97"},     {1, "\xE2", 2, "\xC4\x81"}, {1, "\xE3", 2, "\xC4\x87"},
    {1, "\xE4", 2, "\xC3\xA4"},     {1, "\xE5", 2, "\xC3\xA5"}, {1, "\xE6", 2, "\xC4\x85"},
    {1, "\xE7", 2, "\xC4\x8D"},     {1, "\xE8", 2, "\xC4\xA3"}, {1, "\xE9", 2, "\xC3\xA9"},
    {1, "\xEA", 2, "\xC5\xBE"},     {1, "\xEB", 2, "\xC4\x99"}, {1, "\xEC", 2, "\xC4\x93"},
    {1, "\xED", 2, "\xC4\xB7"},     {1, "\xEE", 2, "\xC4\xAB"}, {1, "\xEF", 2, "\xC4\xBC"},
    {1, "\xF0", 2, "\xC5\x82"},     {1, "\xF1", 2, "\xC5\x86"}, {1, "\xF2", 2, "\xC5\x84"},
    {1, "\xF3", 2, "\xC3\xB3"},     {1, "\xF4", 2, "\xC5\x8D"}, {1, "\xF5", 2, "\xC3\xB5"},
    {1, "\xF6", 2, "\xC3\xB6"},     {1, "\xF7", 2, "\xC3\xB7"}, {1, "\xF8", 2, "\xC5\xB3"},
    {1, "\xF9", 2, "\xC5\xA1"},     {1, "\xFA", 2, "\xC5\x9B"}, {1, "\xFB", 2, "\xC5\xAB"},
    {1, "\xFC", 2, "\xC3\xBC"},     {1, "\xFD", 2, "\xC5\xBC"}, {1, "\xFE", 2, "\xC5\xBA"},
    {1, "\xFF", 2, "\xC4\xB8"},
};
void BalticToUtf::Register(const DBConfig &config) {
	const BalticToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                BALTIC_to_utf8, generated_function.size);
