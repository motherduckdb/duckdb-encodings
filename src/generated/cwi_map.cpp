...
// Generated from: glibc-CWI-2.1.2.ucm
static const map_entry_encoding CWI_to_utf8[] = {
    ...
    {1, "\x8D", 2, "\xC3\x8D"},     {1, "\x8E", 2, "\xC3\x84"},     {1, "\x8F", 2, "\xC3\x81"},
    {1, "\x90", 2, "\xC3\x89"},     {1, "\x91", 2, "\xC3\xA6"},     {1, "\x92", 2, "\xC3\x86"},
    {1, "\x93", 2, "\xC5\x91"},     {1, "\x94", 2, "\xC3\xB6"},     {1, "\x95", 2, "\xC3\x93"},
    {1, "\x96", 2, "\xC5\xB1"},     {1, "\x97", 2, "\xC3\x9A"},     {1, "\x98", 2, "\xC5\xB0"},
    {1, "\x99", 2, "\xC3\x96"},     {1, "\x9A", 2, "\xC3\x9C"},     {1, "\x9B", 2, "\xC2\xA2"},
    {1, "\x9C", 2, "\xC2\xA3"},     {1, "\x9D", 2, "\xC2\xA5"},     {1, "\x9E", 3, "\xE2\x82\xA7"},
    {1, "\x9F", 3, "\xEE\x80\x9F"}, {1, "\xA0", 2, "\xC3\xA1"},     {1, "\xA1", 2, "\xC3\xAD"},
    {1, "\xA2", 2, "\xC3\xB3"},     {1, "\xA3", 2, "\xC3\xBA"},     {1, "\xA4", 2, "\xC3\xB1"},
    {1, "\xA5", 2, "\xC3\x91"},     {1, "\xA6", 2, "\xC2\xAA"},     {1, "\xA7", 2, "\xC5\x90"},
    ...
    {1, "\xF9", 2, "\xC2\xB7"},     {1, "\xFA", 3, "\xE2\x80\xA2"}, {1, "\xFB", 3, "\xE2\x88\x9A"},
    {1, "\xFC", 3, "\xE2\x81\xBF"}, {1, "\xFD", 2, "\xC2\xB2"},     {1, "\xFE", 3, "\xE2\x96\xA0"},
    {1, "\xFF", 2, "\xC2\xA0"},
};
void CwiToUtf::Register(const DBConfig &config) {
	const CwiToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes, CWI_to_utf8,
