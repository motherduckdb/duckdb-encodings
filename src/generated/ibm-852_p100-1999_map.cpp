...
// Generated from: ibm-852_P100-1999.ucm
static const map_entry_encoding ibm_852_P100_1999_to_utf8[] = {
    ...
    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 3, "\xE2\x8C\x82"}, {1, "\x80", 2, "\xC3\x87"},
    ...
    {1, "\xA8", 2, "\xC4\x98"},     {1, "\xA9", 2, "\xC4\x99"},     {1, "\xAB", 2, "\xC5\xBA"},
    {1, "\xAC", 2, "\xC4\x8C"},     {1, "\xAD", 2, "\xC5\x9F"},     {1, "\xAE", 2, "\xC2\xAB"},
    {1, "\xAF", 2, "\xC2\xBB"},     {1, "\xB0", 3, "\xE2\x96\x91"}, {1, "\xB1", 3, "\xE2\x96\x92"},
    {1, "\xB2", 3, "\xE2\x96\x93"}, {1, "\xB3", 3, "\xEF\xBF\xA8"}, {1, "\xB4", 3, "\xE2\x94\xA4"},
    {1, "\xB5", 2, "\xC3\x81"},     {1, "\xB6", 2, "\xC3\x82"},     {1, "\xB7", 2, "\xC4\x9A"},
    {1, "\xB8", 2, "\xC5\x9E"},     {1, "\xB9", 3, "\xE2\x95\xA3"}, {1, "\xBA", 3, "\xE2\x95\x91"},
    {1, "\xBB", 3, "\xE2\x95\x97"}, {1, "\xBC", 3, "\xE2\x95\x9D"}, {1, "\xBD", 2, "\xC5\xBB"},
    {1, "\xBE", 2, "\xC5\xBC"},     {1, "\xBF", 3, "\xE2\x94\x90"}, {1, "\xC0", 3, "\xE2\x94\x94"},
    {1, "\xC1", 3, "\xE2\x94\xB4"}, {1, "\xC2", 3, "\xE2\x94\xAC"}, {1, "\xC3", 3, "\xE2\x94\x9C"},
    {1, "\xC4", 3, "\xE2\x94\x80"}, {1, "\xC5", 3, "\xE2\x94\xBC"}, {1, "\xC6", 2, "\xC4\x82"},
    {1, "\xC7", 2, "\xC4\x83"},     {1, "\xC8", 3, "\xE2\x95\x9A"}, {1, "\xC9", 3, "\xE2\x95\x94"},
    {1, "\xCA", 3, "\xE2\x95\xA9"}, {1, "\xCB", 3, "\xE2\x95\xA6"}, {1, "\xCC", 3, "\xE2\x95\xA0"},
    {1, "\xCD", 3, "\xE2\x95\x90"}, {1, "\xCE", 3, "\xE2\x95\xAC"}, {1, "\xCF", 2, "\xC2\xA4"},
    {1, "\xD0", 2, "\xC4\x91"},     {1, "\xD1", 2, "\xC4\x90"},     {1, "\xD2", 2, "\xC4\x8E"},
    {1, "\xD3", 2, "\xC3\x8B"},     {1, "\xD4", 2, "\xC4\x8F"},     {1, "\xD5", 2, "\xC5\x87"},
    {1, "\xD6", 2, "\xC3\x8D"},     {1, "\xD7", 2, "\xC3\x8E"},     {1, "\xD8", 2, "\xC4\x9B"},
    {1, "\xD9", 3, "\xE2\x94\x98"}, {1, "\xDA", 3, "\xE2\x94\x8C"}, {1, "\xDB", 3, "\xE2\x96\x88"},
    {1, "\xDC", 3, "\xE2\x96\x84"}, {1, "\xDD", 2, "\xC5\xA2"},     {1, "\xDE", 2, "\xC5\xAE"},
    {1, "\xDF", 3, "\xE2\x96\x80"}, {1, "\xE0", 2, "\xC3\x93"},     {1, "\xE1", 2, "\xC3\x9F"},
    {1, "\xE2", 2, "\xC3\x94"},     {1, "\xE3", 2, "\xC5\x83"},     {1, "\xE4", 2, "\xC5\x84"},
    {1, "\xE5", 2, "\xC5\x88"},     {1, "\xE6", 2, "\xC5\xA0"},     {1, "\xE7", 2, "\xC5\xA1"},
    {1, "\xE8", 2, "\xC5\x94"},     {1, "\xE9", 2, "\xC3\x9A"},     {1, "\xEA", 2, "\xC5\x95"},
    {1, "\xEB", 2, "\xC5\xB0"},     {1, "\xEC", 2, "\xC3\xBD"},     {1, "\xED", 2, "\xC3\x9D"},
    {1, "\xEE", 2, "\xC5\xA3"},     {1, "\xEF", 2, "\xC2\xB4"},     {1, "\xF0", 2, "\xC2\xAD"},
    {1, "\xF1", 2, "\xCB\x9D"},     {1, "\xF2", 2, "\xCB\x9B"},     {1, "\xF3", 2, "\xCB\x87"},
    {1, "\xF4", 2, "\xCB\x98"},     {1, "\xF5", 2, "\xC2\xA7"},     {1, "\xF6", 2, "\xC3\xB7"},
    {1, "\xF7", 2, "\xC2\xB8"},     {1, "\xF8", 2, "\xC2\xB0"},     {1, "\xF9", 2, "\xC2\xA8"},
    {1, "\xFA", 2, "\xCB\x99"},     {1, "\xFB", 2, "\xC5\xB1"},     {1, "\xFC", 2, "\xC5\x98"},
    {1, "\xFD", 2, "\xC5\x99"},     {1, "\xFE", 3, "\xEF\xBF\xAD"}, {1, "\xFF", 2, "\xC2\xA0"},
};
void Ibm_852_p100_1999ToUtf::Register(const DBConfig &config) {
	const Ibm_852_p100_1999ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_852_P100_1999_to_utf8, generated_function.size);
