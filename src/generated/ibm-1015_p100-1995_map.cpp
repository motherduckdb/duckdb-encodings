...
// Generated from: ibm-1015_P100-1995.ucm
static const map_entry_encoding ibm_1015_P100_1995_to_utf8[] = {
    ...
    {1, "\x3F", 3, "\xEF\xBC\x9F"}, {1, "\x40", 2, "\xC2\xB4"},     {1, "\x41", 3, "\xEF\xBC\xA1"},
    ...
    {1, "\x5A", 3, "\xEF\xBC\xBA"}, {1, "\x5B", 2, "\xC3\x83"},     {1, "\x5C", 2, "\xC3\x87"},
    {1, "\x5D", 2, "\xC3\x95"},     {1, "\x5E", 3, "\xEF\xBC\xBE"}, {1, "\x5F", 3, "\xEF\xBC\xBF"},
    ...
    {1, "\x7B", 2, "\xC3\xA3"},     {1, "\x7C", 2, "\xC3\xA7"},     {1, "\x7D", 2, "\xC3\xB5"},
    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x7F"},
};
void Ibm_1015_p100_1995ToUtf::Register(const DBConfig &config) {
	const Ibm_1015_p100_1995ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1015_P100_1995_to_utf8, generated_function.size);
