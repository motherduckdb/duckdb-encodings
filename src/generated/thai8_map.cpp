...
// Generated from: hpux-thai8-11.0.ucm
static const map_entry_encoding thai8_to_utf8[] = {
    ...
    {1, "\x9F", 2, "\xC2\x9F"},     {1, "\xA0", 3, "\xE0\xB8\x80"}, {1, "\xA1", 3, "\xE0\xB8\x81"},
...
void Thai8ToUtf::Register(const DBConfig &config) {
	const Thai8ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                thai8_to_utf8, generated_function.size);
