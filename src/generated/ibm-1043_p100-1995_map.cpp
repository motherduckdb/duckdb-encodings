...
// Generated from: ibm-1043_P100-1995.ucm
static const map_entry_encoding ibm_1043_P100_1995_to_utf8[] = {
    ...
    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x1A"},         {1, "\x80", 2, "\xC2\xA2"},
    {1, "\xFD", 2, "\xC2\xAC"},     {1, "\xFE", 2, "\xC2\xA6"},
};
void Ibm_1043_p100_1995ToUtf::Register(const DBConfig &config) {
	const Ibm_1043_p100_1995ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1043_P100_1995_to_utf8, generated_function.size);
