...
// Generated from: glibc-IBM891-2.1.2.ucm
static const map_entry_encoding IBM891_to_utf8[] = {
...
void Ibm891ToUtf::Register(const DBConfig &config) {
	const Ibm891ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                IBM891_to_utf8, generated_function.size);
