...
// Generated from: ibm-1021_P100-2003.ucm
static const map_entry_encoding ibm_1021_P100_2003_to_utf8[] = {
    ...
    {1, "\x21", 3, "\xEF\xBC\x81"}, {1, "\x22", 3, "\xEF\xBC\x82"}, {1, "\x23", 2, "\xC3\xB9"},
    ...
    {1, "\x5A", 3, "\xEF\xBC\xBA"}, {1, "\x5B", 2, "\xC3\xA9"},     {1, "\x5C", 2, "\xC3\xA7"},
    {1, "\x5D", 2, "\xC3\xAA"},     {1, "\x5E", 2, "\xC3\xAE"},     {1, "\x5F", 2, "\xC3\xA8"},
    {1, "\x60", 2, "\xC3\xB4"},     {1, "\x61", 3, "\xEF\xBD\x81"}, {1, "\x62", 3, "\xEF\xBD\x82"},
    ...
    {1, "\x7B", 2, "\xC3\xA4"},     {1, "\x7C", 2, "\xC3\xB6"},     {1, "\x7D", 2, "\xC3\xBC"},
    {1, "\x7E", 2, "\xC3\xBB"},     {1, "\x7F", 1, "\x7F"},
};
void Ibm_1021_p100_2003ToUtf::Register(const DBConfig &config) {
	const Ibm_1021_p100_2003ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1021_P100_2003_to_utf8, generated_function.size);
