...
static const map_entry_encoding java_ISO8859_8_1_3_P_to_utf8[] = {
    ...
    {1, "\xA0", 2, "\xC2\xA0"}, {1, "\xA2", 2, "\xC2\xA2"}, {1, "\xA3", 2, "\xC2\xA3"},     {1, "\xA4", 2, "\xC2\xA4"},
    {1, "\xA5", 2, "\xC2\xA5"}, {1, "\xA6", 2, "\xC2\xA6"}, {1, "\xA7", 2, "\xC2\xA7"},     {1, "\xA8", 2, "\xC2\xA8"},
    {1, "\xA9", 2, "\xC2\xA9"}, {1, "\xAA", 2, "\xC3\x97"}, {1, "\xAB", 2, "\xC2\xAB"},     {1, "\xAC", 2, "\xC2\xAC"},
    {1, "\xAD", 2, "\xC2\xAD"}, {1, "\xAE", 2, "\xC2\xAE"}, {1, "\xAF", 3, "\xE2\x80\xBE"}, {1, "\xB0", 2, "\xC2\xB0"},
    {1, "\xB1", 2, "\xC2\xB1"}, {1, "\xB2", 2, "\xC2\xB2"}, {1, "\xB3", 2, "\xC2\xB3"},     {1, "\xB4", 2, "\xC2\xB4"},
    {1, "\xB5", 2, "\xC2\xB5"}, {1, "\xB6", 2, "\xC2\xB6"}, {1, "\xB7", 2, "\xC2\xB7"},     {1, "\xB8", 2, "\xC2\xB8"},
    {1, "\xB9", 2, "\xC2\xB9"}, {1, "\xBA", 2, "\xC3\xB7"}, {1, "\xBB", 2, "\xC2\xBB"},     {1, "\xBC", 2, "\xC2\xBC"},
    {1, "\xBD", 2, "\xC2\xBD"}, {1, "\xBE", 2, "\xC2\xBE"}, {1, "\xDF", 3, "\xE2\x80\x97"}, {1, "\xE0", 2, "\xD7\x90"},
    {1, "\xE1", 2, "\xD7\x91"}, {1, "\xE2", 2, "\xD7\x92"}, {1, "\xE3", 2, "\xD7\x93"},     {1, "\xE4", 2, "\xD7\x94"},
    {1, "\xE5", 2, "\xD7\x95"}, {1, "\xE6", 2, "\xD7\x96"}, {1, "\xE7", 2, "\xD7\x97"},     {1, "\xE8", 2, "\xD7\x98"},
    {1, "\xE9", 2, "\xD7\x99"}, {1, "\xEA", 2, "\xD7\x9A"}, {1, "\xEB", 2, "\xD7\x9B"},     {1, "\xEC", 2, "\xD7\x9C"},
    {1, "\xED", 2, "\xD7\x9D"}, {1, "\xEE", 2, "\xD7\x9E"}, {1, "\xEF", 2, "\xD7\x9F"},     {1, "\xF0", 2, "\xD7\xA0"},
    {1, "\xF1", 2, "\xD7\xA1"}, {1, "\xF2", 2, "\xD7\xA2"}, {1, "\xF3", 2, "\xD7\xA3"},     {1, "\xF4", 2, "\xD7\xA4"},
    {1, "\xF5", 2, "\xD7\xA5"}, {1, "\xF6", 2, "\xD7\xA6"}, {1, "\xF7", 2, "\xD7\xA7"},     {1, "\xF8", 2, "\xD7\xA8"},
    {1, "\xF9", 2, "\xD7\xA9"}, {1, "\xFA", 2, "\xD7\xAA"},
};
void Java_iso8859_8_1_3_pToUtf::Register(const DBConfig &config) {
	const Java_iso8859_8_1_3_pToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                java_ISO8859_8_1_3_P_to_utf8, generated_function.size);
