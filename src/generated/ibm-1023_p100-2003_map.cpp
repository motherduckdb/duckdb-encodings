...
// Generated from: ibm-1023_P100-2003.ucm
static const map_entry_encoding ibm_1023_P100_2003_to_utf8[] = {
    ...
    {1, "\x5A", 3, "\xEF\xBC\xBA"}, {1, "\x5B", 2, "\xC2\xA1"},     {1, "\x5C", 2, "\xC3\x91"},
    {1, "\x5D", 2, "\xC2\xBF"},     {1, "\x5E", 3, "\xEF\xBC\xBE"}, {1, "\x5F", 3, "\xEF\xBC\xBF"},
    ...
    {1, "\x7B", 2, "\xCB\x9A"},     {1, "\x7C", 2, "\xC3\xB1"},     {1, "\x7D", 2, "\xC3\xA7"},
    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x7F"},
};
void Ibm_1023_p100_2003ToUtf::Register(const DBConfig &config) {
	const Ibm_1023_p100_2003ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1023_P100_2003_to_utf8, generated_function.size);
