...
// Generated from: windows-20107-2000.ucm
static const map_entry_encoding windows_20107_2000_to_utf8[] = {
    ...
    {1, "\x1E", 1, "\x1E"},         {1, "\x1F", 1, "\x1F"},         {1, "\x20", 3, "\xE2\x80\x86"},
    ...
    {1, "\x3F", 1, "\x3F"},         {1, "\x40", 2, "\xC3\x89"},     {1, "\x41", 3, "\xEF\xBC\xA1"},
    ...
    {1, "\x5A", 3, "\xEF\xBC\xBA"}, {1, "\x5B", 2, "\xC3\x84"},     {1, "\x5C", 2, "\xC3\x96"},
    {1, "\x5D", 2, "\xC3\x85"},     {1, "\x5E", 2, "\xC3\x9C"},     {1, "\x5F", 3, "\xEF\xBC\xBF"},
    {1, "\x60", 2, "\xC3\xA9"},     {1, "\x61", 3, "\xEF\xBD\x81"}, {1, "\x62", 3, "\xEF\xBD\x82"},
    ...
    {1, "\x7B", 2, "\xC3\xA4"},     {1, "\x7C", 2, "\xC3\xB6"},     {1, "\x7D", 2, "\xC3\xA5"},
    {1, "\x7E", 3, "\xEF\xBD\x9E"}, {1, "\x7F", 1, "\x7F"},
};
void Windows_20107_2000ToUtf::Register(const DBConfig &config) {
	const Windows_20107_2000ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                windows_20107_2000_to_utf8, generated_function.size);
