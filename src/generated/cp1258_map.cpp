...
// Generated from: glibc-CP1258-2.1.2.ucm
static const map_entry_encoding CP1258_to_utf8[] = {
    ...
    {1, "\xEA", 2, "\xC3\xAA"},     {1, "\xEB", 2, "\xC3\xAB"},     {1, "\xED", 2, "\xC3\xAD"},
    {1, "\xEE", 2, "\xC3\xAE"},     {1, "\xEF", 2, "\xC3\xAF"},     {1, "\xF0", 2, "\xC4\x91"},
    {1, "\xF1", 2, "\xC3\xB1"},     {1, "\xF2", 2, "\xCC\xA3"},     {1, "\xF3", 2, "\xC3\xB3"},
    {1, "\xF4", 2, "\xC3\xB4"},     {1, "\xF5", 2, "\xC6\xA1"},     {1, "\xF6", 2, "\xC3\xB6"},
    {1, "\xF7", 2, "\xC3\xB7"},     {1, "\xF8", 2, "\xC3\xB8"},     {1, "\xF9", 2, "\xC3\xB9"},
    {1, "\xFA", 2, "\xC3\xBA"},     {1, "\xFB", 2, "\xC3\xBB"},     {1, "\xFC", 2, "\xC3\xBC"},
    {1, "\xFD", 2, "\xC6\xB0"},     {1, "\xFE", 3, "\xE2\x82\xAB"}, {1, "\xFF", 2, "\xC3\xBF"},
};
void Cp1258ToUtf::Register(const DBConfig &config) {
	const Cp1258ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                CP1258_to_utf8, generated_function.size);
