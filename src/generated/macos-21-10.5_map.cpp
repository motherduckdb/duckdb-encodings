...
// Generated from: macos-21-10.5.ucm
static const map_entry_encoding macos_21_10_5_to_utf8[] = {
    ...
    {1, "\x7E", 3, "\xE2\x88\xBC"}, {1, "\x7F", 1, "\x7F"},         {1, "\x80", 2, "\xC2\xAB"},
    {1, "\x81", 2, "\xC2\xBB"},     {1, "\x82", 3, "\xE2\x80\xA6"}, {1, "\x83", 3, "\xEF\xA2\x8C"},
    {1, "\x84", 3, "\xEF\xA2\x8F"}, {1, "\x85", 3, "\xEF\xA2\x92"}, {1, "\x86", 3, "\xEF\xA2\x95"},
    {1, "\x87", 3, "\xEF\xA2\x98"}, {1, "\x88", 3, "\xEF\xA2\x8B"}, {1, "\x89", 3, "\xEF\xA2\x8E"},
    {1, "\x8A", 3, "\xEF\xA2\x91"}, {1, "\x8B", 3, "\xEF\xA2\x94"}, {1, "\x8C", 3, "\xEF\xA2\x97"},
    {1, "\x8D", 3, "\xE2\x80\x9C"}, {1, "\x8E", 3, "\xE2\x80\x9D"}, {1, "\x8F", 3, "\xEF\xA2\x99"},
    {1, "\x91", 3, "\xE2\x8B\x85"}, {1, "\x92", 3, "\xEF\xA2\x84"}, {1, "\x93", 3, "\xEF\xA2\x89"},
    {1, "\x94", 3, "\xEF\xA2\x85"}, {1, "\x95", 3, "\xEF\xA2\x86"}, {1, "\x96", 3, "\xEF\xA2\x87"},
    {1, "\x97", 3, "\xEF\xA2\x88"}, {1, "\x98", 3, "\xEF\xA2\x8A"}, {1, "\x99", 3, "\xEF\xA2\x8D"},
    {1, "\x9A", 3, "\xEF\xA2\x90"}, {1, "\x9B", 3, "\xEF\xA2\x93"}, {1, "\x9C", 3, "\xEF\xA2\x96"},
    {1, "\x9D", 3, "\xE2\x80\x98"}, {1, "\x9E", 3, "\xE2\x80\x99"}, {1, "\xA0", 2, "\xC2\xA0"},
    ...
    {1, "\xDA", 3, "\xE0\xB8\xBA"}, {1, "\xDB", 3, "\xE2\x81\xA0"}, {1, "\xDC", 3, "\xE2\x80\x8B"},
    {1, "\xDD", 3, "\xE2\x80\x93"}, {1, "\xDE", 3, "\xE2\x80\x95"}, {1, "\xDF", 3, "\xE0\xB8\xBF"},
    {1, "\xE0", 3, "\xE0\xB9\x80"}, {1, "\xE1", 3, "\xE0\xB9\x81"}, {1, "\xE2", 3, "\xE0\xB9\x82"},
    {1, "\xE3", 3, "\xE0\xB9\x83"}, {1, "\xE4", 3, "\xE0\xB9\x84"}, {1, "\xE5", 3, "\xE0\xB9\x85"},
    {1, "\xE6", 3, "\xE0\xB9\x86"}, {1, "\xE7", 3, "\xE0\xB9\x87"}, {1, "\xE8", 3, "\xE0\xB9\x88"},
    {1, "\xE9", 3, "\xE0\xB9\x89"}, {1, "\xEA", 3, "\xE0\xB9\x8A"}, {1, "\xEB", 3, "\xE0\xB9\x8B"},
    {1, "\xEC", 3, "\xE0\xB9\x8C"}, {1, "\xED", 3, "\xE0\xB9\x8D"}, {1, "\xEE", 3, "\xE2\x84\xA2"},
    {1, "\xEF", 3, "\xE0\xB9\x8F"}, {1, "\xF0", 3, "\xE0\xB9\x90"}, {1, "\xF1", 3, "\xE0\xB9\x91"},
    {1, "\xF2", 3, "\xE0\xB9\x92"}, {1, "\xF3", 3, "\xE0\xB9\x93"}, {1, "\xF4", 3, "\xE0\xB9\x94"},
    {1, "\xF5", 3, "\xE0\xB9\x95"}, {1, "\xF6", 3, "\xE0\xB9\x96"}, {1, "\xF7", 3, "\xE0\xB9\x97"},
    {1, "\xF8", 3, "\xE0\xB9\x98"}, {1, "\xF9", 3, "\xE0\xB9\x99"}, {1, "\xFA", 2, "\xC2\xAE"},
    {1, "\xFB", 2, "\xC2\xA9"},
};
void Macos_21_10_5ToUtf::Register(const DBConfig &config) {
