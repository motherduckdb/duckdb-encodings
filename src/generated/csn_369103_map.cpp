...
// Generated from: glibc-CSN_369103-2.1.2.ucm
static const map_entry_encoding CSN_369103_to_utf8[] = {
    ...
    {1, "\xA4", 1, "\x24"},     {1, "\xA5", 2, "\xC4\xBD"}, {1, "\xA6", 2, "\xC5\x9A"}, {1, "\xA7", 2, "\xC2\xA7"},
...
void Csn_369103ToUtf::Register(const DBConfig &config) {
	const Csn_369103ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                CSN_369103_to_utf8, generated_function.size);
