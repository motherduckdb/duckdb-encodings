...
// Generated from: ibm-1011_P100-1995.ucm
static const map_entry_encoding ibm_1011_P100_1995_to_utf8[] = {
    ...
    {1, "\x5D", 2, "\xC3\x9C"},     {1, "\x5E", 3, "\xEF\xBC\xBE"}, {1, "\x5F", 3, "\xEF\xBC\xBF"},
    ...
    {1, "\x7E", 2, "\xC3\x9F"},     {1, "\x7F", 1, "\x7F"},
};
void Ibm_1011_p100_1995ToUtf::Register(const DBConfig &config) {
	const Ibm_1011_p100_1995ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1011_P100_1995_to_utf8, generated_function.size);
