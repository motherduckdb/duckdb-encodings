...
// Generated from: ibm-1010_P100-1995.ucm
static const map_entry_encoding ibm_1010_P100_1995_to_utf8[] = {
    ...
    {1, "\x21", 3, "\xEF\xBC\x81"}, {1, "\x22", 3, "\xEF\xBC\x82"}, {1, "\x23", 2, "\xC2\xA3"},
    ...
    {1, "\x3F", 3, "\xEF\xBC\x9F"}, {1, "\x40", 2, "\xC3\xA0"},     {1, "\x41", 3, "\xEF\xBC\xA1"},
    ...
    {1, "\x5A", 3, "\xEF\xBC\xBA"}, {1, "\x5B", 2, "\xC2\xB0"},     {1, "\x5C", 2, "\xC3\xA7"},
    {1, "\x5D", 2, "\xC2\xA7"},     {1, "\x5E", 3, "\xEF\xBC\xBE"}, {1, "\x5F", 3, "\xEF\xBC\xBF"},
    {1, "\x60", 2, "\xC2\xB5"},     {1, "\x61", 3, "\xEF\xBD\x81"}, {1, "\x62", 3, "\xEF\xBD\x82"},
    ...
    {1, "\x7B", 2, "\xC3\xA9"},     {1, "\x7C", 2, "\xC3\xB9"},     {1, "\x7D", 2, "\xC3\xA8"},
    {1, "\x7E", 2, "\xC2\xA8"},     {1, "\x7F", 1, "\x7F"},
};
void Ibm_1010_p100_1995ToUtf::Register(const DBConfig &config) {
	const Ibm_1010_p100_1995ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1010_P100_1995_to_utf8, generated_function.size);
