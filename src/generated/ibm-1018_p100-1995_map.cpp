...
// Generated from: ibm-1018_P100-1995.ucm
static const map_entry_encoding ibm_1018_P100_1995_to_utf8[] = {
    ...
    {1, "\x24", 2, "\xC2\xA4"},     {1, "\x25", 3, "\xEF\xBC\x85"}, {1, "\x26", 3, "\xEF\xBC\x86"},
    ...
    {1, "\x5D", 2, "\xC3\x85"},     {1, "\x5E", 3, "\xEF\xBC\xBE"}, {1, "\x5F", 3, "\xEF\xBC\xBF"},
    ...
    {1, "\x7E", 2, "\xC2\xAF"},     {1, "\x7F", 1, "\x7F"},
};
void Ibm_1018_p100_1995ToUtf::Register(const DBConfig &config) {
	const Ibm_1018_p100_1995ToUtf generated_function;
	const EncodingFunction function(generated_function.name, GeneratedEncodedFunction::Decode,
	                                generated_function.max_bytes_per_byte, generated_function.lookup_bytes,
	                                ibm_1018_P100_1995_to_utf8, generated_function.size);
