...
python_icu_encoding_map = [('ascii', '646', None, 'solaris-646-2.7.ucm'), ('big5', 'big5', None, 'aix-big5-4.3.6.ucm')]

header_encoding_generated = '''// !!!!!!!
...
def generate_cpp_map(encoding_name, codepage_to_utf8, filepath):
    lines = [f'// Generated from: {filepath}',
        f'map<vector<uint8_t>, vector<uint8_t>> {encoding_name}_to_utf8 ='+' {'
    ]
...
with open(os.path.join(generated_path, 'CMakeLists.txt'), "w", encoding="utf-8") as cmake_file:
    ...
    for encoding in python_icu_encoding_map:
        ...
        with open(encoding_map_file_path, "w", encoding="utf-8") as out_file:
            ...
            cmake_file.write(f'  encoding_{encoding[0]}_map.cpp\n')
